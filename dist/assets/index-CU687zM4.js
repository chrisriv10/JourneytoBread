...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function Hs(e,t,n){let r=new Float32Array(Os),i=new U(0,1,0);return new lo({name:`SphericalGaussianBlur`,defines:{n:Os,CUBEUV_TEXEL_WIDTH:1/t,CUBEUV_TEXEL_HEIGHT:1/n,CUBEUV_MAX_MIP:`${e}.0`},uniforms:{envMap:{value:null},samples:{value:1},weights:{value:r},latitudinal:{value:!1},dTheta:{value:0},mipInt:{value:0},poleAxis:{value:i}},vertexShader:Gs(),fragmentShader:`
	...
	`}var Ks=class extends qt{constructor(e=1,t={}){super(e,e,t),this.isWebGLCubeRenderTarget=!0;let n={width:e,height:e,depth:1},r=[n,n,n,n,n,n];this.texture=new Ci(r),this._setTextureOptions(t),this.texture.isRenderTargetTexture=!0}fromEquirectangularTexture(e,t){this.texture.type=t.type,this.texture.colorSpace=t.colorSpace,this.texture.generateMipmaps=t.generateMipmaps,this.texture.minFilter=t.minFilter,this.texture.magFilter=t.magFilter;let n={uniforms:{tEquirect:{value:null}},vertexShader:`
	...
	if ( coord.x >= 1.0 ) {
		...
		void main() {
			...
			gl_FragColor = mix( outputColor, texel, alpha );
				...
				}`})}};Gu.BlurDirectionX=new H(1,0),Gu.BlurDirectionY=new H(0,1);var Ku={night:658700,moss:2505255,mossLight:6255937,wheat:14067789,wheatLight:16043890,stone:5986896,stoneLight:9275765,flour:15853520,salt:16314586,yeast:12814431,dough:13208140,doughLight:15775850,oven:2430226,ember:16740146,crust:10111776,bread:13137196,crumb:15976065,table:4403494,ink:1119762};function X(e,t={}){return new fo({color:e,roughness:.86,metalness:.02,transparent:!0,...t})}function qu(e,t,n=.8){return new gi({color:e,size:t,sizeAttenuation:!0,transparent:!0,opacity:n,depthWrite:!1})}function Ju(e,t,n,r=2){let i=new Ya(1,r),a=i.attributes.position,o=new U;for(let r=0;r<a.count;r+=1){o.fromBufferAttribute(a,r);let i=Math.abs(o.x),s=Math.max(0,o.y),c=1-i*.16;o.x*=e*c,o.y=o.y*t+s*.08,o.z*=n*(1-Math.max(0,i-.55)*.12),o.y<-t*.42&&(o.y*=.62),a.setXYZ(r,o.x,o.y,o.z)}return a.needsUpdate=!0,i.computeVertexNormals(),i}function Yu(){let e=new Xa([new H(.02,-.86),new H(.16,-.72),new H(.28,-.4),new H(.34,0),new H(.27,.43),new H(.12,.75),new H(.02,.88)],10);return e.rotateZ(Math.PI/2),e.scale(.56,.56,1.18),e.computeVertexNormals(),e}function Xu(){let e=new Xa([new H(.01,-.62),new H(.1,-.52),new H(.18,-.25),new H(.2,0),new H(.16,.27),new H(.08,.48),new H(.01,.62)],8);return e.computeVertexNormals(),e}function Zu(){let e=new ca;e.moveTo(-1.56,-.5),e.lineTo(1.56,-.5),e.quadraticCurveTo(1.54,-.28,1.42,-.04),e.quadraticCurveTo(1.27,.4,.78,.67),e.quadraticCurveTo(.22,.92,-.22,.86),e.quadraticCurveTo(-.86,.78,-1.22,.41),e.quadraticCurveTo(-1.47,.13,-1.56,-.18),e.quadraticCurveTo(-1.62,-.37,-1.56,-.5);let t=new Ka(e,{depth:1.5,bevelEnabled:!0,bevelSegments:2,bevelSize:.13,bevelThickness:.12,curveSegments:5,steps:1});return t.translate(0,0,-.75),t.computeVertexNormals(),t}function Qu(e,t){e.traverse(e=>{let n=e;(Array.isArray(n.material)?n.material:n.material?[n.material]:[]).forEach(e=>{e.transparent=!0,e.opacity=V.clamp(t,0,1),e.depthWrite=t>.96})})}function Z(e){let t=V.clamp(e,0,1);return t*t*(3-2*t)}function $u(e){let t=V.clamp(e,0,1);return t*t*t*(t*(t*6-15)+10)}function ed(e,t,n){return V.clamp((e-t)/Math.max(n-t,1e-4),0,1)}function td(e,t,n,r=.08){let i=Z((e-t)/r),a=1-Z((e-(n-r))/r);return V.clamp(Math.min(i,a),0,1)}function nd(e,t=.72){let n=new q(new Oi(t,.075,.1),e);return n.rotation.z=-.2,n.rotation.x=-.24,n}var Q=(e,t,n)=>new U(e,t,n),rd=e=>new K(e),id=4937,ad=()=>(id=id*16807%2147483647,(id-1)/2147483646),od=new Map;function sd(t){let n=od.get(t);if(n)return n;let r=document.createElement(`canvas`);r.width=r.height=512;let i=r.getContext(`2d`);i.fillStyle={wood:`#b48958`,stone:`#8c8a84`,flour:`#f4ebd9`,crust:`#c69255`}[t],i.fillRect(0,0,512,512);for(let e=0;e<15e3;e++){let e=ad()*512,n=ad()*512;i.fillStyle=ad()>.5?`rgba(255,255,255,${ad()*.22})`:`rgba(48,28,12,${ad()*.2})`,i.fillRect(e,n,t===`wood`?12+ad()*90:1+ad()*3,.5+ad()*2)}if(t===`wood`)for(let e=0;e<80;e++){i.strokeStyle=`rgba(73,40,18,${.06+ad()*.14})`,i.beginPath();let e=ad()*512;i.moveTo(0,e),i.bezierCurveTo(180,e-13,350,e+18,512,e+ad()*10),i.stroke()}let a=new wi(r);return a.colorSpace=ze,a.wrapS=a.wrapT=e,a.anisotropy=4,od.set(t,a),a}function $(e,t,n={}){return new fo({color:e,roughness:.83,metalness:0,...t?{map:sd(t),bumpMap:sd(t),bumpScale:t===`stone`?.035:.012}:{},...n})}function cd(e,t,n,r=0,i=0,a=0){let o=new q(e,t);return o.position.set(r,i,a),o.castShadow=o.receiveShadow=!0,n?.add(o),o}function ld(e,t,n,r,i){let a=cd(new Ai(n,n,e.distanceTo(t),10),r,i);return a.position.copy(e).add(t).multiplyScalar(.5),a.quaternion.setFromUnitVectors(Q(0,1,0),t.clone().sub(e).normalize()),a}function ud(e,t,n,r){return cd(new eo(new Vi(e),40,t,8,!1),n,r)}function dd(e,t,n,r,i){let a=cd(new $a(e,t,8,80),n,r,0,i,0);return a.rotation.x=Math.PI/2,a}function fd(e,t,n,r=.15){let i=new ca,a=-e/2,o=-t/2,s=r;i.moveTo(a+s,o),i.lineTo(a+e-s,o),i.quadraticCurveTo(a+e,o,a+e,o+s),i.lineTo(a+e,o+t-s),i.quadraticCurveTo(a+e,o+t,a+e-s,o+t),i.lineTo(a+s,o+t),i.quadraticCurveTo(a,o+t,a,o+t-s),i.lineTo(a,o+s),i.quadraticCurveTo(a,o,a+s,o);let c=new Ka(i,{depth:n,bevelEnabled:!0,bevelSegments:3,bevelSize:.025,bevelThickness:.025,curveSegments:10});return c.rotateX(-Math.PI/2),c}function pd(e,t=3.8,n=2.65){return cd(fd(t,n,.13),$(15782304,`wood`),e,0,-.16,0)}function md(e,t=280,n=1.3,r=.006){let i=new ki(.013,6);i.rotateX(-Math.PI/2);let a=new si(i,$(15787987),t),o=new wn;for(let e=0;e<t;e++){let t=ad()*Math.PI*2,i=Math.sqrt(ad())*n;o.position.set(Math.cos(t)*i,r,Math.sin(t)*i*.66),o.scale.setScalar(.4+ad()*1.9),o.updateMatrix(),a.setMatrixAt(e,o.matrix)}e.add(a)}function hd(e,t=15591129,n=1){let r=cd(new Xa([[0,.03],[.45,.03],[.68,.12],[.9,.33],[1.06,.65],[1.12,.96],[1.1,1],[1.045,1],[1.01,.67],[.85,.36],[.64,.19],[.4,.12],[0,.12]].map(([e,t])=>new H(e,t)),80),$(t,void 0,{roughness:.35}),e);return r.scale.setScalar(n),r}function gd(e=1.03,t=.57,n=.85){let r=new Qa(1,64,40),i=r.attributes.position;for(let r=0;r<i.count;r++){let a=i.getX(r),o=i.getY(r),s=i.getZ(r),c=1+.016*Math.sin(a*12+s*5)*Math.sin(s*9+o*6);i.setXYZ(r,a*e*c,Math.max(.025,o*t+t*.77),s*n*c)}return r.computeVertexNormals(),r}function _d(e,t=1.03,n=.57,r=.85){return cd(gd(t,n,r),$(16774107,`flour`,{roughness:.9}),e)}function vd(e,t=1){let n=new Qa(1,112,72),r=n.attributes.position,i=[];for(let e=0;e<r.count;e++){let t=r.getX(e),n=r.getY(e),a=r.getZ(e),o=t*1.38,s=a*.78,c=Math.max(.045,.53+n*.66),l=Math.min(...[-.72,-.24,.24,.72].map(e=>Math.abs(o+s*.33-e))),u=n>.35&&Math.abs(s)<.7?Math.exp(-((l/.066)**4))*Math.min(1,(n-.35)*8):0;c-=u*.095,c+=.008*Math.sin(o*43)*Math.sin(s*29),r.setXYZ(e,o,c,s);let d=rd(12085544).lerp(rd(15316326),Math.max(0,n)*.5);u>.05&&d.lerp(rd(15914400),u*.9),Math.sin(o*18+s*7)*Math.sin(s*15-o*11)>.57&&n>.15&&d.lerp(rd(15785664),.46),d.multiplyScalar(.92+.12*Math.sin(o*117+s*71+n*57)),i.push(d.r,d.g,d.b)}n.setAttribute(`color`,new hr(i,3)),n.computeVertexNormals();let a=cd(n,$(16777215,void 0,{vertexColors:!0,roughness:.88}),e);return a.scale.setScalar(t),a}function yd(e,t=2.8){let n=new G;e.add(n);let r=$(12226879),i=$(15252322);ld(Q(0,0,0),Q(.035,t,0),.013,r,n);let a=new Qa(1,12,10);for(let e=0;e<9;e++)for(let o of[-1,1]){let s=t-.88+e*.095,c=cd(a,i,n,o*(.062-e*.003),s,0);c.scale.set(.061-e*.0018,.112-e*.003,.064),c.rotation.z=o*-.43,ld(Q(o*.085,s+.045,0),Q(o*(.21-e*.005),s+.39,0),.003,r,n)}return ud([Q(0,.78,0),Q(-.19,1.12,.06),Q(-.31,1.43,.03)],.017,r,n),n}function bd(e,t=1){let n=[[.012,-.62],[.12,-.54],[.2,-.3],[.21,0],[.18,.29],[.1,.51],[.012,.62]],r=new G;return e.add(r),cd(new Xa(n.map(([e,t])=>new H(e,t)),48),$(14264396,void 0,{roughness:.72}),r).scale.setScalar(t),ud([Q(0,-.45,.19),Q(0,-.16,.21),Q(0,.16,.21),Q(0,.45,.19)],.014,$(9395492,void 0,{roughness:.9}),r).scale.setScalar(t),r}function xd(){let e=new G,t=[];for(let n=0;n<26;n++){let n=yd(e,1.5+ad()*.55);n.position.set((ad()-.5)*5.1,-.02,-.9-ad()*2),t.push(n)}let n=yd(e,2.75);n.position.set(-.2,0,.45),t.push(n);let r=yd(e,2.35);return r.position.set(.39,0,-.03),r.rotation.z=-.13,t.push(r),{group:e,animate:(e,n)=>t.forEach((e,t)=>e.rotation.z=Math.sin(n*.7+t)*.035+(t===27?-.13:0))}}function Sd(){let e=new G;pd(e),md(e,75);let t=new G;e.add(t);let n=bd(t,1.12);n.position.set(0,.27,.02),n.rotation.z=Math.PI/2-.12;for(let e=0;e<5;e++){let n=bd(t,.43+e%2*.06);n.position.set(-1.02+e*.5,.12+e%2*.02,-.72+e%3*.1),n.rotation.z=Math.PI/2+(e-2)*.18}return{group:e,animate:()=>{}}}function Cd(){let e=new G;pd(e,3.8,3);let t=$(12763321,`stone`),n=$(11963216,`wood`),r=$(3750713,void 0,{metalness:.65,roughness:.45});cd(new Ai(1.18,1.22,.35,80),t,e,0,.2,0);let i=new G;e.add(i),i.position.y=.63,cd(new Ai(1.17,1.18,.42,80),t,i),dd(1.18,.016,r,i,-.19);for(let e=0;e<16;e++){let t=e/16*Math.PI*2;ld(Q(Math.cos(t)*.31,.214,Math.sin(t)*.31),Q(Math.cos(t+.23)*1.1,.214,Math.sin(t+.23)*1.1),.009,$(6118228),i)}ld(Q(0,.72,0),Q(0,1.1,0),.065,r,e),ld(Q(0,1.08,0),Q(.8,1.08,0),.048,r,i),ld(Q(.8,1.06,0),Q(.8,1.43,0),.085,n,i);let a=cd(new Ai(.47,.13,.55,4,1,!0),$(13079633,`wood`,{side:2}),e,0,1.32,0);a.rotation.y=Math.PI/4,cd(new Ai(.26,.26,.025,32),$(14132566),e,0,1.47,0);let o=cd(fd(.38,.8,.06,.04),n,e,.25,.2,1.12);o.rotation.x=.2;let s=cd(gd(.45,.12,.3),$(15919831,`flour`),e,.25,.005,1.23);return{group:e,animate:(e,t)=>{i.rotation.y=t*.25+e*4,s.scale.setScalar(.72+e*.28)}}}function wd(){let e=new G;pd(e),md(e,600,1.55);let t=new Qa(1,80,48),n=t.attributes.position;for(let e=0;e<n.count;e++){let t=n.getX(e),r=n.getZ(e),i=n.getY(e);n.setXYZ(e,t*1.08,Math.max(.012,(i+.25)*.43)*(1+.04*Math.sin(t*15+r*8)),r*.85)}t.computeVertexNormals(),cd(t,$(16777215,`flour`,{roughness:1}),e,-.2,0,0);let r=new G;e.add(r),r.position.set(1,.045,.55),r.rotation.y=-.75,cd(new Qa(.34,40,24,0,Math.PI*2,Math.PI/2,Math.PI/2),$(12752996,`wood`,{side:2}),r,0,.25,0).scale.set(.8,.7,1.35),ld(Q(0,.12,-.25),Q(0,.15,-.95),.063,$(12752996,`wood`),r);let i=cd(new ki(.26,48),$(16777215,`flour`),r,0,.2,0);return i.rotation.x=-Math.PI/2,i.scale.y=1.3,{group:e,animate:()=>{}}}function Td(){let e=new G;pd(e),hd(e,14279903,.95);let t=_d(e,.84,.13,.84);t.position.y=.53;let n=new G;e.add(n),n.position.y=.72;let r=$(12420935,`wood`);cd(new Qa(1,32,24),r,n,.48,.01,0).scale.set(.18,.07,.27),ld(Q(.48,.03,0),Q(.72,1.18,0),.045,r,n);let i=new G;e.add(i),i.position.set(-1.25,1.47,-.08),i.rotation.z=-.6;let a=$(12311007,void 0,{transparent:!0,opacity:.4,roughness:.16,metalness:.15,side:2,depthWrite:!1});cd(new Ai(.3,.25,.62,48,1,!0),a,i,0,0,0),dd(.3,.019,a,i,.31);let o=cd(new $a(.2,.037,12,40),a,i,-.36,0,0);o.scale.x=.75,cd(new Ai(.265,.235,.36,48),$(9289673,void 0,{transparent:!0,opacity:.58,roughness:.15}),i,0,-.09,0);let s=ud([Q(-.82,1.69,0),Q(-.56,1.42,0),Q(-.39,.78,0)],.028,$(12640741,void 0,{transparent:!0,opacity:.65,roughness:.18}),e);return{group:e,animate:(e,r)=>{n.rotation.y=e*6+r*.35,t.rotation.y=e*1.5,s.visible=e<.74,i.rotation.z=-.6+(e>.74?(e-.74)*1.7:0)}}}function Ed(){let e=new G;pd(e),md(e,480,1.5);let t=_d(e,1,.33,.79),n=_d(e,.91,.23,.44);n.position.set(0,.33,-.19),n.rotation.x=-.15,ud([Q(-.75,.4,.24),Q(-.3,.37,.32),Q(.34,.39,.29),Q(.78,.33,.16)],.014,$(13286302),e);let r=new G;e.add(r),r.position.set(.2,.7,.58),r.rotation.y=.18;let i=$(14597510,`wood`);return ld(Q(-.8,0,0),Q(.8,0,0),.14,i,r),ld(Q(-1.13,0,0),Q(1.13,0,0),.065,i,r),{group:e,animate:e=>{n.scale.z=.8+e*.3,t.scale.y=1-.08*Math.sin(e*Math.PI)}}}function Dd(){let e=new G;pd(e);let t=$(13806710,`wood`),n=new G;e.add(n);for(let e=0;e<13;e++)dd(.77+e*.024,.031,t,n,.05+e*.035);for(let e=0;e<32;e++){let t=e/32*Math.PI*2;ld(Q(Math.cos(t)*.79,.055,Math.sin(t)*.79),Q(Math.cos(t)*1.064,.48,Math.sin(t)*1.064),.009,$(9859915),n)}let r=_d(e,.96,.55,.96);return r.position.y=.18,{group:e,animate:e=>{r.scale.set(.84+e*.13,.68+e*.45,.84+e*.13)}}}function Od(){let e=new G,t=$(11303008,`stone`),n=$(5260348),r=$(1445901);cd(fd(3.8,2.65,.18),n,e,0,-.18,0),cd(new Oi(3.5,2.1,.2),r,e,0,1,-.8),cd(new Oi(.55,1.2,1.55),n,e,-1.47,.6,-.12),cd(new Oi(.55,1.2,1.55),n,e,1.47,.6,-.12);for(let n of[-1,1])for(let r=0;r<4;r++)cd(new Oi(.51,.275,.22),t,e,n*1.47,.16+r*.3,.69);for(let n=0;n<13;n++){let r=n/12*Math.PI,i=cd(new Oi(.315,.53,1.52),t,e,Math.cos(r)*1.46,1.17+Math.sin(r)*1.05,-.12);i.rotation.z=r-Math.PI/2}cd(new Oi(2.45,.12,1.5),$(9336416,`stone`),e,0,.04,.01);let i=vd(e,.67);i.position.set(0,.11,.28);let a=$(13586198,void 0,{emissive:16730890,emissiveIntensity:2});for(let t=0;t<12;t++){let n=cd(new Qa(.055,12,8),a,e,(t-5.5)*.17,.19,-.48);n.scale.y=.5}let o=new Wo(16751429,5,5,2);return o.position.set(0,.75,.1),e.add(o),{group:e,animate:(e,t)=>{i.scale.setScalar(.64+e*.045),o.intensity=4.3+Math.sin(t*2)*.2}}}function kd(){let e=new G;pd(e,4.25,2.8),md(e,70,1.65);let t=vd(e);t.position.set(-.38,.02,-.05),t.rotation.y=-.12;let n=new G;e.add(n),n.position.set(1.37,.055,.53),n.rotation.set(-Math.PI/2,0,.23);let r=cd(new Ai(.66,.65,.16,64),$(11429934,`crust`),n);r.scale.z=.78;let i=cd(new ki(.595,64),$(16770485,`flour`),n,0,.087,0);i.rotation.x=-Math.PI/2,i.scale.y=.78;for(let e=0;e<37;e++){let e=ad()*Math.PI*2,t=Math.sqrt(ad())*.51,r=cd(new ki(.015+ad()*.04,14),$(11372122),n,Math.cos(e)*t,.09,Math.sin(e)*t*.78);r.rotation.x=-Math.PI/2,r.scale.y=.65+ad()*.8,r.castShadow=!1}return n.rotation.set(0,.23,0),n.position.y=.12,{group:e,animate:()=>{}}}function Ad(){return[xd(),Sd(),Cd(),wd(),Td(),Ed(),Dd(),Od(),kd()]}var jd=[{id:`wheat`,label:`WHEAT`,start:0,end:.16},{id:`grain`,label:`GRAIN`,start:.12,end:.25},{id:`milling`,label:`MILLING`,start:.21,end:.36},{id:`flour`,label:`FLOUR`,start:.32,end:.47},{id:`mixing`,label:`MIXING`,start:.43,end:.6},{id:`dough`,label:`DOUGH`,start:.56,end:.72},{id:`proofing`,label:`PROOFING`,start:.68,end:.82},{id:`oven`,label:`OVEN`,start:.78,end:.94},{id:`bread`,label:`BREAD`,start:.9,end:1}],Md=new wn,Nd=new K,Pd=new U,Fd=new U,Id=class{scene=new Nn;camera=new Ho(34,1,.1,100);renderer;root=new G;pointer={x:0,y:0,targetX:0,targetY:0};quality;container;onStateChange;clock=new fs;progress=0;elapsed=0;animationFrame=0;resizeObserver=null;composer=null;bloom=null;disposed=!1;fieldGroup=new G;focalWheat=new G;kernelGroup=new G;millGroup=new G;flourCloud=new G;bowlGroup=new G;ingredientsGroup=new G;mixingSpoon=new G;doughGroup=new G;bubblesGroup=new G;ovenGroup=new G;breadGroup=new G;tableGroup=new G;crumbsGroup=new G;steamGroup=new G;wheatField;wheatHeads;wheatLeaves;fieldSamples=[];kernel;stones=[];flourPoints;flourPositions;flourSeeds;water;doughVariants=[];shapedDough;ovenLoaf;ovenGlow;loafWhole;loafSliceA;loafSliceB;knifeGroup=new G;crumbPoints;crumbPositions;crumbSeeds;steamPoints;steamPositions;steamSeeds;ovenLight;breadLight;keyLight;fillLight;chapters;constructor(e,t,n){this.container=e,this.quality=t,this.onStateChange=n,this.scene.background=new K(Ku.night),this.scene.fog=new Mn(Ku.night,.035),this.scene.add(this.root),this.renderer=new Au({antialias:!t.mobile,powerPreference:`high-performance`}),this.renderer.setPixelRatio(t.dpr),this.renderer.setSize(e.clientWidth||window.innerWidth,e.clientHeight||window.innerHeight,!1),this.renderer.outputColorSpace=ze,this.renderer.toneMapping=4,this.renderer.toneMappingExposure=.82,this.renderer.shadowMap.enabled=t.shadows,this.renderer.shadowMap.type=2,this.renderer.domElement.setAttribute(`aria-hidden`,`true`),this.renderer.domElement.className=`journey-canvas`,this.container.appendChild(this.renderer.domElement),t.bloom&&(this.composer=new Hu(this.renderer),this.composer.addPass(new Uu(this.scene,this.camera)),this.bloom=new Gu(new H(window.innerWidth,window.innerHeight),.22,.5,.82),this.composer.addPass(this.bloom)),this.camera.position.set(0,.35,7.2),this.camera.lookAt(0,0,-2),this.fillLight=new Ao(12173981,1053457,1.35),this.keyLight=new qo(16766349,2.5),this.keyLight.position.set(-4,7,5),this.keyLight.castShadow=t.shadows,this.keyLight.shadow.mapSize.set(t.mobile?512:1024,t.mobile?512:1024),this.keyLight.shadow.camera.near=.1,this.keyLight.shadow.camera.far=30,this.keyLight.shadow.camera.left=-10,this.keyLight.shadow.camera.right=10,this.keyLight.shadow.camera.top=10,this.keyLight.shadow.camera.bottom=-10,this.ovenLight=new Wo(Ku.ember,0,10,2),this.ovenLight.position.set(0,0,1.1),this.breadLight=new Wo(16761212,0,9,2),this.breadLight.position.set(1.8,2.2,4.2),this.scene.add(this.fillLight,this.keyLight,this.ovenLight,this.breadLight),this.chapters=Ad(),this.chapters.forEach(({group:e})=>{Qu(e,0),this.root.add(e)}),this.setupEvents(),this.setProgress(0),this.animationFrame=requestAnimationFrame(this.render)}getState(){let e=[...jd].reverse().find(e=>this.progress>=e.start)??jd[0];return{progress:this.progress,stageIndex:jd.indexOf(e)+1,stageLabel:e.label,remainingSeconds:Math.round(120*(1-this.progress))}}setProgress(e){this.progress=V.clamp(e,0,1);let t=this.getState();return this.onStateChange?.(t),t}resize=()=>{let e=this.container.clientWidth||window.innerWidth,t=this.container.clientHeight||window.innerHeight;this.camera.aspect=e/t,this.camera.updateProjectionMatrix(),this.renderer.setPixelRatio(this.quality.dpr),this.renderer.setSize(e,t,!1),this.composer?.setSize(e,t)};destroy(){this.disposed=!0,cancelAnimationFrame(this.animationFrame),this.resizeObserver?.disconnect(),window.removeEventListener(`pointermove`,this.handlePointer),window.removeEventListener(`resize`,this.resize),this.renderer.dispose(),this.composer?.dispose(),this.root.traverse(e=>{let t=e;t.geometry&&t.geometry.dispose(),(Array.isArray(t.material)?t.material:t.material?[t.material]:[]).forEach(e=>e.dispose())}),this.container.replaceChildren()}handlePointer=e=>{this.pointer.targetX=(e.clientX/window.innerWidth-.5)*2,this.pointer.targetY=(e.clientY/window.innerHeight-.5)*2};render=()=>{if(this.disposed)return;let e=Math.min(this.clock.getDelta(),.05);this.elapsed+=e;let t=this.quality.reducedMotion?.12:.065;this.pointer.x=V.lerp(this.pointer.x,this.pointer.targetX,t),this.pointer.y=V.lerp(this.pointer.y,this.pointer.targetY,t),this.applyJourney({progress:this.progress,time:this.elapsed,delta:e,pointer:this.pointer,quality:this.quality}),this.composer?this.composer.render():this.renderer.render(this.scene,this.camera),this.animationFrame=requestAnimationFrame(this.render)};setupEvents(){window.addEventListener(`pointermove`,this.handlePointer,{passive:!0}),window.addEventListener(`resize`,this.resize,{passive:!0}),`ResizeObserver`in window&&(this.resizeObserver=new ResizeObserver(()=>this.resize()),this.resizeObserver.observe(this.container))}applyJourney(e){this.applyChapterJourney(e)}applyChapterJourney(e){let t=e.progress,n=e.quality.reducedMotion?.15:1,r=jd.map(({start:e,end:t},n)=>[e,n===jd.length-1?1.01:t]),i=jd.reduce((e,n,r)=>t>=n.start?r:e,0),a=jd[i].start;this.chapters.forEach((o,s)=>{let[c,l]=r[s],u=s===i-1?1-Z((t-(a-.04))/.04):0,d=s===i?1:V.clamp(u,0,1);if(Qu(o.group,d),o.group.visible=d>.001,!o.group.visible)return;let f=ed(t,c,l);o.animate(f,e.time),o.group.position.y=Math.sin(f*Math.PI)*.045,o.group.position.x=e.pointer.x*.035*n,o.group.rotation.y=e.pointer.x*.018*n,o.group.scale.setScalar(.94+Z(f)*.06)}),this.updateChapterCamera(t,n),this.updateChapterLighting(t)}updateChapterCamera(e,t){let n=Pd.set(0,1.42,6.7),r=Fd.set(0,.48,0);e<.18?(n.set(0,1.23,6.15),r.set(0,.78,-.2)):e<.42?(n.set(0,1.47,6.85),r.set(0,.54,0)):e<.76?(n.set(0,1.72,6.95),r.set(0,.48,0)):e<.9&&(n.set(0,1.58,6.55),r.set(0,.55,0)),n.x+=this.pointer.x*.12*t,r.x+=this.pointer.x*.05*t,this.camera.position.lerp(n,.085),this.camera.lookAt(r)}updateChapterLighting(e){let t=Nd.set(Ku.night),n=new K(5464900),r=new K(12891534),i=new K(2169108),a=new K(1052942),o=new K;e<.2?o.lerpColors(t,n,Z(e/.2)):e<.52?o.lerpColors(n,r,Z((e-.2)/.32)):e<.82?o.lerpColors(r,i,Z((e-.52)/.3)):o.lerpColors(i,a,Z((e-.82)/.18)),this.scene.background=o,this.scene.fog instanceof Mn&&this.scene.fog.color.copy(o),this.fillLight.intensity=e>.76?1.05:1.45,this.keyLight.intensity=e>.76?2.8:2.35,this.ovenLight.intensity=Z(ed(e,.76,.91))*4.2,this.breadLight.intensity=Z(ed(e,.88,1))*1.8,this.bloom&&(this.bloom.strength=e>.76?.28:.16)}updateCamera(e,t){let n=e,r=t.quality.reducedMotion?.12:1,i=this.camera,a=Pd,o=Fd;if(a.set(t.pointer.x*.22*r,.25+t.pointer.y*-.12*r,7.1),o.set(0,.05,-2.6),n<.18){let e=Z(ed(n,0,.18));a.set(t.pointer.x*.22*r,.2+e*.3,V.lerp(7.2,4.55,e)),o.set(0,.06,V.lerp(-3.2,-2.1,e))}else if(n<.38){let e=Z(ed(n,.16,.38));a.set(t.pointer.x*.12*r,.4+e*.3,V.lerp(4.5,6.2,e)),o.set(0,V.lerp(.1,-.15,e),V.lerp(-1.7,0,e))}else if(n<.59){let e=Z(ed(n,.35,.59));a.set(t.pointer.x*.16*r,V.lerp(.1,1.1,e),V.lerp(5.8,7.3,e)),o.set(0,V.lerp(-.1,-.55,e),V.lerp(0,-.35,e))}else if(n<.76){let e=Z(ed(n,.56,.76));a.set(t.pointer.x*.2*r,V.lerp(1.1,.65,e),V.lerp(5.4,6.1,e)),o.set(0,V.lerp(-.5,-.12,e),-.35)}else if(n<.91){let e=Z(ed(n,.75,.91));a.set(t.pointer.x*.16*r,V.lerp(.65,.15,e),V.lerp(6.3,4.65,e)),o.set(0,-.05,V.lerp(-.6,.1,e))}else{let e=$u(ed(n,.89,1)),i=Math.sin(e*Math.PI)*.45;a.set(i+t.pointer.x*.18*r,.08+t.pointer.y*-.08*r,V.lerp(5.35,5.15,e)),o.set(0,-.18,.12)}i.position.lerp(a,t.quality.reducedMotion?.15:.075),i.lookAt(o)}updateLighting(e,t){let n=e,r=new K(Ku.night),i=new K(6714185),a=new K(12366222),o=new K(1773581),s=new K(2105622),c=Nd;n<.3?c.lerpColors(r,i,Z(ed(n,0,.25))):n<.55?c.lerpColors(i,a,Z(ed(n,.28,.55))):n<.79?c.lerpColors(a,o,Z(ed(n,.52,.79))):c.lerpColors(o,s,Z(ed(n,.78,1))),this.scene.background=c,this.scene.fog.color.copy(c),this.scene.fog.density=V.lerp(.05,.022,Z(ed(n,.3,.65)));let l=Z(ed(n,.72,.86))*(1-Z(ed(n,.9,1)));this.keyLight.color.setHex(Ku.wheatLight).lerp(new K(Ku.ember),l),this.keyLight.intensity=V.lerp(2.5,3.1,l),this.keyLight.position.x=-4+t.pointer.x*.8,this.fillLight.intensity=V.lerp(1.35,.95,Z(ed(n,.64,.85)))}updateWheat(e){let t=e.quality.reducedMotion?.008:.045;for(let n=0;n<this.fieldSamples.length;n+=1){let r=this.fieldSamples[n],i=Math.sin(e.time*.9+r.phase)*t+e.pointer.x*(Math.abs(r.z)<3?.016:0);Md.position.set(r.x,-1.15+r.y,r.z),Md.rotation.set(0,r.lean,i),Md.scale.setScalar(1),Md.scale.y=r.height,Md.updateMatrix(),this.wheatField.setMatrixAt(n,Md.matrix),Md.position.set(r.x+i*.12,-1.15+r.y+r.height*.55,r.z),Md.rotation.set(0,r.lean,i),Md.scale.set(.34,r.height*.28,.34),Md.updateMatrix(),this.wheatHeads.setMatrixAt(n,Md.matrix),Md.position.set(r.x+Math.sin(r.phase)*.04,-1.15+r.y+r.height*.36,r.z),Md.rotation.set(.25,r.lean+Math.sin(r.phase)*.4,i*1.4),Md.scale.set(.42,r.height*.16,.42),Md.updateMatrix(),this.wheatLeaves.setMatrixAt(n,Md.matrix)}this.wheatField.instanceMatrix.needsUpdate=!0,this.wheatHeads.instanceMatrix.needsUpdate=!0,this.wheatLeaves.instanceMatrix.needsUpdate=!0}updateFlour(e,t,n){let r=this.flourPoints.geometry.attributes.position,i=Z(ed(e,.38,1)),a=n.quality.reducedMotion?.015:.045;for(let o=0;o<this.flourSeeds.length;o+=3){let s=this.flourSeeds[o],c=this.flourSeeds[o+1],l=this.flourSeeds[o+2],u=n.time*a+o*.002,d=V.lerp(.18,.52,t);r.setXYZ(o/3,s*d+Math.sin(u+c)*.08,c*d-e*3.4*i+Math.cos(u)*.06,l*d+Math.sin(u*.7)*.08)}r.needsUpdate=!0;let o=td(this.progress,.32,.47,.035)*V.lerp(.04,.28,t)*(1-Z(ed(e,.8,1)));this.flourPoints.material.opacity=o}applyDoughVariants(e,t){let n=td(this.progress,.58,.84,.04),r=1-Z(ed(e,.12,.3)),i=Z(ed(e,.12,.26))*(1-Z(ed(e,.28,.42))),a=Z(ed(e,.34,.5))*(1-Z(ed(e,.7,.86))),o=Z(ed(e,.72,1));Qu(this.doughVariants[0],n*r),Qu(this.doughVariants[1],n*Math.max(i,.02)),Qu(this.doughVariants[2],n*Math.max(a,.02)),Qu(this.shapedDough,n*Math.max(o,.02)),this.doughVariants[0].scale.set(1.2-e*.25,.55+e*.16,.85),this.doughVariants[1].scale.setScalar(.72+i*.22),this.doughVariants[1].scale.y*=.88+Math.sin(t.time*1.5)*.012,this.doughVariants[2].rotation.z=Math.sin(t.time*.8)*.04,this.doughVariants[2].scale.set(.92,.65,.72),this.shapedDough.scale.set(.86+o*.12,.58+o*.15,.7+o*.08),this.mixingSpoon.rotation.z=V.lerp(-.32,.26,Z(ed(this.progress,.49,.61))),this.mixingSpoon.rotation.y=Math.sin(t.time*1.8)*.05}updateBubbles(e,t){this.bubblesGroup.children.forEach((n,r)=>{let i=r*1.7;n.position.y+=Math.sin(t.time*.65+i)*.002,n.scale.setScalar(.7+Math.sin(t.time*.75+i)*.12+e*.25)})}updateOvenMaterial(e){let t=this.ovenLoaf.material,n=new K(Ku.doughLight),r=new K(Ku.bread);t.color.lerpColors(n,r,Z(e)),t.roughness=V.lerp(.78,.95,e)}updateSteam(e,t){let n=this.steamPoints.geometry.attributes.position,r=Z(e)*(1-Z(ed(this.progress,.93,1)));this.steamPoints.material.opacity=r*.45;for(let r=0;r<this.steamSeeds.length;r+=3){let i=this.steamSeeds[r],a=this.steamSeeds[r+1],o=this.steamSeeds[r+2],s=r*.02;n.setXYZ(r/3,i+Math.sin(t.time*.55+s)*.12,a+Z(e)*1.35+(t.time*.06+s)%.8,o+Math.cos(t.time*.48+s)*.06)}n.needsUpdate=!0}updateBreadReveal(e,t){let n=Z(ed(this.progress,.87,.94)),r=Z(ed(e,.2,.38)),i=Z(ed(e,.7,.92)),a=r*(1-i),o=Math.max(1-a,i);Qu(this.loafWhole,n*o),Qu(this.loafSliceA,n*a),Qu(this.loafSliceB,n*a),this.loafSliceA.position.x=-a*.62,this.loafSliceB.position.x=a*.68,this.loafSliceA.rotation.z=-a*.04,this.loafSliceB.rotation.z=a*.035,this.knifeGroup.position.x=V.lerp(-1.8,.18,a),this.knifeGroup.position.y=V.lerp(1.25,.3,a),this.knifeGroup.rotation.z=V.lerp(-.22,-.05,a),Qu(this.knifeGroup,n*Z(ed(e,.35,.5))*(1-Z(ed(e,.78,.95)))),this.knifeGroup.rotation.y=t.pointer.x*.035}updateCrumbs(e,t){let n=this.crumbPoints.geometry.attributes.position,r=Z(ed(e,.54,.8));this.crumbPoints.material.opacity=r*.72;for(let e=0;e<this.crumbSeeds.length;e+=3){let i=e/3;n.setXYZ(i,this.crumbSeeds[e]*(1+r*1.5)+Math.sin(t.time*.9+i)*.025,this.crumbSeeds[e+1]+r*(.18+i%4*.035),this.crumbSeeds[e+2]+Math.cos(t.time*.8+i)*.02)}n.needsUpdate=!0}createWheatField(){let e=this.quality.wheatCount,t=new Ai(.018,.04,1,6),n=Xu(),r=new Oi(.055,.26,.018),i=X(6915147,{roughness:.96,emissive:1781010,emissiveIntensity:.24,vertexColors:!0}),a=X(Ku.wheat,{roughness:.84,emissive:4139784,emissiveIntensity:.16,vertexColors:!0}),o=X(4679224,{roughness:.96,emissive:1452047,emissiveIntensity:.28,vertexColors:!0,side:2}),s=new si(t,i,e),c=new si(n,a,e),l=new si(r,o,e);s.castShadow=s.receiveShadow=this.quality.shadows,c.castShadow=c.receiveShadow=this.quality.shadows,l.castShadow=l.receiveShadow=this.quality.shadows,s.userData.heads=c,s.userData.leaves=l;let u=491,d=()=>(u=u*16807%2147483647,(u-1)/2147483646);for(let t=0;t<e;t+=1){let e=(d()-.5)*18,n=d()*-12-2.5,r=.65+d()*.9,i={x:e,y:d()*.08,z:n,height:r,phase:d()*Math.PI*2,lean:(d()-.5)*.12};this.fieldSamples.push(i);let a=.82+d()*.28;Nd.setHex(Ku.mossLight).offsetHSL((d()-.5)*.05,0,(d()-.5)*.12),s.setColorAt(t,Nd),Nd.setHex(Ku.wheat).offsetHSL((d()-.5)*.04,.02,(d()-.5)*.1),c.setColorAt(t,Nd),Nd.setHex(Ku.moss).offsetHSL((d()-.5)*.05,0,(d()-.5)*.14),l.setColorAt(t,Nd),Md.position.set(e,-1.15+i.y,n),Md.rotation.set(0,i.lean,0),Md.scale.set(a,r,a),Md.updateMatrix(),s.setMatrixAt(t,Md.matrix),Md.position.set(e,-1.15+i.y+r*.54,n),Md.scale.set(a*.34,r*.28,a*.34),Md.updateMatrix(),c.setMatrixAt(t,Md.matrix),Md.position.set(e,-1.15+i.y+r*.34,n),Md.rotation.set(.28,i.lean+.35,-.18),Md.scale.set(a*.42,r*.16,a*.42),Md.updateMatrix(),l.setMatrixAt(t,Md.matrix)}return s.instanceColor&&(s.instanceColor.needsUpdate=!0),c.instanceColor&&(c.instanceColor.needsUpdate=!0),l.instanceColor&&(l.instanceColor.needsUpdate=!0),s}createGround(){let e=new q(new ki(17,32),X(Ku.moss,{roughness:1}));return e.rotation.x=-Math.PI/2,e.position.y=-1.19,e.position.z=-5,e.scale.set(1,1,1.2),e.receiveShadow=this.quality.shadows,e}createFocalWheat(){let e=new q(new Ai(.035,.055,2.9,6),X(Ku.mossLight,{roughness:.92,emissive:2838296,emissiveIntensity:.38}));e.position.y=.36,e.rotation.z=-.07,e.castShadow=this.quality.shadows,this.focalWheat.add(e);let t=new G,n=X(Ku.wheatLight,{roughness:.76,emissive:9199640,emissiveIntensity:.38}),r=X(15318367,{roughness:.78,emissive:7030541,emissiveIntensity:.28});for(let e=0;e<8;e+=1){let i=new q(Yu(),n),a=e%2?1:-1;i.scale.setScalar(.2-e*.004),i.position.set(a*.1*(1-e*.04),.48+e*.16,Math.sin(e)*.015),i.rotation.z=e%2?-.34:.34,t.add(i);let o=new q(new Ai(.009,.015,.34,5),r);o.position.set(a*.2,.64+e*.16,.01),o.rotation.z=a*-.32,t.add(o)}let i=new q(Yu(),n);i.position.set(0,1.8,0),i.rotation.z=Math.PI/2,i.scale.setScalar(.18),t.add(i),t.position.y=.1,t.rotation.z=-.08,this.focalWheat.add(t)}createKernel(){let e=X(Ku.wheatLight,{roughness:.68}),t=new q(Yu(),e);t.castShadow=this.quality.shadows,t.position.set(0,0,0),this.kernelGroup.add(t);let n=new q(new $a(.28,.015,5,16),X(Ku.wheat,{roughness:.7}));return n.rotation.y=Math.PI/2,n.scale.set(1,1.5,1),n.position.z=.05,this.kernelGroup.add(n),t}createMillstones(){let e=X(7828582,{roughness:.94}),t=X(11576971,{roughness:.84}),n=X(3487535,{roughness:.98});for(let r of[.36,-.38]){let i=new G,a=new q(new Ai(1.42,1.32,.4,16),e);a.castShadow=a.receiveShadow=this.quality.shadows,i.add(a);let o=new q(new $a(1.36,.055,6,32),t);o.rotation.x=Math.PI/2,i.add(o);let s=new q(new $a(.34,.13,6,18),t);s.rotation.x=Math.PI/2,i.add(s);let c=new q(new Ai(.2,.2,.035,16),n);c.position.y=.21,i.add(c);for(let e=0;e<5;e+=1){let n=new q(new $a(.52+e*.17,.022,5,28),t);n.rotation.x=Math.PI/2,n.position.y=.205*(e%2?-1:1),n.scale.x=1+Math.sin(e)*.02,i.add(n)}i.position.y=r,this.stones.push(i),this.millGroup.add(i)}let r=new q(new Ai(.105,.105,.94,10),n);r.position.y=0,this.millGroup.add(r);let i=new q(new Ai(.33,.15,.28,10),X(9202243,{roughness:.9}));i.position.y=.79,i.castShadow=this.quality.shadows;let a=new q(new Ai(.13,.13,.18,10),X(5980203,{roughness:.94}));a.position.y=.59,this.millGroup.add(i,a);let o=new G;o.position.y=.575;for(let e=0;e<6;e+=1){let n=new q(new Oi(.92,.018,.028),t);n.position.x=.48,n.rotation.y=e/6*Math.PI,o.add(n)}this.millGroup.add(o);let s=new q(new ki(2.4,32),X(1447186,{roughness:1,opacity:.66}));s.rotation.x=-Math.PI/2,s.position.y=-.64,s.position.z=.2,this.millGroup.add(s)}createFlourCloud(){let e=this.quality.flourCount,t=new Float32Array(e*3),n=new Float32Array(e*3),r=1327,i=()=>(r=r*16807%2147483647,(r-1)/2147483646);for(let r=0;r<e;r+=1){let e=r*3,a=i()**1.55*.92,o=i()*Math.PI*2,s=(i()-.5)*.72+(1-a/.92)*.12,c=Math.cos(o)*a,l=Math.sin(o)*a*.65;n[e]=c,n[e+1]=s,n[e+2]=l,t[e]=c,t[e+1]=s,t[e+2]=l}let a=new Dr;a.setAttribute(`position`,new fr(t,3));let o=new xi(a,qu(Ku.flour,this.quality.mobile?.045:.06,0));return o.frustumCulled=!1,[o,t,n]}createFlourPile(){let e=new q(new Xa([new H(.02,-.08),new H(.3,-.09),new H(.58,-.07),new H(.78,0),new H(.9,.11),new H(.86,.22),new H(.7,.32),new H(.52,.42),new H(.32,.51),new H(.12,.56),new H(.02,.57)],24),new Rr({color:16774108,transparent:!0}));e.position.set(0,-.62,.16),e.scale.set(1,.9,.72),e.castShadow=e.receiveShadow=this.quality.shadows;let t=new q(new ki(1,28),X(9275512,{roughness:1,opacity:.1}));return t.rotation.x=-Math.PI/2,t.position.set(0,-.7,.18),t.scale.set(1,.55,1),new G().add(e,t)}createBowlAndIngredients(){let e=X(13288362,{roughness:.72}),t=new q(new Xa([new H(.48,-.42),new H(.82,-.36),new H(1.16,-.14),new H(1.3,.18),new H(1.25,.4),new H(1.08,.52),new H(.96,.48),new H(1,.28),new H(.9,.02),new H(.72,-.18),new H(.44,-.27)],20),e);t.castShadow=t.receiveShadow=this.quality.shadows,this.bowlGroup.add(t);let n=new q(new ki(.94,24),X(Ku.flour,{roughness:.98}));n.rotation.x=-Math.PI/2,n.position.y=.39,this.bowlGroup.add(n),this.water=new q(new Qa(.36,12,8),X(4169146,{roughness:.2,metalness:.05,opacity:.78,emissive:1194311,emissiveIntensity:.22})),this.water.position.set(.42,1.18,.04),this.water.scale.set(.62,.9,.62),this.ingredientsGroup.add(this.water);let r=X(Ku.salt,{roughness:.9});for(let e=0;e<6;e+=1){let t=new q(new Ya(.07,0),r);t.position.set(Math.sin(e*2.1)*.55,.42+e%3*.05,Math.cos(e*1.7)*.36),this.ingredientsGroup.add(t)}let i=X(Ku.yeast,{roughness:.92});for(let e=0;e<5;e+=1){let t=new q(new Ya(.1,1),i);t.position.set(-.38+e%2*.16,.48+Math.floor(e/2)*.08,-.04+e%3*.12),this.ingredientsGroup.add(t)}let a=new q(new Ai(.045,.055,.95,8),X(8080174,{roughness:.84}));a.position.y=.5;let o=new q(new Qa(.18,12,8),X(10248761,{roughness:.88}));o.position.y=.06,o.scale.set(.78,.28,1.05),this.mixingSpoon.add(a,o),this.mixingSpoon.position.set(-.1,.4,.48),this.mixingSpoon.rotation.z=-.32,this.ingredientsGroup.add(this.mixingSpoon)}createDoughWorld(){let e=new q(Ju(1.2,.52,.76,2),X(Ku.dough,{roughness:.98})),t=new q(Ju(.86,.8,.8,3),X(Ku.doughLight,{roughness:.95})),n=new q(Ju(1.3,.46,.78,3),X(Ku.dough,{roughness:.92})),r=new q(Ju(1.16,.64,.82,3),X(Ku.doughLight,{roughness:.95}));return e.castShadow=t.castShadow=n.castShadow=r.castShadow=this.quality.shadows,e.position.y=.08,t.position.y=.08,n.position.y=.08,r.position.y=.08,this.doughVariants.push(e,t,n),this.doughGroup.add(e,t,n,r),r}createBubbles(){let e=X(Ku.flour,{roughness:.45,opacity:.22,transparent:!0});for(let t=0;t<11;t+=1){let n=new q(new $a(.07+t%3*.022,.018,6,14),e),r=t/11*Math.PI*2;n.position.set(Math.cos(r)*(.45+t%2*.35),.4+t%4*.14,.52+Math.sin(r)*.08),this.bubblesGroup.add(n)}}createOven(){let e=X(3482911,{roughness:.88}),t=X(7096629,{roughness:.72}),n=X(1050373,{roughness:.9}),r=new q(new Oi(4.5,3.6,2.1),e);r.position.y=.12,r.castShadow=r.receiveShadow=this.quality.shadows,this.ovenGroup.add(r);let i=new q(new Oi(3.2,2.25,.16),n);i.position.set(0,.1,1.08),this.ovenGroup.add(i);let a=new q(new Za(2.22,1.3),X(13126688,{emissive:Ku.ember,emissiveIntensity:1.5,opacity:0,depthWrite:!1}));a.position.set(0,.12,1.18),this.ovenGroup.add(a);let o=new q(new Oi(2.75,.08,.82),t);o.position.set(0,-.82,.78),this.ovenGroup.add(o);let s=new q(new Oi(2.5,.035,.48),X(1576973,{roughness:.8,metalness:.2}));s.position.set(0,-.6,.9),this.ovenGroup.add(s);for(let e=-2;e<=2;e+=1){let t=new q(new Ai(.025,.025,.5,6),X(3875865,{roughness:.8,metalness:.18}));t.rotation.x=Math.PI/2,t.position.set(e*.42,-.58,.9),this.ovenGroup.add(t)}let c=new q(new Oi(3.62,.18,.24),t);c.position.set(0,1.3,1.24);let l=c.clone();l.position.y=-1.12;let u=new q(new Oi(.18,2.5,.24),t);u.position.set(-1.72,.1,1.24);let d=u.clone();d.position.x=1.72,this.ovenGroup.add(c,l,u,d);let f=new q(new Ai(.06,.06,2.4,8),t);f.rotation.z=Math.PI/2,f.position.set(0,-1.48,1.3),this.ovenGroup.add(f);let p=new q(Zu(),X(14128980,{roughness:.9,emissive:4923917,emissiveIntensity:.3}));p.position.set(0,-.18,.48),this.ovenGroup.add(p);let m=X(8074518,{roughness:.98});for(let e=0;e<3;e+=1){let t=nd(m,.58+e*.04);t.position.set(-.4+e*.4,.48,1.28),this.ovenGroup.add(t)}return[p,a]}createBreadReveal(){let e=(e,t,n=!1)=>{let r=new G,i=new q(Zu(),e);if(i.castShadow=i.receiveShadow=this.quality.shadows,r.add(i),n){let e=new q(Zu(),X(16107906,{roughness:.95,emissive:9128987,emissiveIntensity:.26}));e.position.set(0,-.04,.43),e.scale.set(.76,.64,.5),e.castShadow=e.receiveShadow=this.quality.shadows,r.add(e)}for(let e=0;e<3;e+=1){let n=nd(t,.62+e*.04);n.position.set(-.42+e*.43,.56,1.02),r.add(n)}return r},t={roughness:.88,emissive:10967586,emissiveIntensity:.92},n={roughness:.96,emissive:4988424,emissiveIntensity:.34},r=e(X(15771483,t),X(Ku.crust,n)),i=e(X(15771483,t),X(Ku.crust,n),!0),a=e(X(15771483,t),X(Ku.crust,n),!0);return r.scale.set(.82,.64,.72),i.scale.set(.82,.64,.72),a.scale.set(.82,.64,.72),this.breadGroup.add(r,i,a,this.knifeGroup),[r,i,a]}createTableAndKnife(){let e=new q(new Oi(7.5,.28,4.8),X(Ku.table,{roughness:.94}));e.position.set(0,-1.4,0),e.castShadow=e.receiveShadow=this.quality.shadows,this.tableGroup.add(e);let t=X(7426872,{roughness:1,opacity:.4});for(let e=0;e<7;e+=1){let n=new q(new Oi(3.2+e%3*.65,.014,.026),t);n.position.set(e%2?-.7:.7,-1.245,-1.35+e*.45),n.rotation.y=(e%3-1)*.05,this.tableGroup.add(n)}let n=new q(new Ai(.08,.11,1.25,8),X(5057053,{roughness:.82}));n.rotation.z=Math.PI/2,n.position.set(-.64,.32,.14);let r=new q(new Oi(1.55,.045,.28),X(12629402,{roughness:.34,metalness:.6}));r.position.set(.45,.32,.14),r.rotation.z=.03,this.knifeGroup.add(n,r)}createCrumbs(){let e=this.quality.crumbCount,t=new Float32Array(e*3),n=new Float32Array(e*3),r=6547,i=()=>(r=r*16807%2147483647,(r-1)/2147483646);for(let r=0;r<e;r+=1){let e=r*3;n[e]=(i()-.5)*2.8,n[e+1]=-.92+i()*.3,n[e+2]=(i()-.5)*1.05,t[e]=n[e],t[e+1]=n[e+1],t[e+2]=n[e+2]}let a=new Dr;return a.setAttribute(`position`,new fr(t,3)),[new xi(a,qu(Ku.crumb,this.quality.mobile?.06:.08,0)),t,n]}createSteam(){let e=this.quality.mobile?24:46,t=new Float32Array(e*3),n=new Float32Array(e*3),r=3221,i=()=>(r=r*16807%2147483647,(r-1)/2147483646);for(let r=0;r<e;r+=1){let e=r*3;n[e]=(i()-.5)*1.9,n[e+1]=-.2+i()*.5,n[e+2]=.6+i()*.35,t[e]=n[e],t[e+1]=n[e+1],t[e+2]=n[e+2]}let a=new Dr;return a.setAttribute(`position`,new fr(t,3)),[new xi(a,qu(16245960,this.quality.mobile?.09:.12,0)),t,n]}},Ld=document.querySelector(`#experience`),Rd=document.querySelector(`#scroll-rail`),zd=document.querySelector(`#loader`),Bd=document.querySelector(`#fallback`),Vd=document.querySelector(`#stage-number`),Hd=document.querySelector(`#stage-label`),Ud=document.querySelector(`#timer`),Wd=document.querySelector(`#intro-copy`),Gd=document.querySelector(`#scene-copy`),Kd=document.querySelector(`#finish-copy`),qd=document.querySelector(`#sound-toggle`),Jd=document.querySelector(`#sound-label`),Yd=document.querySelector(`#replay`);if(!Ld||!Rd||!zd||!Bd||!Vd||!Hd||!Ud||!Wd||!Gd||!Kd||!qd||!Jd||!Yd)throw Error(`Journey to Bread could not find its interface shell.`);var Xd=new ju,Zd=Nu(),Qd=null,$d=null;function ef(e){let t=Math.max(0,Math.round(e));return`${String(Math.floor(t/60)).padStart(2,`0`)}:${String(t%60).padStart(2,`0`)}`}function tf(e){let t=[`WHEAT`,`ONE GRAIN.`,`BREAKING IT DOWN.`,`FLOUR.`,`FLOUR. WATER. SALT. TIME.`,`MAKE IT SOFT.`,`WAIT.`,`HEAT.`,``];Vd.textContent=`${String(e.stageIndex).padStart(2,`0`)} / 09`,Hd.textContent=e.stageLabel,Ud.textContent=ef(e.remainingSeconds),Ud.setAttribute(`aria-label`,`${ef(e.remainingSeconds)} remaining in the journey`),Wd.style.opacity=String(Math.max(0,1-e.progress*14)),Gd.textContent=t[e.stageIndex-1]??``,Gd.classList.toggle(`is-visible`,e.progress>.17&&e.progress<.93),Kd.classList.toggle(`is-visible`,e.progress>.93),Kd.setAttribute(`aria-hidden`,String(e.progress<=.93)),document.documentElement.style.setProperty(`--journey-progress`,String(e.progress)),Xd.setProgress(e.progress)}function nf(e){let t=document.modelContext;if(!t?.registerTool)return;let n=new AbortController;Promise.resolve(t.registerTool({name:`set_journey_progress`,title:`Set journey progress`,description:`Move Journey to Bread to a specific scroll progress between 0 and 1 and return the visible stage and countdown.`,inputSchema:{type:`object`,properties:{progress:{type:`number`,minimum:0,maximum:1}},required:[`progress`],additionalProperties:!1},annotations:{readOnlyHint:!1,untrustedContentHint:!1},execute(t){let n=t?.progress;if(typeof n!=`number`||!Number.isFinite(n)||n<0||n>1)throw Error(`progress must be a finite number between 0 and 1`);return e.scrollToProgress(n)}},{signal:n.signal})).catch(()=>void 0),window.addEventListener(`beforeunload`,()=>n.abort(),{once:!0})}try{Qd=new Id(Ld,Zd,tf),$d=new Mu(Qd,Rd,tf),nf($d),qd.addEventListener(`click`,async()=>{let e=await Xd.toggle();qd.setAttribute(`aria-pressed`,String(e)),qd.setAttribute(`aria-label`,e?`Turn sound off`:`Turn sound on`),Jd.textContent=e?`Sound on`:`Sound off`,qd.classList.toggle(`is-on`,e)}),Yd.addEventListener(`click`,()=>$d?.replay());let e=Number(new URLSearchParams(window.location.search).get(`progress`));Number.isFinite(e)&&e>=0&&e<=1&&window.setTimeout(()=>$d?.scrollToProgress(e),120),window.setTimeout(()=>zd.classList.add(`is-hidden`),Zd.reducedMotion?100:360)}catch(e){console.error(e),Ld.hidden=!0,Rd.hidden=!0,zd.hidden=!0,Bd.hidden=!1,document.body.classList.add(`webgl-fallback`)}window.addEventListener(`beforeunload`,()=>{$d?.destroy(),Qd?.destroy(),Xd.disable()},{once:!0});