...
void main() {
	...
	if ( coord.x >= 1.0 ) {
		...
		}`},Md=class extends bd{constructor(){super(),this.isOutputPass=!0,this.uniforms=jo.clone(jd.uniforms),this.material=new Fo({name:jd.name,uniforms:this.uniforms,vertexShader:jd.vertexShader,fragmentShader:jd.fragmentShader}),this._fsQuad=new Cd(this.material),this._outputColorSpace=null,this._toneMapping=null}render(e,t,n){this.uniforms.tDiffuse.value=n.texture,this.uniforms.toneMappingExposure.value=e.toneMappingExposure,(this._outputColorSpace!==e.outputColorSpace||this._toneMapping!==e.toneMapping)&&(this._outputColorSpace=e.outputColorSpace,this._toneMapping=e.toneMapping,this.material.defines={},Nt.getTransfer(this._outputColorSpace)===`srgb`&&(this.material.defines.SRGB_TRANSFER=``),this._toneMapping===1?this.material.defines.LINEAR_TONE_MAPPING=``:this._toneMapping===2?this.material.defines.REINHARD_TONE_MAPPING=``:this._toneMapping===3?this.material.defines.CINEON_TONE_MAPPING=``:this._toneMapping===4?this.material.defines.ACES_FILMIC_TONE_MAPPING=``:this._toneMapping===6?this.material.defines.AGX_TONE_MAPPING=``:this._toneMapping===7?this.material.defines.NEUTRAL_TONE_MAPPING=``:this._toneMapping===5&&(this.material.defines.CUSTOM_TONE_MAPPING=``),this.material.needsUpdate=!0),this.renderToScreen===!0?(e.setRenderTarget(null),this._fsQuad.render(e)):(e.setRenderTarget(t),this.clear&&e.clear(e.autoClearColor,e.autoClearDepth,e.autoClearStencil),this._fsQuad.render(e))}dispose(){this.material.dispose(),this._fsQuad.dispose()}};function Nd(e){return Tt.clamp(e,0,1)}function Pd(e){let t=Nd(e);return t*t*t*(t*(t*6-15)+10)}function Fd(e){return 1-(1-Nd(e))**3}function Id(e){let t=Nd(e);return t*t*(3-2*t)}function Ld(e,t=.5,n=.5){let r=Math.abs(e-t)/Math.max(n,1e-4);return Math.max(0,1-r*r)**2}function X(e,t,n,r=Pd){return r(Tt.clamp((e-t)/Math.max(n-t,1e-4),0,1))}function Rd(e,t,n,r=.12){let i=X(e,t,t+r),a=1-X(e,n-r,n);return Tt.clamp(Math.min(i,a),0,1)}function zd(e,t,n,r=.1){return X(e,t+r*(n-t),n)}function Bd(e,t,n,r){return Tt.lerp(e,t,1-Math.exp(-n*Math.max(r,0)))}function Vd(e,t,n,r,i){let a=Math.max(0,Math.min(i,.05)),o=2/Math.max(.001,r),s=e-t,c=n+o*s,l=Math.exp(-o*a);return{value:t+(s+c*a)*l,velocity:(n-o*c*a)*l}}function Hd(e,t,n){let r=e[t],i=Tt.clamp(r.tension??0,0,1);if(t===0){let t=e[1];return(n(t.value)-n(r.value))/Math.max(t.at-r.at,1e-4)*(1-i)}if(t===e.length-1){let a=e[t-1];return(n(r.value)-n(a.value))/Math.max(r.at-a.at,1e-4)*(1-i)}let a=e[t-1],o=e[t+1];return(n(o.value)-n(a.value))/Math.max(o.at-a.at,1e-4)*(1-i)}function Ud(e,t){let n=e[t],r=Tt.clamp(n.tension??0,0,1);if(t===0){let t=e[1];return(t.value-n.value)/Math.max(t.at-n.at,1e-4)*(1-r)}if(t===e.length-1){let i=e[t-1];return(n.value-i.value)/Math.max(n.at-i.at,1e-4)*(1-r)}let i=e[t-1],a=e[t+1],o=Math.max(n.at-i.at,1e-4),s=Math.max(a.at-n.at,1e-4),c=(n.value-i.value)/o,l=(a.value-n.value)/s;if(c===0||l===0||Math.sign(c)!==Math.sign(l))return 0;let u=2*s+o,d=s+2*o;return(u+d)/(u/c+d/l)*(1-r)}function Wd(e,t,n,r,i,a){let o=a*a,s=o*a,c=2*s-3*o+1,l=s-2*o+a,u=-2*s+3*o,d=s-o;return c*e+l*i*n+u*t+d*i*r}function Gd(e,t){let n=Nd(e);if(n<=t[0].at)return t[0].value;for(let e=1;e<t.length;e+=1){let r=t[e-1],i=t[e];if(n<=i.at){let a=Math.max(i.at-r.at,1e-4),o=Tt.clamp((n-r.at)/a,0,1),s=Wd(r.value,i.value,Ud(t,e-1),Ud(t,e),a,o);return Tt.clamp(s,Math.min(r.value,i.value),Math.max(r.value,i.value))}}return t[t.length-1].value}function Kd(e,t,n){let r=Nd(e);if(r<=t[0].at)return n.copy(t[0].value);for(let e=1;e<t.length;e+=1){let i=t[e-1],a=t[e];if(r<=a.at){let o=Math.max(a.at-i.at,1e-4),s=Tt.clamp((r-i.at)/o,0,1),c=Hd(t,e-1,e=>e.x),l=Hd(t,e-1,e=>e.y),u=Hd(t,e-1,e=>e.z),d=Hd(t,e,e=>e.x),f=Hd(t,e,e=>e.y),p=Hd(t,e,e=>e.z);return n.set(Wd(i.value.x,a.value.x,c,d,o,s),Wd(i.value.y,a.value.y,l,f,o,s),Wd(i.value.z,a.value.z,u,p,o,s))}}return n.copy(t[t.length-1].value)}function qd(e,t,n,r,i=new G){let a=Nd(n);return i.lerpVectors(e,t,a),i.y+=Math.sin(a*Math.PI)*r,i}var Jd={night:658700,moss:2505255,mossLight:6255937,wheat:14067789,wheatLight:16043890,stone:5986896,stoneLight:9275765,flour:15853520,salt:16314586,yeast:12814431,dough:13208140,doughLight:15775850,oven:2430226,ember:16740146,crust:10111776,bread:13137196,crumb:15976065,table:4403494,ink:1119762};function Yd(e,t,n=.8){return new Ii({color:e,size:t,sizeAttenuation:!0,transparent:!0,opacity:n,depthWrite:!1})}var Xd=new G,Zd=new G,Qd=[{center:-.6,width:.92,depth:1.03},{center:-.01,width:1.08,depth:1.12},{center:.58,width:.86,depth:.96}];function $d(e){let t=e;return()=>(t=t*16807%2147483647,(t-1)/2147483646)}var Z=$d(4937),ef=new Map;function tf(t,n){let r=ef.get(t);if(r)return r;let i=document.createElement(`canvas`);i.width=i.height=512;let a=i.getContext(`2d`),o=$d(t.length*431);a.fillStyle={wood:`#e1d1b8`,stone:`#d8d5ca`,flour:`#fffaf0`,crust:`#e7c690`,crumb:`#f8e2b4`}[t],a.fillRect(0,0,512,512);let s=a.createLinearGradient(0,0,t===`wood`?512:340,512);s.addColorStop(0,t===`flour`?`rgba(255,250,236,0.045)`:t===`crumb`?`rgba(255,246,216,0.11)`:`rgba(255,248,224,0.12)`),s.addColorStop(.45,t===`flour`?`rgba(91,72,45,0.012)`:t===`crumb`?`rgba(155,92,43,0.025)`:`rgba(70,39,18,0.025)`),s.addColorStop(1,t===`flour`?`rgba(54,42,25,0.028)`:t===`crumb`?`rgba(99,50,22,0.07)`:`rgba(21,15,10,0.09)`),a.fillStyle=s,a.fillRect(0,0,512,512);for(let e=0;e<(t===`flour`?4300:t===`crumb`?2400:5900);e+=1){let e=o()*512,n=o()*512,r=t===`flour`?o()*.04:t===`crumb`?.012+o()*.052:.02+o()*.075;a.fillStyle=o()>.5?`rgba(255,247,226,${r})`:t===`crumb`?`rgba(121,69,31,${r*.72})`:`rgba(38,22,10,${r*.8})`;let i=t===`wood`?14+o()*64:t===`crust`?1+o()*4:1+o()*2;a.fillRect(e,n,i,t===`wood`?.65:.8+o()*1.6)}if(t===`wood`){for(let e=0;e<34;e+=1){let e=o()*512;a.strokeStyle=`rgba(66,34,17,${.045+o()*.085})`,a.lineWidth=.7+o()*1.6,a.beginPath(),a.moveTo(-20,e),a.bezierCurveTo(150,e-11,350,e+13,532,e+o()*10),a.stroke()}for(let e=0;e<2;e+=1){let e=100+o()*320,t=80+o()*350;a.strokeStyle=`rgba(73,38,18,0.11)`,a.lineWidth=2,a.beginPath(),a.ellipse(e,t,25+o()*18,7+o()*5,0,0,Math.PI*2),a.stroke()}}else if(t===`stone`)for(let e=0;e<22;e+=1){let e=o()*512;a.strokeStyle=`rgba(61,56,48,${.025+o()*.055})`,a.lineWidth=2+o()*5,a.beginPath(),a.moveTo(-30,e),a.bezierCurveTo(120,e+35,330,e-28,542,e+12),a.stroke()}else if(t===`crumb`)for(let e=0;e<150;e+=1){let e=o()*512,t=o()*512,n=.8+o()**2.2*4.2;a.fillStyle=`rgba(113,61,28,${.045+o()*.11})`,a.beginPath(),a.ellipse(e,t,n,n*(.55+o()*.5),o()*Math.PI,0,Math.PI*2),a.fill()}let c=new Wi(i);return c.colorSpace=Ie,c.wrapS=c.wrapT=e,c.repeat.set(t===`wood`?1:1.25,t===`wood`?1:1.25),c.anisotropy=n,ef.set(t,c),c}function Q(e,t,n,r={}){return new Io({color:e,roughness:.84,metalness:.01,transparent:!0,...n?{map:tf(n,t.anisotropy),bumpMap:tf(n,t.anisotropy),bumpScale:n===`stone`?.034:n===`crust`?.022:n===`wood`?.014:n===`crumb`?.012:.006}:{},...r})}function $(e,t,n,r=0,i=0,a=0){let o=new hi(e,t);return o.position.set(r,i,a),o.castShadow=!0,o.receiveShadow=!0,n?.add(o),o}function nf(e,t,n,r,i){let a=$(new Xi(n,n,e.distanceTo(t),8),r,i);return a.position.copy(e).add(t).multiplyScalar(.5),a.quaternion.setFromUnitVectors(new G(0,1,0),t.clone().sub(e).normalize()),a}function rf(e,t,n,r){return $(new To(new ca(e),28,t,8,!1),n,r)}function af(e,t,n,r,i){let a=$(new wo(e,t,8,64),n,r,0,i,0);return a.rotation.x=Math.PI/2,a}function of(e,t,n,r=.14){let i=new ka,a=-e/2,o=-t/2,s=r;i.moveTo(a+s,o),i.lineTo(a+e-s,o),i.quadraticCurveTo(a+e,o,a+e,o+s),i.lineTo(a+e,o+t-s),i.quadraticCurveTo(a+e,o+t,a+e-s,o+t),i.lineTo(a+s,o+t),i.quadraticCurveTo(a,o+t,a,o+t-s),i.lineTo(a,o+s),i.quadraticCurveTo(a,o,a+s,o);let c=new mo(i,{depth:n,bevelEnabled:!0,bevelSegments:3,bevelSize:.025,bevelThickness:.025,curveSegments:10});return c.rotateX(-Math.PI/2),c}function sf(e,t,n=3.9,r=2.7,i=12618325){let a=$(of(n,r,.13),Q(i,t,`wood`,{roughness:.86,bumpScale:.012}),e,0,-.16,0);a.name=`wood-work-surface`;let o=$d(Math.round(n*r*977)),s=Q(new q(i).multiplyScalar(.48),t,void 0,{roughness:.96,transparent:!0,opacity:.24,depthWrite:!1});for(let t=0;t<13;t+=1){let t=(o()-.5)*r*.76,i=(o()-.5)*.045,a=rf([new G(-n*.44,-.019,t),new G(-n*.08,-.018,t+i),new G(n*.2,-.019,t-i*.45),new G(n*.44,-.019,t+i*.3)],.0022+o()*.0014,s,e);a.castShadow=a.receiveShadow=!1}return a}function cf(e,t,n,r,i){let a=new Xi(e,t,n,r,3),o=a.attributes.position,s=$d(i),c=Array.from({length:r},()=>(s()-.5)*.045);for(let e=0;e<o.count;e+=1){let t=o.getX(e),n=o.getZ(e),a=Math.atan2(n,t),s=1+c[(Math.round((a+Math.PI)/(Math.PI*2)*r)%r+r)%r]+Math.sin(a*5+i)*.008;o.setX(e,t*s),o.setZ(e,n*s)}return o.needsUpdate=!0,a.computeVertexNormals(),a}function lf(e,t,n,r=1.3,i=.006){let a=new Yi(.013,6);a.rotateX(-Math.PI/2);let o=new Di(a,Q(15787987,t,`flour`,{roughness:1}),n),s=new Cn;for(let e=0;e<n;e+=1){let t=Z()*Math.PI*2,n=Math.sqrt(Z())*r;s.position.set(Math.cos(t)*n,i,Math.sin(t)*n*.66),s.scale.setScalar(.25+Z()*1.05),s.updateMatrix(),o.setMatrixAt(e,s.matrix)}return o.castShadow=!1,e.add(o),o}var uf=class{object;materials;last=-1;constructor(e){this.object=e,this.materials=[],e.traverse(e=>{let t=e;(Array.isArray(t.material)?t.material:t.material?[t.material]:[]).forEach(e=>{this.materials.some(t=>t.material===e)||this.materials.push({material:e,opacity:e.opacity,depthWrite:e.depthWrite})})})}set(e){let t=Tt.clamp(e,0,1);t!==this.last&&(this.last=t,this.object.visible=t>.002,this.materials.forEach(e=>{e.material.transparent=!0,e.material.opacity=t*e.opacity,e.material.depthWrite=e.depthWrite&&t>.96}))}},df=class{mesh;original;position;colors;lastProgress=-1;color=new q;pale=new q(Jd.flour);wet=new q(14200434);proofed=new q(15055736);crust=new q(12149282);toasted=new q(6104079);cut=new q(15779975);raised=new q(15906909);constructor(e,t){let n=new So(1,t.mobile?72:t.tier===`high`?128:96,t.mobile?36:t.tier===`high`?64:48);this.position=n.attributes.position,this.original=new Float32Array(this.position.array),this.colors=new fr(new Float32Array(this.position.count*3),3),n.setAttribute(`color`,this.colors),this.mesh=$(n,Q(16777215,t,`flour`,{vertexColors:!0,roughness:.96,metalness:0,emissive:2429447,emissiveIntensity:.035}),e),this.mesh.name=`hero-dough-loaf`,this.mesh.frustumCulled=!1}apply(e){if(e===this.lastProgress)return;this.lastProgress=e;let t=X(e,.502,.575),n=X(e,.598,.692),r=X(e,.705,.778),i=X(e,.834,.885),a=X(e,.842,.925),o=X(e,.776,.803),s=X(e,.61,.69,e=>e),c=Math.sin(s*Math.PI*3)**2*Ld(s),l=X(e,.989,.997)*.9,u=.8+t*.12+n*.2+r*.18+i*.14,d=.08+t*.56+r*.2+i*.12,f=.69+t*.045+r*.06-a*.018,p=X(e,.492,.565,e=>e)*Math.PI*5;for(let e=0;e<this.position.count;e+=1){let m=this.original[e*3],h=this.original[e*3+1],g=this.original[e*3+2],_=Math.max(0,h),v=Nd((h+.12)/1.12),y=Math.max(0,(h+.64)/1.64),b=Math.exp(-(((m-Math.sin(s*Math.PI*3)*.4)/.42)**2))*c,x=Math.sin(m*7.5+g*5.5-p)*_*t*(1-t)*.125,S=Math.sin(m*6.5+s*8)*b*_*.06,C=m+g*.32-Tt.lerp(-.3,.26,s),w=(Math.exp(-(((C+.16)/.22)**2))*.09-Math.exp(-((C/.105)**2))*.055)*_*Ld(s),T=Math.sin(m*4.3+g*7.1)*t*(1-t)*.038,E=1-(r*.035+i*.12)*Math.abs(m)**1.55,D=1+r*(.052*Math.sin(m*2.2+g*2.7)+m*.028-g*.018),ee=r*_*(.024*Math.sin(m*3.1-g*2.4)+.018*m),O=a*_*(Math.sin(m*2.7+g*3.6)*.012+m*.008-g*.006),k=y*d*D*E-b*_*.16+x+S+w+ee+O,A=m*u*(1+c*.12)+T*(.4+_)+n*Math.sin(g*3.2+h)*.018,j=g*f*E*(1-c*.09)+T*.42;A>.72&&(A=Tt.lerp(A,.72,l));let M=A+j*.42,N=0,P=0,F=0;for(let e of Qd){let t=(.014+i*.038)*e.width,n=Math.abs(M-e.center);N=Math.max(N,Math.exp(-((n/t)**2))),P=Math.max(P,Math.exp(-((n/(t*.34))**2))*e.depth),F=Math.max(F,Math.exp(-(((n-t*1.05)/(t*.48))**2)))}let te=X(h,.28,.66)*(1-X(Math.abs(g),.57,.88));N*=te*o,P*=te*o,F*=te*o,k-=N*(.024+i*.066);let ne=Math.sin(A*21+j*13)*Math.sin(j*31-A*9);k+=_*a*ne*.009,this.position.setXYZ(e,A,Math.max(0,k),j),this.color.copy(this.pale).lerp(this.wet,t*(.72-n*.25)),this.color.lerp(this.proofed,n*.52+r*.2);let re=Nd(.52+v*.34+m*.065-g*.12+ne*.15);this.color.lerp(this.crust,a*re);let ie=Math.max(0,Math.sin(A*8.5-j*5.2)*Math.cos(j*10.5+A*2.7));this.color.lerp(this.toasted,a*((1-v)*.68+Math.max(0,g)*.11+P*.34+ie*v*.08)),this.color.lerp(this.cut,N*a*.86),this.color.lerp(this.raised,F*a*.82);let ae=Math.max(0,Math.sin(A*12+j*7)*Math.sin(j*18-A*3.5)-.34);this.color.lerp(this.pale,ae*v*a*(1-N)*.4),this.colors.setXYZ(e,this.color.r,this.color.g,this.color.b)}let m=t*(1-n);this.mesh.material.roughness=Math.min(.99,.96-m*.34+n*.13+r*.03+a*.09),this.mesh.material.bumpScale=.006+a*.031,this.mesh.material.emissiveIntensity=.025+a*.018,this.position.needsUpdate=this.colors.needsUpdate=!0,this.mesh.geometry.computeVertexNormals()}},ff=class{group=new wn;pile;pileShadow;points;particles=[];positions;alphas;haze=[];source=new G;destination=new G;constructor(e){this.group.name=`milling-output`;let t=e.flourCount,n=new Dr;this.positions=new fr(new Float32Array(t*3),3),this.alphas=new fr(new Float32Array(t),1);let r=new Float32Array(t),i=Array.from({length:14},()=>{let e=Z()*Math.PI*2,t=Math.sqrt(Z());return{x:Math.cos(e)*t*.68,z:Math.sin(e)*t*.46}});for(let e=0;e<t;e+=1){let t=i[Math.floor(Z()*i.length)],n=Z()**2.2,a=Z()*Math.PI*2,o=Z()**1.8;this.particles.push({x:t.x+Math.cos(a)*n*.26,y:(.15+Z()*.85)*(1-Math.min(.9,Math.hypot(t.x,t.z)))*.48,z:t.z+Math.sin(a)*n*.2,delay:Z(),phase:Z()*Math.PI*2,weight:o,near:Z()}),r[e]=.28+o*1.85}n.setAttribute(`position`,this.positions),n.setAttribute(`alpha`,this.alphas),n.setAttribute(`size`,new fr(r,1));let a=new Po({transparent:!0,depthWrite:!1,uniforms:{tint:{value:new q(15853264)},pixelRatio:{value:e.dpr}},vertexShader:`attribute float alpha; attribute float size; varying float vAlpha;
        ...
        void main(){ float r=length(gl_PointCoord-0.5)*2.0;
          ...
          #include <tonemapping_fragment>
          #include <colorspace_fragment>
        }`});this.points=new Vi(n,a),this.points.frustumCulled=!1,this.group.add(this.points);let o=document.createElement(`canvas`);o.width=o.height=96;let s=o.getContext(`2d`),c=s.createRadialGradient(48,48,4,48,48,47);c.addColorStop(0,`rgba(255,247,226,0.42)`),c.addColorStop(.42,`rgba(246,235,211,0.2)`),c.addColorStop(1,`rgba(238,224,198,0)`),s.fillStyle=c,s.fillRect(0,0,96,96);let l=new Wi(o);l.colorSpace=Ie;let u=e.mobile?4:8,d=e.mobile?2:3;for(let e=0;e<u;e+=1){let t=new Nr({map:l,color:new q().setHSL(.105+e*.0025,.3,.88+e%3*.025),transparent:!0,opacity:0,depthWrite:!1,depthTest:e>=d}),n=new qr(t);n.frustumCulled=!1,n.renderOrder=e<d?12:0,this.group.add(n),this.haze.push({sprite:n,material:t,phase:Z()*Math.PI*2,near:Z(),scale:.7+Z()*.85})}let f=new So(1,48,24),p=f.attributes.position;for(let e=0;e<p.count;e+=1){let t=p.getX(e),n=p.getY(e),r=p.getZ(e),i=Math.sqrt(t*t+r*r),a=Math.atan2(r,t),o=1+Math.sin(a*5+.8)*.065+Math.sin(a*9)*.028,s=Math.max(0,1-i*i)**.42*.27,c=Math.sin(t*17+r*13)*Math.cos(r*21-t*7)*.012;p.setXYZ(e,t*.96*o,n<0?0:Math.max(0,s+c),r*.68*o)}f.computeVertexNormals(),this.pile=$(f,Q(Jd.flour,e,`flour`,{roughness:1}),this.group),this.pile.name=`flour-pile`,lf(this.pile,e,e.mobile?34:58,1.12,.008),this.pileShadow=wf(this.group,1.8,1.15),this.pileShadow.material.opacity=.24}update(e,t,n,r){let i=X(e,.288,.405,e=>e*e*(2-e)),a=X(e,.42,.51,e=>e*e),o=X(e,.3,.405)*(1-X(e,.425,.475));if(this.group.visible=e>=.278&&e<=.52,this.pile.position.set(-.65,0,.85),this.pile.scale.setScalar(Math.max(.001,Math.cbrt(o))),this.pile.visible=o>1e-4,this.pileShadow.position.set(-.65,.002,.85),this.pileShadow.scale.setScalar(Math.max(.001,Math.sqrt(o))),this.pileShadow.visible=this.pile.visible,!this.group.visible)return;let s=X(e,.318,.372)*(1-X(e,.472,.515)),c=Math.max(Ld(i,.58,.58)*(1-a)*.55,s,Ld(a)),l=X(e,.405,.437)*(1-X(e,.448,.482)),u=this.haze.length<=4?2:3;this.haze.forEach((e,n)=>{let i=e.near**1.6,o=n<u?Math.max(c*(.18+i*.2),l*(.42+i*.18)):c*(.22+i*.32);e.sprite.visible=o>.003,e.material.opacity=o,e.sprite.position.set(Tt.lerp(-.35,r.x,a)+Math.sin(e.phase+a*3+t*.08)*(.56+i*.28),.42+i*.88-a*(.08+i*.24)+Math.cos(e.phase+t*(.14+i*.08))*.13,1.8+i*2.1+Math.sin(n*1.7)*.16);let s=e.scale*(1.2+i*1.5)*(1+c*.55);e.sprite.scale.set(s,s*(.58+n%3*.08),1),e.material.rotation=e.phase*.18+t*(n%2==0?.018:-.013)}),this.particles.forEach((e,o)=>{let s=Nd((i-e.delay*.72)/.28),c=Nd((a-e.delay*.65)/.35);this.source.copy(n),this.destination.set(-.65+e.x,e.y,.85+e.z);let l=s*s;Xd.lerpVectors(this.source,this.destination,l);let u=s>0&&s<1?.2+e.weight*.4:0;if(a>0){this.source.copy(this.destination),this.destination.copy(r).add(Zd.set(e.x*.7,e.y*.18,e.z*.68)),qd(this.source,this.destination,c,.65,Xd);let t=Ld(c)*e.near**4;Xd.z+=t*(1.2+e.near*1.55),Xd.y+=t*(.1+e.weight*.55),Xd.x+=Math.sin(e.phase)*t*.46,u=c>0&&c<1?.22+e.weight*.42+t*.22:0}let d=Math.sin(t*(.34+e.near*.32)+e.phase)*(.008+e.near*.022)*u;this.positions.setXYZ(o,Xd.x+d,Xd.y+Math.cos(t*.28+e.phase)*d*.6,Xd.z+d),this.alphas.setX(o,u)}),this.positions.needsUpdate=this.alphas.needsUpdate=!0}};function pf(e,t,n,r){let i=$d(r),a=new wn;e.add(a);let o=Q(12226879,t,void 0,{roughness:.92}),s=Q(Jd.wheatLight,t,`crust`,{roughness:.76,emissive:7030027,emissiveIntensity:.18});nf(new G(0,0,0),new G(.035,n,0),.014,o,a);let c=new So(1,12,10);for(let e=0;e<9;e+=1)for(let t of[-1,1]){if(e===4&&t===1)continue;let r=n-.88+e*.095,i=$(c,s,a,t*(.062-e*.003),r,0);i.scale.set(.061-e*.0018,.112-e*.003,.064),i.rotation.z=t*-.43,nf(new G(t*.085,r+.045,0),new G(t*(.21-e*.005),r+.39,0),.003,o,a)}return rf([new G(0,.78,0),new G(-.19,1.12,.06),new G(-.31,1.43,.03)],.017,o,a),a.userData.phase=i()*Math.PI*2,a}function mf(e){let t=new wn,n=e.wheatCount,r=new Di(new Xi(.012,.018,1,6),Q(6716222,e,void 0,{roughness:.96}),n),i=new Di(new So(1,8,6),Q(Jd.wheat,e,`crust`,{roughness:.84,emissive:4926472,emissiveIntensity:.08}),n*8),a=new Di(new Xi(.0025,.0025,1,4),Q(10386226,e,void 0,{roughness:.96}),n*8);r.instanceMatrix.setUsage(Ve),i.instanceMatrix.setUsage(Ve),a.instanceMatrix.setUsage(Ve),r.castShadow=i.castShadow=a.castShadow=e.shadows,r.receiveShadow=i.receiveShadow=a.receiveShadow=e.shadows,t.add(r,i,a);let o=[-2.55,-1.62,-.72,.2,1.16,2.18,2.78],s=Math.max(12,Math.floor(n*.065)),c=Array.from({length:n},(e,t)=>{let n=t<s,r=o[Math.floor(Z()*o.length)],i=(Z()+Z()+Z()-1.5)*.64,a=Z()>.5?1:-1;return{x:n?a*(1.25+Z()*1.75)+(Z()-.5)*.35:r+i,z:n?.34+Z()*1.35:-.52-Z()*3,height:n?1.62+Z()*.72:1.15+Z()*.82,scale:n?.92+Z()*.32:.72+Z()*.46,phase:Z()*Math.PI*2,lean:(Z()-.5)*(n?.28:.19),forward:(Z()-.5)*.13,tone:Z()}}),l=new Cn,u=new q,d=0;return c.forEach((e,t)=>{u.setHSL(.22+e.tone*.018,.34,.25+e.tone*.11),r.setColorAt(t,u);for(let t=0;t<4;t+=1)for(let t of[-1,1])u.setHSL(.105+e.tone*.018,.58+e.tone*.08,.41+e.tone*.15),i.setColorAt(d,u),a.setColorAt(d,u.clone().multiplyScalar(.73)),d+=1}),r.instanceColor.needsUpdate=i.instanceColor.needsUpdate=a.instanceColor.needsUpdate=!0,{group:t,update(e){let t=0,n=0;c.forEach((o,s)=>{let c=Math.sin(e*(.48+o.tone*.19)+o.phase)*(.018+o.tone*.014),u=o.height*o.scale;l.position.set(o.x+c*.25,u*.5-.03,o.z),l.rotation.set(o.forward+c*.35,0,o.lean+c),l.scale.set(1,u,1),l.updateMatrix(),r.setMatrixAt(s,l.matrix);for(let e=0;e<4;e+=1){let r=u*.63+e*.105;for(let s of[-1,1]){let u=s*(.048-e*.002),d=(o.lean+c)*r*.44,f=o.forward*r*.38;l.position.set(o.x+d+u,r,o.z+f),l.rotation.set(o.forward,0,o.lean+c+s*-.42);let p=.9+o.tone*.18;l.scale.set((.057-e*.002)*p,(.092-e*.003)*p,.06*p),l.updateMatrix(),i.setMatrixAt(t,l.matrix),t+=1,l.position.set(o.x+d+s*.082,r+.045,o.z+f),l.rotation.set(o.forward,0,o.lean+c+s*-.34),l.scale.set(1,.34,1),l.updateMatrix(),a.setMatrixAt(n,l.matrix),n+=1}}}),r.instanceMatrix.needsUpdate=!0,i.instanceMatrix.needsUpdate=!0,a.instanceMatrix.needsUpdate=!0}}}function hf(e,t=1){let n=[[.012,-.59],[.17,-.53],[.285,-.32],[.325,.02],[.27,.34],[.15,.54],[.01,.62]],r=new wn,i=new vo(n.map(([e,t])=>new W(e,t)),48),a=i.attributes.position;for(let e=0;e<a.count;e+=1){let t=a.getX(e),n=a.getY(e),r=a.getZ(e),i=Math.atan2(r,t),o=1+n*.065+Math.sin(n*4.2)*.022,s=1+Math.sin(i*3+n*2.1)*.014;a.setXYZ(e,t*o*s+(1-n*n)*.024,n,r*.69*(1-n*.045)*s)}return i.computeVertexNormals(),$(i,Q(14724429,e,`crust`,{roughness:.78,bumpScale:.012,emissive:3480069,emissiveIntensity:.075}),r).scale.setScalar(t),rf([new G(.018,-.45,.18),new G(-.006,-.18,.218),new G(.012,.16,.213),new G(-.005,.44,.176)],.015,Q(6438937,e,void 0,{roughness:.98}),r).scale.setScalar(t),rf([new G(.04,-.41,.19),new G(.022,-.12,.227),new G(.035,.2,.22),new G(.018,.4,.185)],.004,Q(16109432,e,void 0,{roughness:.82}),r).scale.setScalar(t),r}function gf(e){let t=new wn,n=Q(10986389,e,`stone`,{roughness:.96}),r=Q(8486257,e,`stone`,{roughness:.98}),i=Q(6842207,e,void 0,{roughness:.94}),a=Q(3157803,e,void 0,{metalness:.48,roughness:.55}),o=new wn;o.position.y=.62,t.add(o),$(cf(1.19,1.25,.38,48,31),n,t,0,.2,0),$(cf(1.16,1.2,.44,48,79),n,o),af(1.12,.042,Q(5131591,e,`stone`,{roughness:.99}),t,.025),af(1.205,.028,r,t,.37),af(1.18,.025,r,o,-.2),af(1.16,.014,a,o,.2),af(.19,.026,a,o,.225);for(let e=0;e<14;e+=1){let t=e/14*Math.PI*2,n=t+.2+Math.sin(e*1.7)*.035;nf(new G(Math.cos(t)*.29,.224,Math.sin(t)*.29),new G(Math.cos(n)*1.08,.224,Math.sin(n)*1.08),.008,i,o)}nf(new G(0,.74,0),new G(0,1.78,0),.052,a,t),nf(new G(0,1.1,0),new G(.88,1.1,0),.052,a,o),nf(new G(.88,1.08,0),new G(.88,1.5,0),.09,Q(9329201,e,`wood`,{roughness:.83}),o);let s=Q(11434313,e,void 0,{side:2,roughness:.86,emissive:2823689,emissiveIntensity:.08}),c=$(new Xi(.49,.14,.56,4,1,!0),s,t,0,1.35,0);c.rotation.y=Math.PI/4+.16,af(.49,.023,Q(7357993,e,`wood`,{roughness:.9}),t,1.63),af(.145,.016,Q(6175784,e,void 0,{roughness:.92}),t,1.07),$(new Xi(.28,.28,.03,24),Q(9132596,e,`wood`),t,0,1.53,0);let l=new G(.25,.2,1.12);$(of(.42,.84,.065,.045),Q(9658425,e,`wood`),t,l.x,l.y,l.z).rotation.x=.2;let u=wf(t,2.85,2.45);return u.scale.set(1.08,1,1),u.material.opacity=.82,{group:t,rotor:o,outlet:l}}function _f(e){let t=new wn,n=$(new vo([[.48,-.42],[.82,-.36],[1.16,-.14],[1.3,.18],[1.25,.4],[1.08,.52],[.96,.48],[1,.28],[.9,.02],[.72,-.18],[.44,-.27]].map(([e,t])=>new W(e,t)),48),Q(14209472,e,void 0,{roughness:.29,emissive:1511947,emissiveIntensity:.025}),t);n.scale.z=.96;let r=$(new Yi(.455,40),Q(11183773,e,void 0,{roughness:.58}),t,0,-.265,0);r.rotation.x=-Math.PI/2;let i=$(new Yi(.94,32),Q(Jd.flour,e,`flour`,{roughness:1}),t,0,.39,0);return i.rotation.x=-Math.PI/2,af(1.14,.042,Q(16050902,e,void 0,{roughness:.22,emissive:2826258,emissiveIntensity:.045}),t,.48).scale.set(1,.98,1),af(.48,.035,Q(11183512,e,void 0,{roughness:.62}),t,-.4),{group:t,flourSurface:i}}function vf(e){let t=new wn;t.position.set(-1.25,1.47,-.08),t.rotation.z=-.6;let n=Q(11916497,e,void 0,{transparent:!0,opacity:.48,roughness:.1,metalness:.08,side:2,depthWrite:!1});$(new vo([[.22,-.34],[.27,-.29],[.3,.12],[.285,.27],[.32,.34]].map(([e,t])=>new W(e,t)),32),n,t),af(.32,.024,n,t,.34);let r=$(new wo(.2,.037,12,32),n,t,-.36,0,0);r.scale.x=.75;let i=$(new Zi(.14,.3,4,1,!0),n,t,.25,.34,0);i.rotation.z=-Math.PI/2,i.rotation.y=Math.PI/4;let a=$(new Xi(.274,.235,.36,32),Q(7515829,e,void 0,{transparent:!0,opacity:.67,roughness:.12,depthWrite:!1}),t,0,-.11,0);a.castShadow=!1;let o=$(new Yi(.272,32),Q(11131354,e,void 0,{transparent:!0,opacity:.72,roughness:.08,depthWrite:!1}),t,0,.07,0);return o.rotation.x=-Math.PI/2,t.traverse(e=>{let t=e;t.isMesh&&(t.castShadow=!1)}),t}function yf(e){let t=new wn,n=[13015648,12158544,13675121].map(t=>Q(t,e,`wood`,{roughness:.92}));for(let e=0;e<12;e+=1){let r=af(.77+e*.022+Math.sin(e*1.7)*.006,.027+e%3*.002,n[e%n.length],t,.05+e*.031);r.position.x=Math.sin(e*2.3)*.005,r.rotation.z=Math.sin(e*1.2)*.004}let r=[Q(8476209,e,`wood`,{roughness:.95}),Q(10119999,e,`wood`,{roughness:.95})];for(let e=0;e<28;e+=1){let n=e/28*Math.PI*2,i=.995+Math.sin(e*1.31)*.008;nf(new G(Math.cos(n)*.79,.055,Math.sin(n)*.79),new G(Math.cos(n)*i,.405,Math.sin(n)*i),.0095,r[e%2],t)}return t}function bf(e){let t=new wn,n=[9323305,10637100,7550757,11557942].map(t=>Q(t,e,`stone`,{roughness:.92})),r=Q(3156001,e,`stone`,{roughness:.97}),i=Q(459779,e,void 0,{roughness:1});$(of(3.8,2.65,.18),r,t,0,-.18,0),$(new Ji(3.5,2.2,.18),i,t,0,1.02,-1.08),$(new Ji(.16,1.18,1.5),i,t,-1.12,.59,-.28),$(new Ji(.16,1.18,1.5),i,t,1.12,.59,-.28),$(new Ji(2.25,.12,1.5),i,t,0,1.18,-.28);let a=Q(2889489,e,`stone`,{roughness:.98}),o=$(new wo(1.18,.095,8,42,Math.PI),a,t,0,1.17,.57);o.rotation.z=0,$(new Ji(.19,1.17,.26),a,t,-1.18,.59,.57),$(new Ji(.19,1.17,.26),a,t,1.18,.59,.57),$(new Ji(.55,1.2,1.55),r,t,-1.47,.6,-.12),$(new Ji(.55,1.2,1.55),r,t,1.47,.6,-.12);for(let e of[-1,1])for(let r=0;r<4;r+=1){let i=$(new Ji(.49,.265,.24),n[(r+ +(e>0))%n.length],t,e*1.47,.16+r*.3,.69);i.position.x+=Math.sin(r*2.1+e)*.012}for(let e=0;e<13;e+=1){let r=e/13*Math.PI+.005,i=(e+1)/13*Math.PI-.005,a=new ka;a.moveTo(Math.cos(r)*1.2,1.17+Math.sin(r)*.94),a.lineTo(Math.cos(r)*1.745,1.17+Math.sin(r)*1.39),a.lineTo(Math.cos(i)*1.745,1.17+Math.sin(i)*1.39),a.lineTo(Math.cos(i)*1.2,1.17+Math.sin(i)*.94),a.closePath(),$(new mo(a,{depth:1.5,bevelEnabled:!0,bevelSegments:1,bevelSize:.012,bevelThickness:.012}),n[e%n.length],t,0,0,-.86)}let s=[6640711,5851454,7626836].map(t=>Q(t,e,`stone`,{roughness:.98}));for(let e=0;e<5;e+=1){let n=$(new Ji(.47,.11,1.45),s[e%s.length],t,-.98+e*.49,.04,.01);n.position.y+=Math.sin(e*2.1)*.008}let c=document.createElement(`canvas`);c.width=256,c.height=128;let l=c.getContext(`2d`),u=l.createRadialGradient(128,98,4,128,90,118);u.addColorStop(0,`rgba(255,139,50,0.92)`),u.addColorStop(.28,`rgba(209,63,15,0.5)`),u.addColorStop(1,`rgba(63,9,2,0)`),l.fillStyle=u,l.fillRect(0,0,256,128);let d=new Wi(c);d.colorSpace=Ie;let f=$(new yo(2.15,.82),new ri({map:d,transparent:!0,opacity:0,depthWrite:!1,blending:2}),t,0,.46,-.98);f.castShadow=!1;let p=[];for(let n=0;n<11;n+=1){let r=n<5,i=n%2==0?-1:1,a=$(new _o(.026+Z()*.027,0),Q(7741966,e,void 0,{emissive:n%3==0?15300901:12073750,emissiveIntensity:.55,roughness:1}),t,r?i*(.78+Z()*.25):-.88+Z()*1.76,.13+Z()*.07,r?.35+Z()*.38:-.52-Z()*.34);a.userData.phase=Z()*Math.PI*2,p.push(a)}return{group:t,glow:f,embers:p}}function xf(e){let t=new wn;t.name=`bread-knife`;let n=new ka;n.moveTo(-.72,.065),n.lineTo(.72,.055),n.lineTo(.72,-.018);for(let e=8;e>=0;--e){let t=-.64+e*.15;n.lineTo(t,e%2==0?-.055:-.028)}n.lineTo(-.72,-.015),n.closePath();let r=new mo(n,{depth:.026,bevelEnabled:!0,bevelSegments:1,bevelSize:.006,bevelThickness:.005});r.rotateY(Math.PI/2),r.center();let i=$(r,Q(13750472,e,void 0,{metalness:.78,roughness:.2,emissive:3881010,emissiveIntensity:.12}),t,0,0,.08);i.castShadow=e.shadows,$(of(.13,.64,.14,.04),Q(4007451,e,`wood`,{roughness:.72}),t,0,.01,-.94);let a=$(new Ji(.031,.008,.96),new ri({color:16772553,transparent:!0,opacity:.48}),t,.018,.052,.12);return a.castShadow=a.receiveShadow=!1,t}function Sf(){let e=new ka;return e.moveTo(-.48,-.34),e.bezierCurveTo(-.52,-.08,-.47,.25,-.22,.38),e.bezierCurveTo(-.06,.47,.23,.43,.39,.27),e.bezierCurveTo(.5,.14,.52,-.12,.46,-.34),e.lineTo(-.48,-.34),new bo(e,5)}function Cf(e){let t=new wn;t.name=`bread-cut-reveal`;let n=Q(16774098,e,`crumb`,{roughness:.97,side:2,emissive:16762751,emissiveIntensity:.5}),r=Q(8664341,e,`crust`,{roughness:.94,bumpScale:.027}),i=new ri({color:7158041,transparent:!0,opacity:.64,side:2,depthWrite:!1}),a=Sf(),o=$(a,r,t,.806,.43,0);o.rotation.y=Math.PI/2,o.scale.set(1,1,1);let s=$(a,n,t,.821,.43,0);s.rotation.y=Math.PI/2,s.scale.set(.94,.94,.94);let c=new wn;c.name=`separated-slice`,$(new So(1,28,18),r,c).scale.set(.145,.44,.57);let l=$(a,n,c,.151,0,0);l.rotation.y=Math.PI/2,l.scale.set(.95,.95,.95),c.position.set(.88,.43,0),t.add(c);let u=new ri({color:13999449,transparent:!0,opacity:.14,side:2,depthWrite:!1});return[[.38,-.17,.085],[.19,.12,.055],[.55,.2,.07]].forEach(([e,n,r],i)=>{let a=$(new Yi(r,12),u,t,.825,e,n);a.rotation.y=Math.PI/2,a.scale.y=.62+i*.12}),[[.31,-.14],[.52,.08],[.41,.21],[.57,-.24],[.27,.18],[.46,-.02],[.2,-.2],[.62,-.08],[.34,.04]].forEach(([e,n],r)=>{let a=$(new Yi(.014+r%3*.005,8),i,t,.824,e,n);a.rotation.y=Math.PI/2,a.scale.y=.72+r%2*.18}),[[-.04,-.12,.075],[.18,.15,.058]].forEach(([e,t,n],r)=>{let i=$(new Yi(n,12),u,c,.155,e,t);i.rotation.y=Math.PI/2,i.scale.y=.66+r*.15}),[[-.12,-.16],[.1,.09],[.23,-.04],[-.02,.22],[.27,.2],[-.2,.12],[.16,-.2],[-.24,-.05]].forEach(([e,t],n)=>{let r=$(new Yi(.013+n%3*.004,8),i,c,.154,e,t);r.rotation.y=Math.PI/2,r.scale.y=.68+n%2*.2}),{group:t,slice:c,crumbs:Array.from({length:8},(e,r)=>{let i=.014+Z()*.019;return{crumb:$(r%3==0?new Co(i,0):new _o(i,0),n,t),delay:r/11+Z()*.12,x:.72+Z()*.2,z:(Z()-.5)*.55,stretch:.68+Z()*.72,drift:(Z()-.5)*.12}})}}function wf(e,t,n){let r=document.createElement(`canvas`);r.width=r.height=128;let i=r.getContext(`2d`),a=i.createRadialGradient(64,64,5,64,64,64);a.addColorStop(0,`rgba(15,10,5,0.3)`),a.addColorStop(.55,`rgba(15,10,5,0.13)`),a.addColorStop(1,`rgba(15,10,5,0)`),i.fillStyle=a,i.fillRect(0,0,128,128);let o=$(new yo(t,n),new ri({map:new Wi(r),transparent:!0,depthWrite:!1,opacity:1}),e,0,.004,0);return o.rotation.x=-Math.PI/2,o.castShadow=o.receiveShadow=!1,o}function Tf(e){Z=$d(4937);let t=new wn;t.name=`journey-transformation`;let n=new wn,r=pf(n,e,2.48,812);r.position.set(-.21,0,.26);let i=mf(e);n.add(i.group),t.add(n);let a=e.mobile?14:32,o=new Float32Array(a*3),s=Array.from({length:a},(e,t)=>({x:-2.8+Z()*5.6,y:.45+Z()*1.75,z:-1.9+Z()*3.2,phase:Z()*Math.PI*2+t})),c=new Dr;c.setAttribute(`position`,new fr(o,3));let l=Yd(16042873,e.mobile?.022:.028,0),u=new Vi(c,l);u.name=`wheat-pollen`,u.frustumCulled=!1,t.add(u);let d=hf(e);d.name=`hero-kernel`,t.add(d);let f=gf(e);f.group.name=`mill`,t.add(f.group);let p=new wn;p.name=`shared-worktop`,sf(p,e,5.5,3.7,11106640),lf(p,e,e.crumbCount,1.9,.002),p.rotation.y=-.018,t.add(p);let m=new ff(e);t.add(m.group);let h=_f(e);h.group.name=`mixing-bowl`,t.add(h.group);let g=wf(t,2.6,2.3),_=vf(e);t.add(_);let v=Q(12377312,e,void 0,{opacity:.65,roughness:.2,depthWrite:!1}),y=$(new Xi(.021,.035,1,10),v,t);y.name=`water-stream`;let b=$(new Xi(.004,.007,.94,6),new ri({color:15138815,transparent:!0,opacity:.5,depthWrite:!1}),y,.018,0,0);b.castShadow=b.receiveShadow=!1;let x=new wn,S=[];for(let t=0;t<15;t+=1){let n=$(new _o(t<10?.02:.035,0),Q(t<10?Jd.salt:Jd.yeast,e),x);S.push({mesh:n,x:(Z()-.5)*.65,z:(Z()-.5)*.45,delay:Z()*.45})}t.add(x);let C=new wn;C.name=`forming-dough-clumps`;let w=Q(13871987,e,`flour`,{roughness:.82,bumpScale:.012}),T=Array.from({length:e.mobile?5:8},(e,t)=>{let n=$(new _o(1,+(t%3==0)),w,C),r=Z()*Math.PI*2;return{clump:n,x:Math.cos(r)*(.16+Z()*.42),z:Math.sin(r)*(.1+Z()*.3),size:.055+Z()*.085,phase:Z()*Math.PI*2}});t.add(C);let E=new df(t,e),D=Cf(e);D.group.visible=!1,E.mesh.add(D.group);let ee=wf(t,2.5,1.85),O=new wn;O.name=`mixing-spoon`;let k=Q(12420935,e,`wood`,{roughness:.86});$(new So(1,24,16),k,O).scale.set(.16,.055,.24),nf(new G(0,.03,0),new G(.28,1.12,0),.037,k,O),t.add(O);let A=yf(e);A.name=`proofing-basket`,A.scale.set(1.14,1,.92),t.add(A);let j=new wn;j.name=`proofing-dust-motes`;let M=e.mobile?12:22,N=new Float32Array(M*3),P=Array.from({length:M},(e,t)=>({x:(Z()-.5)*3.2,y:.28+Z()*1.45,z:-.2+(Z()-.5)*1.8,phase:Z()*Math.PI*2+t})),F=new Dr;F.setAttribute(`position`,new fr(N,3));let te=Yd(16769448,.025,0),ne=new Vi(F,te);ne.frustumCulled=!1,j.add(ne),t.add(j);let re=bf(e);re.group.name=`oven`,t.add(re.group);let ie=new wn;ie.name=`oven-peel`,$(of(2.65,1.95,.045,.25),Q(14925445,e,`wood`),ie),nf(new G(0,.005,.95),new G(0,.005,2.7),.055,Q(11502927,e,`wood`),ie),t.add(ie);let ae=xf(e);t.add(ae);let oe=new wn;oe.name=`final-board`,sf(oe,e,3.65,2.45,6502691),lf(oe,e,Math.max(18,Math.floor(e.crumbCount*.62)),1.48),oe.rotation.y=.025,t.add(oe);let se=new wn,I=new Float32Array(72),ce=new Dr;ce.setAttribute(`position`,new fr(I,3));let le=Yd(15327698,.07,0),ue=document.createElement(`canvas`);ue.width=ue.height=64;let de=ue.getContext(`2d`),fe=de.createRadialGradient(32,32,0,32,32,32);fe.addColorStop(0,`rgba(255,255,255,0.6)`),fe.addColorStop(1,`rgba(255,255,255,0)`),de.fillStyle=fe,de.fillRect(0,0,64,64),le.map=new Wi(ue);let pe=new Vi(ce,le);pe.frustumCulled=!1,se.add(pe),t.add(se);let me={field:new uf(n),kernel:new uf(d),mill:new uf(f.group),top:new uf(p),bowl:new uf(h.group),water:new uf(_),spoon:new uf(O),additions:new uf(x),clumps:new uf(C),basket:new uf(A),oven:new uf(re.group),peel:new uf(ie),final:new uf(oe),knife:new uf(ae),cut:new uf(D.group)},he=new G(-.155,1.98,.26),ge=new G(0,1.5,.65),_e=new G,ve=new G,ye=new G,be=new G(0,.48,.18),xe=new G(0,.002,.12),Se=new G(0,.075,.12),Ce=new G(0,.105,-1.4),we=new G(0,.02,.48),Te=[{at:.968,value:new G(.78,1.78,.63)},{at:.982,value:new G(.78,1.26,.57)},{at:.989,value:new G(.78,.99,.51),tension:.58},{at:.997,value:new G(.84,.73,.49)},{at:1,value:new G(1.7,1.05,.49)}],Ee=[{at:.968,value:new G(.04,-.08,-.18)},{at:.989,value:new G(.04,-.08,-.1),tension:.5},{at:.997,value:new G(.04,-.02,-.08)},{at:1,value:new G(.04,.1,.18)}],De=new G,Oe=new G,ke=new G,Ae=new G(0,1,0);return{group:t,update({progress:e,time:t,quality:a}){let p=Nd(e),b=a.reducedMotion?0:t,x=a.reducedMotion?.35:1,C=X(p,.082,.17),k=X(p,.225,.292,e=>e*e),M=X(p,.182,.242),ne=X(p,.43,.47),ue=X(p,.138,.285);n.position.set(-ue*.08,0,-ue*2.3),me.field.set(1-X(p,.19,.298)),n.visible&&(i.update(b),r.rotation.z=Math.sin(b*.65)*.016*(1-C));let de=1-X(p,.14,.255);u.visible=de>.002,l.opacity=de*.26,u.position.copy(n.position),s.forEach((e,t)=>{o[t*3]=e.x+Math.sin(b*.14+e.phase)*.12,o[t*3+1]=e.y+Math.sin(b*.2+e.phase*.7)*.06,o[t*3+2]=e.z+Math.cos(b*.11+e.phase)*.05}),c.attributes.position.needsUpdate=!0,me.kernel.set(1-X(p,.29,.297)),Xd.set(.055,1.98,0).applyEuler(r.rotation).add(r.position).add(n.position),he.copy(Xd),d.position.lerpVectors(he,ge,C),d.scale.setScalar(.11+C*.64),d.rotation.set(.06*C,.08*C,-.43+C*1.12),f.group.position.set(.12+(1-M)*.34-ne*.1,0,-.4-(1-M)*2.55-ne*.65),me.mill.set(X(p,.178,.228)*(1-X(p,.423,.448))),_e.set(f.group.position.x,1.21,f.group.position.z),k>0&&(qd(ge,_e,k,.65*x,d.position),d.scale.setScalar(Tt.lerp(.75,.07,k)),d.rotation.z+=k*1.6);let fe=X(p,.284,.405,e=>e*e*(2-e));f.rotor.rotation.y=fe*Math.PI*9+Math.sin(b*.35)*.014*Ld(fe),ve.copy(f.outlet).add(f.group.position),me.top.set(X(p,.205,.255)*(1-X(p,.8,.845)));let pe=X(p,.432,.492),je=X(p,.592,.66),L=X(p,.437,.48)*(1-X(p,.61,.646));h.group.position.set(.32*(1-pe)-je*.28,.43-je*.05,.18-(1-pe)*2.6-je*1.45),me.bowl.set(L),g.position.set(h.group.position.x,.004,h.group.position.z),g.material.opacity=L*.86,g.visible=g.material.opacity>.002,ye.copy(h.group.position).add(Xd.set(0,.16,0)),m.update(p,b,ve,ye);let Me=X(p,.432,.49),Ne=X(p,.502,.575),Pe=X(p,.502,.542),R=Me*L*(1-Pe);h.flourSurface.visible=R>.002,h.flourSurface.scale.setScalar(Math.sqrt(Me)*(1-Ne*.08)),h.flourSurface.position.y=-.18+Me*.38-Ne*.13,h.flourSurface.material.opacity=R,h.flourSurface.material.transparent=Pe>.001,h.flourSurface.material.depthWrite=Pe<.08;let Fe=X(p,.486,.524);_.position.set(h.group.position.x-1.12,1.54+Ld(Fe)*.06,.16),_.rotation.z=-.3-Ld(Fe)*.72,me.water.set(Rd(p,.477,.546,.016)),ke.set(.29,.27,0).applyEuler(_.rotation).add(_.position),y.position.copy(ke).add(ye).multiplyScalar(.5),y.quaternion.setFromUnitVectors(Ae,Xd.copy(ke).sub(ye).normalize()),y.scale.set(1,ke.distanceTo(ye),1),y.visible=Fe>.01&&Fe<.99,v.opacity=Ld(Fe)*.58;let z=X(p,.498,.535,e=>e*e);me.additions.set(Rd(p,.495,.542,.011)),S.forEach(e=>{let t=Nd((z-e.delay)/.55);e.mesh.position.set(ye.x+e.x,ye.y+.88*(1-t*t),ye.z+e.z)});let Ie=X(p,.49,.518)*(1-X(p,.548,.575)),B=X(p,.505,.56);me.clumps.set(Ie),w.roughness=.88-X(p,.498,.535)*.18,T.forEach((e,t)=>{let n=e.phase+B*(.8+t*.07);e.clump.position.set(ye.x+Tt.lerp(e.x,Math.cos(n)*.07,B),ye.y+.025+Math.sin(n*1.7)*.035*(1-B),ye.z+Tt.lerp(e.z,Math.sin(n)*.045,B));let r=e.size*(1-B*.64);e.clump.scale.set(r*(1.08+t%2*.16),r*(.72+t%3*.08),r),e.clump.rotation.set(n*.23,n*.5,n*-.16)});let Le=X(p,.492,.568,e=>e*e*(2-e))*Math.PI*5,Re=X(p,.535,.575),ze=X(p,.552,.615,Fd);O.position.set(ye.x+Math.cos(Le)*(.48-Re*.15),.66+Ne*.06,ye.z+Math.sin(Le)*.32),O.rotation.set(-.2+Math.sin(Le)*.12,Le,-.34+Re*.15),O.position.y+=ze*1.28,O.position.z-=ze*.34,me.spoon.set(Rd(p,.488,.628,.018));let Be=X(p,.498,.538);E.mesh.visible=Be>.002,E.apply(p),E.mesh.material.opacity=Be,E.mesh.material.depthWrite=E.mesh.material.opacity>.98;let Ve=X(p,.565,.625);qd(be,xe,Ve,.42,E.mesh.position);let He=X(p,.61,.69,e=>e);E.mesh.rotation.set(0,Math.sin(He*Math.PI*3)*Ld(He)*.06,0);let Ue=X(p,.65,.705),We=X(p,.688,.735),Ge=X(p,.805,.848);A.position.set(.25*(1-Ue),-.34*(1-Ue)-Ge*.38,.12-(1-Ue)*2.35-Ge*.72),me.basket.set(X(p,.666,.7)*(1-X(p,.812,.846))),p>=.688&&qd(xe,Se,We,.28,E.mesh.position);let Ke=Rd(p,.69,.82,.022);j.visible=Ke>.002,te.opacity=Ke*.22,P.forEach((e,t)=>{let n=a.reducedMotion?.35:b;N[t*3]=e.x+Math.sin(n*.18+e.phase)*.08,N[t*3+1]=e.y+Math.sin(n*.11+e.phase)*.09,N[t*3+2]=e.z+Math.cos(n*.16+e.phase)*.05}),F.attributes.position.needsUpdate=!0;let qe=X(p,.738,.812),Je=X(p,.95,.988);re.group.position.set(0,0,-1.4-3.2*(1-qe)-Je*.25),me.oven.set(X(p,.735,.792)*(1-X(p,.965,.993)));let Ye=X(p,.77,.808),V=X(p,.808,.858),H=X(p,.858,.9,Fd),Xe=Tt.lerp(1.2,.12,Ye);V>0&&(Xe=Tt.lerp(.12,Ce.z,V)),H>0&&(Xe=Tt.lerp(Ce.z,1.45,H)),ie.position.set(0,.053,Xe),me.peel.set(X(p,.765,.8)*(1-X(p,.88,.91))),p>=.808&&qd(Se,Ce,V,.22,E.mesh.position);let Ze=X(p,.748,.83)*(1-Je);re.glow.material.opacity=Ze*(.3+Math.sin(b*3.1)*.025),re.embers.forEach((e,t)=>{let n=.86+Math.sin(b*(1.7+t*.07)+e.userData.phase)*.13+Math.sin(b*3.3+t)*.05;e.material.emissiveIntensity=Ze*(.38+n*.44);let r=.92+Ze*n*.12;e.scale.set(r,r*.58,r*.84)});let Qe=X(p,.925,.972);oe.position.set(0,0,.48),me.final.set(X(p,.94,.97)),p>=.925&&qd(Ce,we,Qe,.28*x,E.mesh.position),E.mesh.rotation.y+=Qe*-.12;let $e=X(p,.989,.997),et=X(p,.99,.997),tt=X(p,.994,1);Kd(p,Te,De),Kd(p,Ee,Oe),ae.position.copy(De),ae.rotation.set(Oe.x,Oe.y,Oe.z),me.knife.set(Rd(p,.965,1,.007)),me.cut.set(et),D.slice.position.set(.88+tt*.32,.43-tt*.035,tt*.045),D.slice.rotation.z=-tt*.1,D.crumbs.forEach(({crumb:e,delay:t,x:n,z:r,stretch:i,drift:a},o)=>{let s=Nd(($e-t)/.42);e.visible=s>.002;let c=X(s,0,.28);e.scale.set(c*i,c*(.72+o%2*.25),c),e.position.set(n+s*(.06+o*.006)+a*s,.62-s*(.5+o%3*.035),r+Math.sin(o*2.3)*s*.08),e.rotation.set(s*o,s*2.1,s*.7)});let nt=Math.max(Ld(Ve),Ld(We),Ld(V),Ld(Qe)),rt=X(p,.61,.635)*.62*(1-nt*.9);ee.position.set(E.mesh.position.x,p<.808?.003:p<.925?.101:.019,E.mesh.position.z),ee.visible=rt>.002,ee.material.opacity=rt,se.position.copy(E.mesh.position);let it=zd(p,.863,.93,.1)*.13;se.visible=it>.002&&!a.reducedMotion,le.opacity=it;for(let e=0;e<24;e+=1){let t=(b*.11+e/24)%1;I[e*3]=Math.sin(e*2.4)*.65+Math.sin(b*.35+e)*t*.1,I[e*3+1]=.92+t*.55,I[e*3+2]=Math.cos(e*1.3)*.22}ce.attributes.position.needsUpdate=!0}}}var Ef=[{id:`wheat`,label:`WHEAT`,start:0,end:.16},{id:`grain`,label:`GRAIN`,start:.12,end:.25},{id:`milling`,label:`MILLING`,start:.21,end:.36},{id:`flour`,label:`FLOUR`,start:.32,end:.47},{id:`mixing`,label:`MIXING`,start:.43,end:.6},{id:`dough`,label:`DOUGH`,start:.56,end:.72},{id:`proofing`,label:`PROOFING`,start:.68,end:.82},{id:`oven`,label:`OVEN`,start:.78,end:.94},{id:`bread`,label:`BREAD`,start:.9,end:1}],Df=[{at:0,value:new G(-.82,1.1,5.25)},{at:.08,value:new G(-.54,1.2,4.6)},{at:.145,value:new G(.48,1.68,4.22),tension:.3},{at:.2,value:new G(.78,1.75,4.12),tension:.62},{at:.25,value:new G(.24,1.62,4.3)},{at:.31,value:new G(-.68,1.45,4.74)},{at:.38,value:new G(-.08,1.72,4.68)},{at:.45,value:new G(.5,2.4,5.02)},{at:.53,value:new G(.64,2.4,4.72)},{at:.62,value:new G(.06,1.88,4.38)},{at:.69,value:new G(-.38,1.78,4.22)},{at:.74,value:new G(.18,2,4.42),tension:.84},{at:.81,value:new G(.04,1.84,4.28)},{at:.86,value:new G(-.5,1.48,4.04)},{at:.92,value:new G(.08,1.68,4.34)},{at:.955,value:new G(.66,1.92,4.7),tension:.22},{at:.98,value:new G(1.72,1.72,4.96)},{at:1,value:new G(2.9,1.58,4.5)}],Of=[{at:0,value:new G(-.2,1.48,-.02)},{at:.12,value:new G(-.1,1.7,.28)},{at:.2,value:new G(0,1.55,.55),tension:.62},{at:.245,value:new G(.05,1.35,.1)},{at:.31,value:new G(0,.78,-.35)},{at:.38,value:new G(-.35,.42,.35)},{at:.44,value:new G(-.1,.42,.65)},{at:.49,value:new G(0,.38,.18)},{at:.6,value:new G(0,.4,.14)},{at:.74,value:new G(0,.32,.14),tension:.85},{at:.8,value:new G(0,.42,-.35)},{at:.855,value:new G(0,.68,-1.4)},{at:.91,value:new G(0,.58,-1.3)},{at:.95,value:new G(.02,.42,.1),tension:.25},{at:1,value:new G(.02,.42,.47)}],kf=[{at:0,value:32},{at:.14,value:28},{at:.22,value:27,tension:.55},{at:.31,value:34},{at:.38,value:32},{at:.45,value:36},{at:.53,value:34},{at:.63,value:31},{at:.74,value:33,tension:.72},{at:.855,value:36},{at:.93,value:34},{at:1,value:31}],Af=[{at:0,value:new q(Jd.night)},{at:.08,value:new q(1186577)},{at:.17,value:new q(2701090)},{at:.25,value:new q(3489835)},{at:.34,value:new q(4671291)},{at:.43,value:new q(8354661)},{at:.5,value:new q(11576714)},{at:.66,value:new q(10851960)},{at:.75,value:new q(8418141)},{at:.82,value:new q(2168079)},{at:.93,value:new q(1182472)},{at:1,value:new q(526600)}],jf=[{at:0,value:new q(12043661)},{at:.16,value:new q(15911279)},{at:.3,value:new q(15190161)},{at:.5,value:new q(16769197)},{at:.74,value:new q(15845251)},{at:.82,value:new q(16171396)},{at:.865,value:new q(16746560)},{at:1,value:new q(16761213)}],Mf=[{at:0,value:new G(-4.5,6.2,2.4)},{at:.18,value:new G(-2.8,5.4,3.2)},{at:.32,value:new G(3.4,5.6,3.6)},{at:.5,value:new G(-3.8,6.2,3.4)},{at:.74,value:new G(3.1,5.4,3)},{at:.84,value:new G(-2.3,3.4,1.2)},{at:1,value:new G(-3.4,4.8,3.2)}],Nf=[{at:0,value:.035},{at:.2,value:.065},{at:.48,value:.11},{at:.68,value:.09},{at:.84,value:.025},{at:1,value:.025}],Pf=[{at:0,value:.34},{at:.16,value:.48},{at:.34,value:.42},{at:.5,value:.64},{at:.68,value:.56},{at:.84,value:.2},{at:1,value:.18}],Ff=[{at:0,value:2},{at:.16,value:2.7},{at:.3,value:3},{at:.5,value:2.55},{at:.68,value:2.7},{at:.76,value:2.25},{at:.84,value:1.85},{at:1,value:3.15}],If=[{at:0,value:.84},{at:.18,value:.92},{at:.5,value:.9},{at:.74,value:.86},{at:.84,value:.78},{at:1,value:.94}],Lf=[{at:0,value:.052},{at:.14,value:.042},{at:.28,value:.027},{at:.37,value:.038},{at:.48,value:.021},{at:.74,value:.024},{at:.85,value:.04},{at:1,value:.03}];function Rf(e,t,n){let r=Tt.clamp(e,0,1);if(r<=t[0].at)return n.copy(t[0].value);for(let e=1;e<t.length;e+=1){let i=t[e-1],a=t[e];if(r<=a.at){let e=Tt.clamp((r-i.at)/(a.at-i.at),0,1);return n.lerpColors(i.value,a.value,Id(e))}}return n.copy(t[t.length-1].value)}var zf=class{scene=new Nn;camera=new fs(34,1,.1,100);renderer;root=new wn;pointer={x:0,y:0,targetX:0,targetY:0};quality;container;onStateChange;previousTime=0;sequence;lookTarget=new G;desiredLook=new G;cameraTarget=new G;reducedCamera=new G(0,3,7.8);lightTarget=new G;backgroundColor=new q(Jd.night);keyLightColor=new q;fillLightColor=new q(12173981);groundLightColor=new q(1053457);fillLight;keyLight;ovenLight;breadLight;ambientLight;progress=0;visualProgress=0;visualVelocity=0;elapsed=0;animationFrame=0;composer=null;bloom=null;resizeObserver=null;disposed=!1;constructor(e,t,n){if(this.container=e,this.quality=t,this.onStateChange=n,this.scene.background=this.backgroundColor,this.scene.fog=new Mn(Jd.night,.028),this.scene.add(this.root),this.renderer=new ed({antialias:!0,powerPreference:`high-performance`,alpha:!1}),this.renderer.setPixelRatio(t.dpr),this.renderer.setSize(e.clientWidth||window.innerWidth,e.clientHeight||window.innerHeight,!1),this.renderer.outputColorSpace=Ie,this.renderer.toneMapping=4,this.renderer.toneMappingExposure=.92,this.renderer.shadowMap.enabled=t.shadows,this.renderer.shadowMap.type=1,this.renderer.domElement.setAttribute(`aria-hidden`,`true`),this.renderer.domElement.className=`journey-canvas`,this.container.appendChild(this.renderer.domElement),t.bloom){let e=new Kt(1,1,{type:g,samples:t.tier===`high`?4:0});this.composer=new Dd(this.renderer,e),this.composer.addPass(new Od(this.scene,this.camera)),this.bloom=new Ad(new W(1,1),.06,.32,.86),this.composer.addPass(this.bloom),this.composer.addPass(new Md)}this.ambientLight=new vs(16774630,.035),this.fillLight=new es(this.fillLightColor,this.groundLightColor,.34),this.keyLight=new _s(16766349,2.25),this.keyLight.castShadow=t.shadows,this.keyLight.shadow.mapSize.set(t.shadowMapSize,t.shadowMapSize),this.keyLight.shadow.camera.near=.1,this.keyLight.shadow.camera.far=30,this.keyLight.shadow.camera.left=-6,this.keyLight.shadow.camera.right=6,this.keyLight.shadow.camera.top=6,this.keyLight.shadow.camera.bottom=-6,this.keyLight.shadow.normalBias=.025,this.keyLight.shadow.bias=-2e-4,this.keyLight.shadow.radius=2,this.keyLight.shadow.blurSamples=8,this.ovenLight=new ms(Jd.ember,0,6,2),this.ovenLight.position.set(-.55,.46,-1.1),this.breadLight=new ms(16763282,0,5.5,2),this.breadLight.position.set(2.5,2.15,1.45),this.keyLight.target.position.set(0,.35,0),this.scene.add(this.ambientLight,this.fillLight,this.keyLight,this.keyLight.target,this.ovenLight,this.breadLight),this.sequence=Tf(t),this.root.add(this.sequence.group),this.setupEvents(),this.resize(),this.camera.position.copy(Df[0].value),this.lookTarget.copy(Of[0].value),this.setProgress(0),this.animationFrame=requestAnimationFrame(this.render)}getState(){let e=[...Ef].reverse().find(e=>this.progress>=e.start)??Ef[0];return{progress:this.progress,stageIndex:Ef.indexOf(e)+1,stageLabel:e.label,remainingSeconds:Math.round(120*(1-this.progress))}}getMotionState(){return{targetProgress:this.progress,visualProgress:this.visualProgress,visualVelocity:this.visualVelocity}}setProgress(e){this.progress=Tt.clamp(e,0,1);let t=this.getState();return this.onStateChange?.(t),t}resize=()=>{let e=this.container.clientWidth||window.innerWidth,t=this.container.clientHeight||window.innerHeight;this.camera.aspect=e/Math.max(t,1),this.camera.updateProjectionMatrix(),this.renderer.setPixelRatio(this.quality.dpr),this.renderer.setSize(e,t,!1),this.composer?.setSize(e,t)};destroy(){this.disposed=!0,cancelAnimationFrame(this.animationFrame),this.resizeObserver?.disconnect(),window.removeEventListener(`pointermove`,this.handlePointer),window.removeEventListener(`resize`,this.resize),this.renderer.dispose(),this.composer?.dispose(),this.root.traverse(e=>{let t=e;t.geometry&&t.geometry.dispose(),(Array.isArray(t.material)?t.material:t.material?[t.material]:[]).forEach(e=>e.dispose())}),this.container.replaceChildren()}handlePointer=e=>{this.pointer.targetX=(e.clientX/Math.max(window.innerWidth,1)-.5)*2,this.pointer.targetY=(e.clientY/Math.max(window.innerHeight,1)-.5)*2};render=e=>{if(this.disposed)return;let t=this.previousTime?Math.min((e-this.previousTime)/1e3,.05):1/60;this.previousTime=e,this.elapsed+=t;let n=this.quality.reducedMotion?16:8;this.pointer.x=Bd(this.pointer.x,this.pointer.targetX,n,t),this.pointer.y=Bd(this.pointer.y,this.pointer.targetY,n,t);let r=Math.abs(this.progress-this.visualProgress);if(this.quality.reducedMotion)this.visualProgress=this.progress,this.visualVelocity=0;else{let e=this.quality.mobile?.068:.088,n=this.quality.mobile?.046:.054,i=Tt.smoothstep(r,.015,.2),a=Vd(this.visualProgress,this.progress,this.visualVelocity,Tt.lerp(e,n,i),t);this.visualProgress=Tt.clamp(a.value,0,1),this.visualVelocity=a.velocity,r<1e-5&&Math.abs(this.visualVelocity)<1e-4&&(this.visualProgress=this.progress,this.visualVelocity=0)}let i={progress:this.visualProgress,time:this.elapsed,delta:t,pointer:this.pointer,quality:this.quality};this.sequence.update(i),this.updateCamera(i),this.updateLighting(i),this.composer?this.composer.render():this.renderer.render(this.scene,this.camera),this.animationFrame=requestAnimationFrame(this.render)};setupEvents(){window.addEventListener(`pointermove`,this.handlePointer,{passive:!0}),window.addEventListener(`resize`,this.resize,{passive:!0}),`ResizeObserver`in window&&(this.resizeObserver=new ResizeObserver(()=>this.resize()),this.resizeObserver.observe(this.container))}updateCamera(e){let t=+!e.quality.reducedMotion;if(Kd(e.progress,Df,this.cameraTarget),Kd(e.progress,Of,this.desiredLook),e.quality.reducedMotion){let t=.8*(1-X(e.progress,.965,.998));this.cameraTarget.lerp(this.reducedCamera,t)}let n=Math.max(1,1.22/this.camera.aspect);this.cameraTarget.sub(this.desiredLook).multiplyScalar(n).add(this.desiredLook),this.cameraTarget.x+=e.pointer.x*.12*t,this.cameraTarget.y+=e.pointer.y*-.06*t,this.camera.position.copy(this.cameraTarget),this.desiredLook.x+=e.pointer.x*.045*t,this.desiredLook.y+=e.pointer.y*-.03*t,this.lookTarget.copy(this.desiredLook),this.camera.lookAt(this.lookTarget);let r=Gd(e.progress,kf);Math.abs(this.camera.fov-r)>.001&&(this.camera.fov=r,this.camera.updateProjectionMatrix())}updateLighting(e){let t=e.progress;Rf(t,Af,this.backgroundColor),this.scene.background=this.backgroundColor,this.scene.fog instanceof Mn&&this.scene.fog.color.copy(this.backgroundColor),Rf(t,jf,this.keyLightColor),this.keyLight.color.copy(this.keyLightColor),Kd(t,Mf,this.lightTarget);let n=X(t,.68,.71)*(1-X(t,.775,.81));e.quality.reducedMotion||(this.lightTarget.x+=Math.sin(this.elapsed*.12)*n*.42,this.lightTarget.z+=Math.cos(this.elapsed*.09)*n*.22),this.keyLight.position.copy(this.lightTarget),this.keyLight.target.position.set(0,.32+X(t,.72,.86)*.35,-X(t,.72,.86)*1.2+X(t,.9,1)*1.65);let r=X(t,.753,.829)*(1-X(t,.925,.98)),i=X(t,.813,.86),a=X(t,.89,1);this.ambientLight.intensity=Gd(t,Nf),this.fillLight.intensity=Gd(t,Pf),this.keyLight.intensity=Gd(t,Ff),this.ovenLight.intensity=r*(.82+i*1.78),this.breadLight.intensity=a*2.25,this.renderer.toneMappingExposure=Gd(t,If),this.scene.fog instanceof Mn&&(this.scene.fog.density=Gd(t,Lf)),this.bloom&&(this.bloom.strength=.045+r*.12+a*.035,this.bloom.radius=.28+r*.12,this.bloom.threshold=.84)}},Bf=document.querySelector(`#experience`),Vf=document.querySelector(`#scroll-rail`),Hf=document.querySelector(`#loader`),Uf=document.querySelector(`#fallback`),Wf=document.querySelector(`#stage-number`),Gf=document.querySelector(`#stage-label`),Kf=document.querySelector(`#timer`),qf=document.querySelector(`#intro-copy`),Jf=document.querySelector(`#scene-copy`),Yf=document.querySelector(`#finish-copy`),Xf=document.querySelector(`#sound-toggle`),Zf=document.querySelector(`#sound-label`),Qf=document.querySelector(`#replay`);if(!Bf||!Vf||!Hf||!Uf||!Wf||!Gf||!Kf||!qf||!Jf||!Yf||!Xf||!Zf||!Qf)throw Error(`Journey to Bread could not find its interface shell.`);var $f=new td,ep=null,tp=null,np=1,rp=null;function ip(e){let t=Math.max(0,Math.round(e));return`${String(Math.floor(t/60)).padStart(2,`0`)}:${String(t%60).padStart(2,`0`)}`}function ap(e){let t=[`WHEAT`,`ONE GRAIN.`,`BREAKING IT DOWN.`,`FLOUR.`,`FLOUR. WATER. SALT. TIME.`,`MAKE IT SOFT.`,`WAIT.`,`HEAT.`,``];Wf.textContent=`${String(e.stageIndex).padStart(2,`0`)} / 09`,Gf.textContent=e.stageLabel,e.stageIndex!==np&&!window.matchMedia(`(prefers-reduced-motion: reduce)`).matches&&(rp?.cancel(),rp=document.querySelector(`.hud__stage`)?.animate([{opacity:.34,transform:`translateY(-3px)`},{opacity:.72,transform:`translateY(0)`}],{duration:220,easing:`cubic-bezier(.2,.75,.25,1)`})??null),np=e.stageIndex,Kf.textContent=ip(e.remainingSeconds),Kf.setAttribute(`aria-label`,`${ip(e.remainingSeconds)} remaining in the journey`),qf.style.opacity=String(Math.max(0,1-e.progress*14)),Jf.textContent=t[e.stageIndex-1]??``,Jf.classList.toggle(`is-visible`,e.progress>.17&&e.progress<.93),e.progress<=.996&&Yf.contains(document.activeElement)&&Xf.focus({preventScroll:!0}),Yf.inert=e.progress<=.996,Yf.classList.toggle(`is-visible`,e.progress>.996),Yf.setAttribute(`aria-hidden`,String(e.progress<=.996)),document.documentElement.classList.toggle(`hud-on-light`,e.progress>=.335&&e.progress<=.79),document.documentElement.style.setProperty(`--journey-progress`,String(e.progress)),$f.setProgress(e.progress)}function op(e){let t=document.modelContext;if(!t?.registerTool)return;let n=new AbortController;Promise.resolve(t.registerTool({name:`set_journey_progress`,title:`Set journey progress`,description:`Move Journey to Bread to a specific scroll progress between 0 and 1 and return the visible stage and countdown.`,inputSchema:{type:`object`,properties:{progress:{type:`number`,minimum:0,maximum:1}},required:[`progress`],additionalProperties:!1},annotations:{readOnlyHint:!1,untrustedContentHint:!1},execute(t){let n=t?.progress;if(typeof n!=`number`||!Number.isFinite(n)||n<0||n>1)throw Error(`progress must be a finite number between 0 and 1`);return e.scrollToProgress(n)}},{signal:n.signal})).catch(()=>void 0),window.addEventListener(`beforeunload`,()=>n.abort(),{once:!0})}try{let e=vd();ep=new zf(Bf,e,ap),tp=new _d(ep),op(tp),Xf.addEventListener(`click`,async()=>{let e=await $f.toggle();Xf.setAttribute(`aria-pressed`,String(e)),Xf.setAttribute(`aria-label`,e?`Turn sound off`:`Turn sound on`),Zf.textContent=e?`Sound on`:`Sound off`,Xf.classList.toggle(`is-on`,e)}),Qf.addEventListener(`click`,()=>tp?.replay());let t=new URLSearchParams(window.location.search).get(`progress`),n=Number(t);t!==null&&Number.isFinite(n)&&n>=0&&n<=1&&window.setTimeout(()=>tp?.scrollToProgress(n),120),window.setTimeout(()=>Hf.classList.add(`is-hidden`),e.reducedMotion?100:360)}catch(e){console.error(e),Bf.hidden=!0,Vf.hidden=!0,Hf.hidden=!0,Uf.hidden=!1,document.body.classList.add(`webgl-fallback`)}window.addEventListener(`beforeunload`,()=>{tp?.destroy(),ep?.destroy(),$f.disable(),delete window.__journeyDebug},{once:!0});