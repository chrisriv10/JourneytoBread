...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function fc(e,t,n){let r=new Float32Array(Qs),i=new W(0,1,0);return new Po({name:`SphericalGaussianBlur`,defines:{n:Qs,CUBEUV_TEXEL_WIDTH:1/t,CUBEUV_TEXEL_HEIGHT:1/n,CUBEUV_MAX_MIP:`${e}.0`},uniforms:{envMap:{value:null},samples:{value:1},weights:{value:r},latitudinal:{value:!1},dTheta:{value:0},mipInt:{value:0},poleAxis:{value:i}},vertexShader:hc(),fragmentShader:`
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function pc(){return new Po({name:`EquirectangularToCubeUV`,uniforms:{envMap:{value:null}},vertexShader:hc(),fragmentShader:`
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function mc(){return new Po({name:`CubemapToCubeUV`,uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:hc(),fragmentShader:`
	...
	`}var gc=class extends qt{constructor(e=1,t={}){super(e,e,t),this.isWebGLCubeRenderTarget=!0;let n={width:e,height:e,depth:1},r=[n,n,n,n,n,n];this.texture=new Ui(r),this._setTextureOptions(t),this.texture.isRenderTargetTexture=!0}fromEquirectangularTexture(e,t){this.texture.type=t.type,this.texture.colorSpace=t.colorSpace,this.texture.generateMipmaps=t.generateMipmaps,this.texture.minFilter=t.minFilter,this.texture.magFilter=t.magFilter;let n={uniforms:{tEquirect:{value:null}},vertexShader:`
...
`)}var Vl={1:`Linear`,2:`Reinhard`,3:`Cineon`,4:`ACESFilmic`,6:`AgX`,7:`Neutral`,5:`Custom`};function Hl(e,t){let n=Vl[t];return n===void 0?(B(`WebGLProgram: Unsupported toneMapping:`,t),`vec3 `+e+`( vec3 color ) { return LinearToneMapping( color ); }`):`vec3 `+e+`( vec3 color ) { return `+n+`ToneMapping( color ); }`}var Ul=new W;function Wl(){return Pt.getLuminanceCoefficients(Ul),[`float luminance( const in vec3 rgb ) {`,`	const vec3 weights = vec3( ${Ul.x.toFixed(4)}, ${Ul.y.toFixed(4)}, ${Ul.z.toFixed(4)} );`,`	return dot( weights, rgb );`,`}`].join(`
...
void main() {
	...
	if ( coord.x >= 1.0 ) {
		...
		}`},Md=class extends bd{constructor(){super(),this.isOutputPass=!0,this.uniforms=jo.clone(jd.uniforms),this.material=new Fo({name:jd.name,uniforms:this.uniforms,vertexShader:jd.vertexShader,fragmentShader:jd.fragmentShader}),this._fsQuad=new Cd(this.material),this._outputColorSpace=null,this._toneMapping=null}render(e,t,n){this.uniforms.tDiffuse.value=n.texture,this.uniforms.toneMappingExposure.value=e.toneMappingExposure,(this._outputColorSpace!==e.outputColorSpace||this._toneMapping!==e.toneMapping)&&(this._outputColorSpace=e.outputColorSpace,this._toneMapping=e.toneMapping,this.material.defines={},Pt.getTransfer(this._outputColorSpace)===`srgb`&&(this.material.defines.SRGB_TRANSFER=``),this._toneMapping===1?this.material.defines.LINEAR_TONE_MAPPING=``:this._toneMapping===2?this.material.defines.REINHARD_TONE_MAPPING=``:this._toneMapping===3?this.material.defines.CINEON_TONE_MAPPING=``:this._toneMapping===4?this.material.defines.ACES_FILMIC_TONE_MAPPING=``:this._toneMapping===6?this.material.defines.AGX_TONE_MAPPING=``:this._toneMapping===7?this.material.defines.NEUTRAL_TONE_MAPPING=``:this._toneMapping===5&&(this.material.defines.CUSTOM_TONE_MAPPING=``),this.material.needsUpdate=!0),this.renderToScreen===!0?(e.setRenderTarget(null),this._fsQuad.render(e)):(e.setRenderTarget(t),this.clear&&e.clear(e.autoClearColor,e.autoClearDepth,e.autoClearStencil),this._fsQuad.render(e))}dispose(){this.material.dispose(),this._fsQuad.dispose()}};function Nd(e){return Et.clamp(e,0,1)}function Pd(e){let t=Nd(e);return t*t*t*(t*(t*6-15)+10)}function Fd(e){return 1-(1-Nd(e))**3}function Id(e){let t=Nd(e);return t*t*(3-2*t)}function Ld(e,t=.5,n=.5){let r=Math.abs(e-t)/Math.max(n,1e-4);return Math.max(0,1-r*r)**2}function X(e,t,n,r=Pd){return r(Et.clamp((e-t)/Math.max(n-t,1e-4),0,1))}function Rd(e,t,n,r=.12){let i=X(e,t,t+r),a=1-X(e,n-r,n);return Et.clamp(Math.min(i,a),0,1)}function zd(e,t,n,r=.1){return X(e,t+r*(n-t),n)}function Bd(e,t,n,r){return Et.lerp(e,t,1-Math.exp(-n*Math.max(r,0)))}function Vd(e,t,n,r,i){let a=Math.max(0,Math.min(i,.05)),o=2/Math.max(.001,r),s=e-t,c=n+o*s,l=Math.exp(-o*a);return{value:t+(s+c*a)*l,velocity:(n-o*c*a)*l}}function Hd(e,t,n){let r=e[t],i=Et.clamp(r.tension??0,0,1);if(t===0){let t=e[1];return(n(t.value)-n(r.value))/Math.max(t.at-r.at,1e-4)*(1-i)}if(t===e.length-1){let a=e[t-1];return(n(r.value)-n(a.value))/Math.max(r.at-a.at,1e-4)*(1-i)}let a=e[t-1],o=e[t+1];return(n(o.value)-n(a.value))/Math.max(o.at-a.at,1e-4)*(1-i)}function Ud(e,t){let n=e[t],r=Et.clamp(n.tension??0,0,1);if(t===0){let t=e[1];return(t.value-n.value)/Math.max(t.at-n.at,1e-4)*(1-r)}if(t===e.length-1){let i=e[t-1];return(n.value-i.value)/Math.max(n.at-i.at,1e-4)*(1-r)}let i=e[t-1],a=e[t+1],o=Math.max(n.at-i.at,1e-4),s=Math.max(a.at-n.at,1e-4),c=(n.value-i.value)/o,l=(a.value-n.value)/s;if(c===0||l===0||Math.sign(c)!==Math.sign(l))return 0;let u=2*s+o,d=s+2*o;return(u+d)/(u/c+d/l)*(1-r)}function Wd(e,t,n,r,i,a){let o=a*a,s=o*a,c=2*s-3*o+1,l=s-2*o+a,u=-2*s+3*o,d=s-o;return c*e+l*i*n+u*t+d*i*r}function Gd(e,t){let n=Nd(e);if(n<=t[0].at)return t[0].value;for(let e=1;e<t.length;e+=1){let r=t[e-1],i=t[e];if(n<=i.at){let a=Math.max(i.at-r.at,1e-4),o=Et.clamp((n-r.at)/a,0,1),s=Wd(r.value,i.value,Ud(t,e-1),Ud(t,e),a,o);return Et.clamp(s,Math.min(r.value,i.value),Math.max(r.value,i.value))}}return t[t.length-1].value}function Kd(e,t,n){let r=Nd(e);if(r<=t[0].at)return n.copy(t[0].value);for(let e=1;e<t.length;e+=1){let i=t[e-1],a=t[e];if(r<=a.at){let o=Math.max(a.at-i.at,1e-4),s=Et.clamp((r-i.at)/o,0,1),c=Hd(t,e-1,e=>e.x),l=Hd(t,e-1,e=>e.y),u=Hd(t,e-1,e=>e.z),d=Hd(t,e,e=>e.x),f=Hd(t,e,e=>e.y),p=Hd(t,e,e=>e.z);return n.set(Wd(i.value.x,a.value.x,c,d,o,s),Wd(i.value.y,a.value.y,l,f,o,s),Wd(i.value.z,a.value.z,u,p,o,s))}}return n.copy(t[t.length-1].value)}function qd(e,t,n,r,i=new W){let a=Nd(n);return i.lerpVectors(e,t,a),i.y+=Math.sin(a*Math.PI)*r,i}var Jd={night:658700,moss:2505255,mossLight:6255937,wheat:14067789,wheatLight:16043890,stone:5986896,stoneLight:9275765,flour:15853520,salt:16314586,yeast:12814431,dough:13208140,doughLight:15775850,oven:2430226,ember:16740146,crust:10111776,bread:13137196,crumb:15976065,table:4403494,ink:1119762};function Yd(e,t,n=.8){return new Ii({color:e,size:t,sizeAttenuation:!0,transparent:!0,opacity:n,depthWrite:!1})}var Xd=new Map;function Zd(e){let t=e;return()=>(t=t*16807%2147483647,(t-1)/2147483646)}function Qd(e,t){let n=document.createElement(`canvas`);n.width=n.height=e;let r=n.getContext(`2d`);return r.fillStyle=t,r.fillRect(0,0,e,e),{canvas:n,context:r}}function $d(e,t,n,r,i,a,o=`rgba(0,0,0,0)`){e.save(),e.translate(t,n),e.scale(r,i);let s=e.createRadialGradient(0,0,0,0,0,1);s.addColorStop(0,a),s.addColorStop(1,o),e.fillStyle=s,e.fillRect(-1,-1,2,2),e.restore()}function ef(t,n,r,i){let a=new Wi(t);return a.colorSpace=n?Le:``,a.wrapS=a.wrapT=e,a.repeat.set(r,r),a.anisotropy=i,a.minFilter=c,a.magFilter=o,a}function tf(e,t,n,r){let i=Zd(1103);for(let r=0;r<28;r+=1){let r=i()*e,a=(i()-.5)*e*.045,o=.6+i()*2.2;t.strokeStyle=i()>.42?`rgba(70,34,15,${.035+i()*.09})`:`rgba(255,240,210,${.025+i()*.06})`,t.lineWidth=o,t.beginPath(),t.moveTo(-e*.05,r),t.bezierCurveTo(e*.28,r-a,e*.7,r+a,e*1.05,r-a*.25),t.stroke(),n.strokeStyle=i()>.5?`#747474`:`#8a8a8a`,n.lineWidth=Math.max(.65,o*.62),n.beginPath(),n.moveTo(-e*.05,r),n.bezierCurveTo(e*.28,r-a,e*.7,r+a,e*1.05,r-a*.25),n.stroke()}for(let a=0;a<2;a+=1){let a=e*(.22+i()*.56),o=e*(.18+i()*.64),s=e*(.035+i()*.025),c=s*(.22+i()*.14);t.strokeStyle=`rgba(66,29,12,0.14)`,t.lineWidth=1.5,t.beginPath(),t.ellipse(a,o,s,c,0,0,Math.PI*2),t.stroke(),n.strokeStyle=`#707070`,n.lineWidth=1,n.beginPath(),n.ellipse(a,o,s,c,0,0,Math.PI*2),n.stroke(),$d(r,a,o,s*2,c*3.2,`rgba(190,190,190,0.5)`)}let a=r.createLinearGradient(0,0,0,e);a.addColorStop(0,`rgba(255,255,255,0.05)`),a.addColorStop(.5,`rgba(174,174,174,0.06)`),a.addColorStop(1,`rgba(255,255,255,0.04)`),r.fillStyle=a,r.fillRect(0,0,e,e)}function nf(e,t,n,r){let i=Zd(2207);for(let a=0;a<58;a+=1){let a=i()*e,o=i()*e,s=e*(.035+i()*.12),c=s*(.55+i()*.9),l=i()>.48;$d(t,a,o,s,c,l?`rgba(255,250,233,${.025+i()*.06})`:`rgba(45,42,36,${.025+i()*.055})`),$d(n,a,o,s,c,l?`rgba(148,148,148,0.18)`:`rgba(102,102,102,0.2)`),$d(r,a,o,s*1.15,c*1.15,l?`rgba(255,255,255,0.1)`:`rgba(170,170,170,0.12)`)}for(let r=0;r<180;r+=1){let r=i()*e,a=i()*e,o=.45+i()*1.7;t.fillStyle=`rgba(34,31,27,${.025+i()*.07})`,t.beginPath(),t.arc(r,a,o,0,Math.PI*2),t.fill(),n.fillStyle=`rgba(${72+Math.round(i()*28)},${72+Math.round(i()*28)},${72+Math.round(i()*28)},0.5)`,n.fillRect(r,a,Math.max(1,o),Math.max(1,o))}for(let r=0;r<15;r+=1){let r=i()*e,a=i()*e,o=e*(.025+i()*.075),s=(i()-.5)*o*.45;t.strokeStyle=`rgba(45,42,36,${.025+i()*.035})`,t.lineWidth=.45+i()*.55,t.beginPath(),t.moveTo(r,a),t.quadraticCurveTo(r+o*.5,a+s,r+o,a+s*.35),t.stroke(),n.strokeStyle=`rgba(82,82,82,0.24)`,n.lineWidth=.55,n.beginPath(),n.moveTo(r,a),n.quadraticCurveTo(r+o*.5,a+s,r+o,a+s*.35),n.stroke()}}function rf(e,t,n,r){let i=Zd(3313),a=t.createLinearGradient(0,0,e,e);a.addColorStop(0,`rgba(255,255,255,0.025)`),a.addColorStop(1,`rgba(116,92,58,0.018)`),t.fillStyle=a,t.fillRect(0,0,e,e);for(let r=0;r<560;r+=1){let r=i()*e,a=i()*e,o=.012+i()*.025;t.fillStyle=i()>.5?`rgba(255,255,255,${o})`:`rgba(96,76,48,${o*.45})`,t.fillRect(r,a,.55+i(),.55+i());let s=120+Math.round(i()*16);n.fillStyle=`rgb(${s},${s},${s})`,n.fillRect(r,a,.5+i(),.5+i())}r.fillStyle=`rgba(255,255,255,0.18)`,r.fillRect(0,0,e,e)}function af(e,t,n,r){let i=Zd(4421);for(let a=0;a<22;a+=1){let a=i()*e,o=i()*e,s=e*(.06+i()*.16);$d(t,a,o,s,s*(.6+i()*.7),i()>.5?`rgba(255,248,222,0.045)`:`rgba(123,74,36,0.025)`),$d(n,a,o,s,s,i()>.5?`rgba(141,141,141,0.07)`:`rgba(112,112,112,0.07)`),$d(r,a,o,s*1.1,s*1.1,i()>.52?`rgba(245,245,245,0.1)`:`rgba(150,150,150,0.13)`)}}function of(e,t,n,r){let i=Zd(4903),a=t.createLinearGradient(0,0,e,e);a.addColorStop(0,`rgba(255,231,145,0.09)`),a.addColorStop(.52,`rgba(255,255,255,0)`),a.addColorStop(1,`rgba(91,44,8,0.08)`),t.fillStyle=a,t.fillRect(0,0,e,e);for(let r=0;r<24;r+=1){let r=i()*e,a=(i()-.5)*e*.05;t.strokeStyle=i()>.5?`rgba(255,237,163,${.025+i()*.045})`:`rgba(104,50,9,${.02+i()*.04})`,t.lineWidth=.5+i()*1.1,t.beginPath(),t.moveTo(r,-e*.04),t.bezierCurveTo(r-a,e*.3,r+a,e*.7,r-a*.2,e*1.04),t.stroke(),n.strokeStyle=i()>.5?`#898989`:`#777777`,n.lineWidth=.55,n.beginPath(),n.moveTo(r,-e*.04),n.bezierCurveTo(r-a,e*.3,r+a,e*.7,r-a*.2,e*1.04),n.stroke()}r.fillStyle=`rgba(255,255,255,0.07)`,r.fillRect(0,0,e,e)}function sf(e,t,n,r){let i=Zd(5531);for(let n=0;n<46;n+=1){let n=i()*e,a=i()*e,o=e*(.025+i()*.11),s=i()>.45;$d(t,n,a,o,o*(.55+i()),s?`rgba(84,28,8,${.05+i()*.12})`:`rgba(255,210,112,${.04+i()*.11})`),$d(r,n,a,o*1.1,o,s?`rgba(255,255,255,0.16)`:`rgba(155,155,155,0.1)`)}for(let r=0;r<140;r+=1){let r=i()*e,a=i()*e,o=.7+i()*2.9,s=o*(.45+i()*.75);t.fillStyle=i()>.55?`rgba(255,221,142,${.025+i()*.07})`:`rgba(78,28,8,${.025+i()*.065})`,t.beginPath(),t.ellipse(r,a,o,s,i()*Math.PI,0,Math.PI*2),t.fill(),n.fillStyle=i()>.45?`#969696`:`#707070`,n.beginPath(),n.ellipse(r,a,o*.72,s*.72,i()*Math.PI,0,Math.PI*2),n.fill()}}function cf(e,t,n,r){let i=Zd(6653);for(let n=0;n<28;n+=1){let n=i()*e,r=i()*e,a=e*(.04+i()*.12);$d(t,n,r,a,a*(.7+i()*.7),i()>.5?`rgba(255,246,207,0.07)`:`rgba(141,77,31,0.035)`)}for(let r=0;r<92;r+=1){let r=i()*e,a=i()*e,o=.8+i()**1.7*4.2,s=o*(.45+i()*.75);t.fillStyle=`rgba(104,55,25,${.025+i()*.09})`,t.beginPath(),t.ellipse(r,a,o,s,i()*Math.PI,0,Math.PI*2),t.fill(),n.fillStyle=`rgba(68,68,68,${.28+i()*.34})`,n.beginPath(),n.ellipse(r,a,o*.78,s*.78,i()*Math.PI,0,Math.PI*2),n.fill()}r.fillStyle=`rgba(255,255,255,0.12)`,r.fillRect(0,0,e,e)}function lf(e,t){let n=t.mobile?256:512,r=`${e}:${n}:${t.anisotropy}`,i=Xd.get(r);if(i)return i;let a={wood:[`#dfcbb0`,`#808080`,`#dedede`],stone:[`#dfddd4`,`#808080`,`#e8e8e8`],flour:[`#fffaf0`,`#808080`,`#f2f2f2`],grain:[`#f0ce82`,`#808080`,`#e4e4e4`],dough:[`#fff0d2`,`#808080`,`#d7d7d7`],crust:[`#e7bd7d`,`#808080`,`#dedede`],crumb:[`#f8dda8`,`#808080`,`#eeeeee`]}[e],o=Qd(n,a[0]),s=Qd(n,a[1]),c=Qd(n,a[2]),l={wood:tf,stone:nf,flour:rf,grain:of,dough:af,crust:sf,crumb:cf}[e];l(n,o.context,s.context,c.context);let u={wood:1,stone:1.2,flour:1.55,grain:1.08,dough:1.1,crust:1.25,crumb:1.08}[e],d={albedo:ef(o.canvas,!0,u,t.anisotropy),height:ef(s.canvas,!1,u,t.anisotropy),roughness:ef(c.canvas,!1,u,t.anisotropy)};return Xd.set(r,d),d}function uf(e,t){return lf(e,t)}function Z(e,t,n,r={}){let i=n?{wood:.84,stone:.96,flour:1,grain:.8,dough:.76,crust:.82,crumb:.98}[n]:.84,a=n?{wood:.012,stone:.027,flour:.003,grain:.009,dough:.006,crust:.025,crumb:.009}[n]:0,o=n?lf(n,t):void 0;return new Io({color:e,roughness:i,metalness:0,transparent:!0,...o?{map:o.albedo,bumpMap:o.height,roughnessMap:o.roughness,bumpScale:a}:{},...r})}var df=new W;new W;var ff=.003;function pf(e){if(e.boundingBox||e.computeBoundingBox(),!e.boundingBox)throw Error(`Unable to measure geometry bounds`);return{min:e.boundingBox.min.y,max:e.boundingBox.max.y}}function mf(e){return e.updateMatrixWorld(!0),new Yn().setFromObject(e).min.y}function hf(e,t){return e-t+ff}var gf=[{center:-.52,width:.88,depth:1,curve:-.014},{center:0,width:1.08,depth:1.12,curve:.018},{center:.5,width:.82,depth:.9,curve:-.011}];function _f(e){let t=e;return()=>(t=t*16807%2147483647,(t-1)/2147483646)}var Q=_f(4937);function $(e,t,n,r=0,i=0,a=0){let o=new hi(e,t);return o.position.set(r,i,a),o.castShadow=!0,o.receiveShadow=!0,n?.add(o),o}function vf(e,t,n,r,i){let a=$(new Xi(n,n,e.distanceTo(t),8),r,i);return a.position.copy(e).add(t).multiplyScalar(.5),a.quaternion.setFromUnitVectors(new W(0,1,0),t.clone().sub(e).normalize()),a}function yf(e,t,n,r){return $(new To(new ca(e),28,t,8,!1),n,r)}function bf(e,t,n,r,i){let a=$(new wo(e,t,8,64),n,r,0,i,0);return a.rotation.x=Math.PI/2,a}function xf(e,t,n,r=.14){let i=new ka,a=-e/2,o=-t/2,s=r;i.moveTo(a+s,o),i.lineTo(a+e-s,o),i.quadraticCurveTo(a+e,o,a+e,o+s),i.lineTo(a+e,o+t-s),i.quadraticCurveTo(a+e,o+t,a+e-s,o+t),i.lineTo(a+s,o+t),i.quadraticCurveTo(a,o+t,a,o+t-s),i.lineTo(a,o+s),i.quadraticCurveTo(a,o,a+s,o);let c=new mo(i,{depth:n,bevelEnabled:!0,bevelSegments:3,bevelSize:.025,bevelThickness:.025,curveSegments:10});return c.rotateX(-Math.PI/2),c}function Sf(e,t,n=3.9,r=2.7,i=12618325){let a=xf(n,r,.13),o=$(a,Z(i,t,`wood`,{roughness:.86,bumpScale:.012}),e,0,-.16,0);o.name=`wood-work-surface`;let s=o.position.y+pf(a).max,c=_f(Math.round(n*r*977)),l=Z(new K(i).multiplyScalar(.48),t,void 0,{roughness:.96,transparent:!0,opacity:.24,depthWrite:!1});for(let t=0;t<13;t+=1){let t=(c()-.5)*r*.76,i=(c()-.5)*.045,a=yf([new W(-n*.44,s+.001,t),new W(-n*.08,s+.0015,t+i),new W(n*.2,s+.001,t-i*.45),new W(n*.44,s+.0012,t+i*.3)],.0022+c()*.0014,l,e);a.castShadow=a.receiveShadow=!1}return{object:o,topY:s}}function Cf(e,t,n,r,i){let a=new Xi(e,t,n,r,3),o=a.attributes.position,s=_f(i),c=Array.from({length:r},()=>(s()-.5)*.045);for(let e=0;e<o.count;e+=1){let t=o.getX(e),n=o.getZ(e),a=Math.atan2(n,t),s=1+c[(Math.round((a+Math.PI)/(Math.PI*2)*r)%r+r)%r]+Math.sin(a*5+i)*.008;o.setX(e,t*s),o.setZ(e,n*s)}return o.needsUpdate=!0,a.computeVertexNormals(),a}function wf(){let e=[],t=[];for(let t=0;t<=18;t+=1){let n=t/18,r=n-.5,i=Math.sin(n*Math.PI)*.022+Math.sin(n*Math.PI*2.2)*.004,a=Math.sin(n*Math.PI*1.3)*.008,o=Et.lerp(.035,.018,n)*(1+Math.sin(n*Math.PI*3)*.045);for(let t=0;t<9;t+=1){let n=t/9*Math.PI*2;e.push(i+Math.cos(n)*o,r,a+Math.sin(n)*o)}}for(let e=0;e<18;e+=1)for(let n=0;n<9;n+=1){let r=(n+1)%9,i=e*9+n,a=e*9+r,o=(e+1)*9+n,s=(e+1)*9+r;t.push(i,o,a,a,o,s)}let n=new Dr;return n.setAttribute(`position`,new q(e,3)),n.setIndex(t),n.computeVertexNormals(),n}function Tf(e,t,n,r=1.3,i=.006){let a=new Yi(.013,6);a.rotateX(-Math.PI/2);let o=new Di(a,Z(15787987,t,`flour`,{roughness:1}),n),s=new wn;for(let e=0;e<n;e+=1){let t=Q()*Math.PI*2,n=Math.sqrt(Q())*r;s.position.set(Math.cos(t)*n,i,Math.sin(t)*n*.66),s.scale.setScalar(.25+Q()*1.05),s.updateMatrix(),o.setMatrixAt(e,s.matrix)}return o.castShadow=!1,e.add(o),o}var Ef=class{object;depthWriteThreshold;materials;last=-1;constructor(e,t=.96){this.object=e,this.depthWriteThreshold=t,this.materials=[],e.traverse(e=>{let t=e;(Array.isArray(t.material)?t.material:t.material?[t.material]:[]).forEach(e=>{this.materials.some(t=>t.material===e)||this.materials.push({material:e,opacity:e.opacity,depthWrite:e.depthWrite})})})}set(e){let t=Et.clamp(e,0,1);t!==this.last&&(this.last=t,this.object.visible=t>.002,this.materials.forEach(e=>{e.material.transparent=!0,e.material.opacity=t*e.opacity,e.material.depthWrite=e.depthWrite&&t>this.depthWriteThreshold}))}},Df=class{mesh;original;position;colors;doughSurface;crustSurface;showingCrustSurface=!1;lastProgress=-1;color=new K;pale=new K(Jd.flour);wet=new K(14200434);proofed=new K(15055736);crust=new K(13008180);toasted=new K(6104079);cut=new K(15779975);raised=new K(16105837);constructor(e,t){let n=new So(1,t.mobile?72:t.tier===`high`?128:96,t.mobile?36:t.tier===`high`?64:48);this.position=n.attributes.position,this.original=new Float32Array(this.position.array),this.colors=new pr(new Float32Array(this.position.count*3),3),n.setAttribute(`color`,this.colors),this.doughSurface=uf(`dough`,t),this.crustSurface=uf(`crust`,t),this.mesh=$(n,Z(16777215,t,`dough`,{vertexColors:!0,roughness:.96,metalness:0,emissive:2429447,emissiveIntensity:.035}),e),this.mesh.name=`hero-dough-loaf`,this.mesh.frustumCulled=!1}apply(e){if(e===this.lastProgress)return;this.lastProgress=e;let t=X(e,.502,.575),n=X(e,.598,.692),r=X(e,.705,.778),i=X(e,.834,.885),a=X(e,.842,.925),o=X(e,.776,.803),s=X(e,.61,.69,e=>e),c=Math.sin(s*Math.PI*3)**2*Ld(s),l=a>.28;if(l!==this.showingCrustSurface){let e=l?this.crustSurface:this.doughSurface;this.mesh.material.map=e.albedo,this.mesh.material.bumpMap=e.height,this.mesh.material.roughnessMap=e.roughness,this.mesh.material.needsUpdate=!0,this.showingCrustSurface=l}let u=X(e,.989,.997)*.9,d=.8+t*.12+n*.2+r*.18+i*.14,f=.08+t*.56+r*.2+i*.12,p=.69+t*.045+r*.06-a*.018,m=X(e,.492,.565,e=>e)*Math.PI*5;for(let e=0;e<this.position.count;e+=1){let l=this.original[e*3],h=this.original[e*3+1],g=this.original[e*3+2],_=Math.max(0,h),v=Nd((h+.12)/1.12),y=Math.max(0,(h+.64)/1.64),b=Math.exp(-(((l-Math.sin(s*Math.PI*3)*.4)/.42)**2))*c,x=Math.sin(l*7.5+g*5.5-m)*_*t*(1-t)*.125,S=Math.sin(l*6.5+s*8)*b*_*.06,C=l+g*.32-Et.lerp(-.3,.26,s),w=(Math.exp(-(((C+.18)/.25)**2))*.145-Math.exp(-(((C-.015)/.12)**2))*.082)*_*Ld(s),T=Math.sin(l*4.3+g*7.1)*t*(1-t)*.038,E=1-(r*.045+i*.18)*Math.abs(l)**1.48,D=1+r*(.052*Math.sin(l*2.2+g*2.7)+l*.028-g*.018),ee=r*_*(.024*Math.sin(l*3.1-g*2.4)+.018*l),O=r*_*(1-a*.55)*(Math.exp(-((l-.28)**2+(g+.16)**2)/.038)*.012+Math.exp(-((l+.34)**2+(g-.08)**2)/.052)*.009+Math.exp(-((l-.02)**2+(g-.31)**2)/.034)*.007),k=a*_*(Math.sin(l*2.7+g*3.6)*.012+l*.008-g*.006),te=y*f*D*E-b*_*.225+x+S+w+ee+O+k,A=l*d*(1+c*.15)+T*(.4+_)+n*Math.sin(g*3.2+h)*.018,j=g*p*E*(1-c*.09)+T*.42;A>.72&&(A=Et.lerp(A,.72,u));let ne=A+j*.42,M=0,N=0,re=0;for(let e of gf){let t=(.014+i*.031)*e.width,n=e.center+Math.sin(j*2.7+e.center*3.2)*e.curve,r=Math.abs(ne-n);M=Math.max(M,Math.exp(-((r/t)**2))),N=Math.max(N,Math.exp(-((r/(t*.34))**2))*e.depth),re=Math.max(re,Math.exp(-(((r-t*1.05)/(t*.48))**2)))}let ie=X(h,.28,.66)*(1-X(Math.abs(g),.57,.88));M*=ie*o,N*=ie*o,re*=ie*o,te-=M*(.03+i*.068);let ae=Math.sin(A*21+j*13)*Math.sin(j*31-A*9),oe=Math.max(0,Math.sin(A*8.6+j*4.9)*Math.cos(j*10.2-A*3.3)-.7);te+=_*a*(ae*.0055+oe*.008),this.position.setXYZ(e,A,Math.max(0,te),j),this.color.copy(this.pale).lerp(this.wet,t*(.72-n*.25)),this.color.lerp(this.proofed,n*.52+r*.2);let se=Nd(.52+v*.34+l*.065-g*.12+ae*.15);this.color.lerp(this.crust,a*se);let ce=Math.max(0,Math.sin(A*5.2+j*4.1+Math.sin(j*2.7))*Math.cos(j*6.1-A*3.4)-.08);this.color.lerp(this.toasted,a*((1-v)*.74+Math.max(0,g)*.075+N*.36+ce*v*.078)),this.color.lerp(this.cut,M*a*.72),this.color.lerp(this.toasted,N*a*.76),this.color.lerp(this.raised,re*a*.88);let le=Math.max(0,Math.sin(A*12+j*7)*Math.sin(j*18-A*3.5)-.34);this.color.lerp(this.pale,le*v*a*(1-M)*.4),this.colors.setXYZ(e,this.color.r,this.color.g,this.color.b)}let h=t*(1-n);this.mesh.material.roughness=Math.min(.99,.96-h*.34+n*.13+r*.03+a*.09),this.mesh.material.bumpScale=.006+a*.036,this.mesh.material.emissiveIntensity=.025+a*.018,this.position.needsUpdate=this.colors.needsUpdate=!0,this.mesh.geometry.computeVertexNormals()}};function Of(e,t,n,r,i){let a=new Dr,o=new pr(new Float32Array(t*3),3),s=new pr(new Float32Array(t),1),c=new Float32Array(t),l=new Float32Array(t);for(let e=0;e<t;e+=1)c[e]=Et.lerp(n,r,Q()**1.65),l[e]=Q();a.setAttribute(`position`,o),a.setAttribute(`alpha`,s),a.setAttribute(`size`,new pr(c,1)),a.setAttribute(`shape`,new pr(l,1));let u=new Vi(a,new Po({transparent:!0,depthWrite:!1,uniforms:{tint:{value:new K(i)},pixelRatio:{value:e.dpr}},vertexShader:`
    ...
    `}));return u.frustumCulled=!1,{points:u,positions:o,alphas:s}}function kf(e,t){let n=e.mobile?28:48,r=e.mobile?7:11,i=_f(t),a=Array.from({length:n},()=>.91+i()*.17),o=[0,.225,0],s=[.5,.5],c=[1,.975,.91],l=[];for(let e=1;e<=r;e+=1){let t=e/r;for(let e=0;e<n;e+=1){let r=e/n*Math.PI*2,i=t*Et.lerp(1,a[e],t**1.5),l=Math.cos(r)*i*.96,u=Math.sin(r)*i*.7,d=Math.max(0,1-t**1.65)**1.42*.225,f=(Math.sin(r*5.1+t*8.2)+Math.sin(r*9.3-t*5.4)*.5)*.0045*(1-t);o.push(l,Math.max(0,d+f),u),s.push(.5+l*.5,.5+u/1.4);let p=.9+(1-t)*.065+Math.sin(r*4.7+t*7.2)*.018;c.push(p,p*.976,p*.92)}}for(let e=0;e<n;e+=1){let t=(e+1)%n;l.push(0,1+t,1+e)}for(let e=1;e<r;e+=1){let t=1+(e-1)*n,r=t+n;for(let e=0;e<n;e+=1){let i=(e+1)%n,a=t+e,o=t+i,s=r+e,c=r+i;l.push(a,o,s,o,c,s)}}let u=new Dr;return u.setAttribute(`position`,new q(o,3)),u.setAttribute(`uv`,new q(s,2)),u.setAttribute(`color`,new q(c,3)),u.setIndex(l),u.computeVertexNormals(),u}var Af=class{group=new Tn;pile=new Tn;mound;moundMaterial;settledDust;pileShadow;grinding;stream;impact;grindingParticles=[];streamParticles=[];impactParticles=[];haze=[];source=new W;destination=new W;constructor(e){this.group.name=`milling-output`;let t=e.mobile?56:e.tier===`high`?150:96,n=Math.floor(e.flourCount*.64),r=Math.max(120,e.flourCount-n-t);this.grinding=Of(e,t,.4,1.12,14271645),this.stream=Of(e,n,.38,1.38,14996921),this.impact=Of(e,r,.4,1.48,14206375),this.group.add(this.grinding.points,this.stream.points,this.impact.points);for(let e=0;e<t;e+=1)this.grindingParticles.push({angle:Math.PI*(.3+Q()*.4),radius:1.155+Q()*.115,delay:Q(),phase:Q()*Math.PI*2,weight:Q()**.95,near:Q(),turbulence:.003+Q()*.009});for(let e=0;e<n;e+=1)this.streamParticles.push({angle:Q()*Math.PI*2,radius:Q()**2.15,delay:Q(),phase:Q(),weight:Q()**1.55,near:Q(),turbulence:.004+Q()*.014});for(let e=0;e<r;e+=1)this.impactParticles.push({angle:Q()*Math.PI*2,radius:Math.sqrt(Q()),delay:Q(),phase:Q(),weight:Q()**1.45,near:Q(),turbulence:.008+Q()*.02});let i=document.createElement(`canvas`);i.width=i.height=96;let a=i.getContext(`2d`),o=a.createRadialGradient(44,51,3,48,48,47);o.addColorStop(0,`rgba(255,248,230,0.7)`),o.addColorStop(.38,`rgba(246,235,211,0.29)`),o.addColorStop(1,`rgba(238,224,198,0)`),a.fillStyle=o,a.fillRect(0,0,96,96);let s=new Wi(i);s.colorSpace=Le;let c=e.mobile?3:6,l=e.mobile?1:2;for(let e=0;e<c;e+=1){let t=new Nr({map:s,color:new K().setHSL(.105+e*.0025,.26,.86+e%3*.02),transparent:!0,opacity:0,depthWrite:!1,depthTest:e>=l}),n=new qr(t);n.frustumCulled=!1,n.renderOrder=e<l?12:0,this.group.add(n),this.haze.push({sprite:n,material:t,phase:Q()*Math.PI*2,near:Q(),scale:.62+Q()*.68})}let u=kf(e,7301);this.moundMaterial=Z(15195332,e,`flour`,{roughness:1,bumpScale:.003,vertexColors:!0}),this.mound=$(u,this.moundMaterial,this.pile),this.mound.name=`flour-pile-mound`,this.mound.castShadow=!1,this.pile.name=`flour-pile`,this.group.add(this.pile),this.settledDust=Tf(this.pile,e,e.mobile?22:38,.76,ff);let d=this.settledDust.material;d.transparent=!0,d.opacity=0,d.depthWrite=!1,this.pileShadow=Gf(this.group,1.45,.95),this.pileShadow.material.opacity=.1}update(e,t,n,r,i,a){let o=X(e,.274,.31)*(1-X(e,.41,.442)),s=X(e,.304,.356,e=>e*e*(2-e)),c=s*(1-X(e,.416,.447)),l=X(e,.326,.405),u=X(e,.342,.418)*(1-X(e,.463,.505)),d=X(e,.397,.432)*(1-X(e,.448,.486)),f=X(e,.326,.413,e=>e*e*(2-e)),p=X(e,.332,.402,e=>e*e*(3-2*e)),m=1-X(e,.414,.444),h=f*m;this.group.visible=e>=.27&&e<=.51,this.pile.position.copy(r);let g=Et.lerp(.11,.42,f**.62),_=Et.lerp(.01,.155,p**.92)*(1+c*.035);this.mound.scale.set(Math.max(.001,g),Math.max(.001,_/.225),Math.max(.001,g)),this.moundMaterial.transparent=m<.999,this.moundMaterial.opacity=m,this.moundMaterial.depthWrite=m>.96;let v=Et.lerp(.22,1,f**.58);this.settledDust.scale.set(v,1,v),this.settledDust.material.opacity=m*(.1+f*.25),this.pile.visible=h>.002,this.pileShadow.position.set(r.x-.018,r.y+.002,r.z-.032);let y=Math.max(.001,.24+f*.58);if(this.pileShadow.scale.set(y*1.02,y*.88,1),this.pileShadow.visible=this.pile.visible,this.pileShadow.material.opacity=h*.1,!this.group.visible)return;this.grindingParticles.forEach((e,n)=>{let r=e.angle+Math.sin(a*.42+e.phase)*(.035+e.weight*.085),s=Math.sin(t*(.8+e.weight*.7)+e.phase)*e.turbulence,c=e.radius+s+o*e.weight*.045,l=o*e.weight*.052;this.grinding.positions.setXYZ(n,i.x+Math.cos(r)*c,i.y+.408+l+(e.near-.5)*.038+Math.sin(e.phase+a)*.012,i.z+Math.sin(r)*c),this.grinding.alphas.setX(n,o*(.075+e.weight*.25))}),this.grinding.positions.needsUpdate=this.grinding.alphas.needsUpdate=!0,this.source.copy(n),this.streamParticles.forEach((n,i)=>{let a=+(s>=n.delay*.88),o=((n.phase+e*(17+n.weight*7))%1+1)%1,l=(.015+n.radius*.14)*(.3+o*.7);this.destination.set(r.x+Math.cos(n.angle)*l,r.y+.012+n.weight*.012,r.z+Math.sin(n.angle)*l*.72),df.lerpVectors(this.source,this.destination,o),df.y=this.source.y+(this.destination.y-this.source.y)*o*o;let u=Math.sin(n.phase*21+o*7.2+t*.28)*n.turbulence*o;df.x+=u,df.z+=Math.cos(n.phase*17+o*5.4)*n.turbulence*o*.62;let d=X(o,0,.08)*(1-X(o,.9,1));this.stream.positions.setXYZ(i,df.x,df.y,df.z),this.stream.alphas.setX(i,a*c*d*(.24+n.weight*.48))}),this.stream.positions.needsUpdate=this.stream.alphas.needsUpdate=!0;let b=Math.max(c*.72,u*.58,d*.42);this.impactParticles.forEach((n,i)=>{let a=((n.phase+e*(10+n.weight*4))%1+1)%1,o=Math.sin(a*Math.PI),s=d*n.near**1.55,c=n.radius*(.035+l*.62+s*.82)*Math.sqrt(a),f=Math.sin(t*.2+n.phase*11)*n.turbulence*u;this.impact.positions.setXYZ(i,r.x+Math.cos(n.angle)*c+f,r.y+.014+o*(.04+l*(.16+n.near*.3))+s*(.12+n.near*.76),r.z+Math.sin(n.angle)*c*.68+f*.6+s*1.38);let p=X(a,0,.12)*(1-X(a,.78,1)),m=+(l>=n.delay*.82);this.impact.alphas.setX(i,m*b*p*(.09+n.weight*.34+s*.11))}),this.impact.positions.needsUpdate=this.impact.alphas.needsUpdate=!0;let x=this.haze.length<=3?1:2;this.haze.forEach((e,n)=>{let i=e.near**1.6,a=n<x?Math.max(u*(.075+i*.1),d*(.32+i*.17)):u*(.09+i*.16);e.sprite.visible=a>.003,e.material.opacity=a,e.sprite.position.set(r.x+Math.sin(e.phase+t*.08)*(.18+i*.42),r.y+.18+i*.62+Math.cos(e.phase+t*(.12+i*.06))*.09,r.z+.1+i*1.62+Math.sin(n*1.7)*.08);let o=e.scale*(.52+u*1.05+d*1.12)*(1+i*.82);e.sprite.scale.set(o,o*(.48+n%3*.09),1),e.material.rotation=e.phase*.18+t*(n%2==0?.018:-.013)})}};function jf(){let e=new So(1,12,9),t=e.attributes.position;for(let e=0;e<t.count;e+=1){let n=t.getX(e),r=t.getY(e),i=t.getZ(e),a=.76+(1-Math.abs(r)**1.45)*.24,o=1+r*.045+Math.sin(r*3.4)*.018;t.setXYZ(e,n*a*o+(1-r*r)*.055,r,i*a*.88)}return e.computeVertexNormals(),e}function Mf(e,t,n,r){let i=new ka;return i.moveTo(0,0),i.bezierCurveTo(e*n*.4,t*.18,e*(n+r*.15),t*.52,e*r,t),i.bezierCurveTo(e*(n*.34+r*.42),t*.6,e*n*.18,t*.2,0,0),new bo(i,7)}function Nf(e,t,n,r){let i=_f(r),a=new Tn;e.add(a);let o=Z(12226879,t,void 0,{roughness:.92}),s=Z(Jd.wheatLight,t,`grain`,{roughness:.76,emissive:7030027,emissiveIntensity:.13});yf([new W(0,0,0),new W(-.018,n*.34,.008),new W(.028,n*.69,-.006),new W(.035,n,0)],.014,o,a);let c=Z(9272633,t,void 0,{roughness:.96,side:2}),l=$(Mf(-1,1.08,.16,.5),c,a,-.004,.68,.018);l.rotation.y=-.13;let u=$(Mf(1,.76,.115,.3),c,a,.018,1.05,-.012);u.rotation.y=.22;let d=jf();for(let e=0;e<9;e+=1)for(let t of[-1,1]){if(e===4&&t===1)continue;let r=n-.88+e*.095,c=$(d,s,a,t*(.062-e*.003),r,(i()-.5)*.028),l=.94+i()*.12;c.scale.set((.061-e*.0018)*l,(.112-e*.003)*l,.064*l),c.rotation.set((i()-.5)*.13,(i()-.5)*.18,t*(-.4-i()*.08));let u=(.34-e*.004)*(.86+i()*.28);vf(new W(t*.085,r+.045,c.position.z),new W(t*(.085+u*.37),r+.045+u,c.position.z+(i()-.5)*.045),.0026+i()*8e-4,o,a)}return yf([new W(0,.78,0),new W(-.19,1.12,.06),new W(-.31,1.43,.03)],.017,o,a),a.userData.phase=i()*Math.PI*2,a}function Pf(e){let t=new Tn,n=e.wheatCount,r=new Di(new Xi(.012,.018,1,6),Z(6716222,e,void 0,{roughness:.96}),n),i=new Di(new So(1,8,6),Z(Jd.wheat,e,`grain`,{roughness:.84,emissive:4926472,emissiveIntensity:.065}),n*8),a=new Di(new Xi(.0025,.0025,1,4),Z(10386226,e,void 0,{roughness:.96}),n*8);r.instanceMatrix.setUsage(He),i.instanceMatrix.setUsage(He),a.instanceMatrix.setUsage(He),r.castShadow=i.castShadow=a.castShadow=e.shadows,r.receiveShadow=i.receiveShadow=a.receiveShadow=e.shadows,t.add(r,i,a);let o=[-2.55,-1.62,-.72,.2,1.16,2.18,2.78],s=Math.max(12,Math.floor(n*.065)),c=Array.from({length:n},(e,t)=>{let n=t<s,r=o[Math.floor(Q()*o.length)],i=(Q()+Q()+Q()-1.5)*.64,a=Q()>.5?1:-1;return{x:n?a*(1.25+Q()*1.75)+(Q()-.5)*.35:r+i,z:n?.34+Q()*1.35:-.52-Q()*3,height:n?1.62+Q()*.72:1.15+Q()*.82,scale:n?.92+Q()*.32:.72+Q()*.46,phase:Q()*Math.PI*2,lean:(Q()-.5)*(n?.28:.19),forward:(Q()-.5)*.13,tone:Q()}}),l=new wn,u=new K,d=0;return c.forEach((e,t)=>{u.setHSL(.22+e.tone*.018,.34,.25+e.tone*.11),r.setColorAt(t,u);for(let t=0;t<4;t+=1)for(let t of[-1,1])u.setHSL(.105+e.tone*.018,.58+e.tone*.08,.41+e.tone*.15),i.setColorAt(d,u),a.setColorAt(d,u.clone().multiplyScalar(.73)),d+=1}),r.instanceColor.needsUpdate=i.instanceColor.needsUpdate=a.instanceColor.needsUpdate=!0,{group:t,update(e){let t=0,n=0;c.forEach((o,s)=>{let c=Math.sin(e*(.48+o.tone*.19)+o.phase)*(.018+o.tone*.014),u=o.height*o.scale;l.position.set(o.x+c*.25,u*.5-.03,o.z),l.rotation.set(o.forward+c*.35,0,o.lean+c),l.scale.set(1,u,1),l.updateMatrix(),r.setMatrixAt(s,l.matrix);for(let e=0;e<4;e+=1){let r=u*.63+e*.105;for(let s of[-1,1]){let u=s*(.048-e*.002),d=(o.lean+c)*r*.44,f=o.forward*r*.38;l.position.set(o.x+d+u,r,o.z+f),l.rotation.set(o.forward,0,o.lean+c+s*-.42);let p=.9+o.tone*.18;l.scale.set((.057-e*.002)*p,(.092-e*.003)*p,.06*p),l.updateMatrix(),i.setMatrixAt(t,l.matrix),t+=1,l.position.set(o.x+d+s*.082,r+.045,o.z+f),l.rotation.set(o.forward,0,o.lean+c+s*-.34),l.scale.set(1,.34,1),l.updateMatrix(),a.setMatrixAt(n,l.matrix),n+=1}}}),r.instanceMatrix.needsUpdate=!0,i.instanceMatrix.needsUpdate=!0,a.instanceMatrix.needsUpdate=!0}}}function Ff(e,t=1){let n=[[.008,-.64],[.12,-.59],[.27,-.4],[.345,-.12],[.355,.14],[.3,.4],[.18,.57],[.045,.65],[.008,.66]],r=new Tn,i=new vo(n.map(([e,t])=>new U(e,t)),e.mobile?28:e.tier===`high`?40:34),a=i.attributes.position;for(let e=0;e<a.count;e+=1){let t=a.getX(e),n=a.getY(e),r=a.getZ(e),i=Math.atan2(r,t),o=1+n*.075+Math.sin(n*4.2)*.024,s=1+Math.sin(i*3+n*2.1)*.012,c=t*o*s+(1-n*n)*.03,l=r*.71*(1-n*.05)*s,u=Math.max(0,Math.sin(i)),d=Math.exp(-((c/.078)**2))*u*(1-(Math.abs(n)/.68)**2)*.072;a.setXYZ(e,c,n,l-Math.max(0,d))}return i.computeVertexNormals(),$(i,Z(14724429,e,`grain`,{roughness:.78,bumpScale:.012,emissive:3480069,emissiveIntensity:.075}),r).scale.setScalar(t),yf([new W(.018,-.48,.174),new W(-.01,-.2,.199),new W(.012,.15,.196),new W(-.004,.47,.166)],.012,Z(5320979,e,void 0,{roughness:.99}),r).scale.setScalar(t),yf([new W(.037,-.42,.183),new W(.019,-.12,.208),new W(.032,.2,.205),new W(.016,.42,.177)],.0035,Z(16109432,e,void 0,{roughness:.82}),r).scale.setScalar(t),r}function If(e){let t=new Tn,n=Z(10986389,e,`stone`,{roughness:.96}),r=Z(8486257,e,`stone`,{roughness:.98}),i=Z(6842207,e,void 0,{roughness:.94}),a=Z(3157803,e,void 0,{metalness:.48,roughness:.55}),o=new Tn;o.position.y=.62,t.add(o),$(Cf(1.19,1.25,.38,48,31),n,t,0,.2,0),$(Cf(1.16,1.2,.44,48,79),n,o);let s=$(new Yi(1.075,48),new ri({color:1513233,transparent:!0,opacity:.28,depthWrite:!1}),t,0,.397,0);s.rotation.x=-Math.PI/2,s.castShadow=s.receiveShadow=!1,bf(1.12,.042,Z(5131591,e,`stone`,{roughness:.99}),t,.025),bf(1.205,.028,r,t,.37),bf(1.18,.025,r,o,-.2),bf(1.16,.014,a,o,.2),bf(.19,.026,a,o,.225);for(let e=0;e<14;e+=1){let t=e/14*Math.PI*2,n=t+.2+Math.sin(e*1.7)*.035;vf(new W(Math.cos(t)*.29,.224,Math.sin(t)*.29),new W(Math.cos(n)*1.08,.224,Math.sin(n)*1.08),.008,i,o)}let c=Z(6446934,e,`stone`,{roughness:.99}),l=Z(12631214,e,`stone`,{roughness:.98});for(let e=0;e<11;e+=1){let t=e/11*Math.PI*2+.13,n=1.218+Math.sin(e*2.4)*.008,r=$(new Ji(.11+e%3*.035,.018+e%2*.008,.016),e%4==0?l:c,o,Math.cos(t)*n,-.02+Math.sin(e*1.7)*.105,Math.sin(t)*n);r.rotation.y=Math.PI/2-t,r.rotation.z=Math.sin(e*2.1)*.16,r.castShadow=!1}vf(new W(0,.74,0),new W(0,1.78,0),.052,a,t),vf(new W(0,1.1,0),new W(.88,1.1,0),.052,a,o),vf(new W(.88,1.08,0),new W(.88,1.5,0),.09,Z(9329201,e,`wood`,{roughness:.83}),o);let u=Z(11434313,e,`wood`,{side:2,roughness:.86,emissive:2823689,emissiveIntensity:.05}),d=new Tn;d.position.y=1.35,d.rotation.y=Math.PI/4+.16,t.add(d),$(new Xi(.49,.14,.56,4,1,!0),u,d);let f=Z(7357993,e,`wood`,{roughness:.92,bumpScale:.01}),p=Z(5123869,e,void 0,{roughness:.96});for(let e of[-1,1])$(new Ji(.78,.045,.045),f,d,0,.29,e*.39),$(new Ji(.045,.045,.78),f,d,e*.39,.29,0);for(let e=0;e<4;e+=1){let t=Math.PI/4+e*Math.PI/2;vf(new W(Math.cos(t)*.47,.27,Math.sin(t)*.47),new W(Math.cos(t)*.13,-.27,Math.sin(t)*.13),.008,p,d)}bf(.145,.016,Z(6175784,e,void 0,{roughness:.92}),t,1.07);let m=new Tn;m.position.set(.25,.36,1.15),m.rotation.x=.14,t.add(m);let h=Z(9658425,e,`wood`,{roughness:.88,bumpScale:.009}),g=Z(7159845,e,`wood`,{roughness:.92,bumpScale:.008});$(xf(.46,.82,.055,.04),h,m);let _=$(new Ji(.31,.008,.56),Z(4796451,e,`wood`,{roughness:.96}),m,0,.034,.06);_.castShadow=!1,$(new Ji(.042,.105,.77),g,m,-.205,.052,0),$(new Ji(.042,.105,.77),g,m,.205,.052,0);let v=$(new Ji(.37,.075,.038),Z(3087378,e,void 0,{roughness:.98}),m,0,.025,.4);v.castShadow=!1;let y=$(new Ji(.47,.052,.06),g,m,0,-.004,.405);y.rotation.z=.006;let b=Z(15194557,e,`flour`,{transparent:!0,opacity:.42,depthWrite:!1});for(let e=0;e<3;e+=1){let t=$(new Ji(.025+e*.006,.004,.18+e*.035),b,m,(e-1)*.075,.032+e*.001,.18+e*.035);t.rotation.y=(e-1)*.07,t.castShadow=t.receiveShadow=!1}let x=new W(0,.006,.408).applyEuler(m.rotation).add(m.position),S=mf(t),C=Gf(t,2.85,2.45);return C.scale.set(1.08,1,1),C.material.opacity=.4,{group:t,rotor:o,outlet:x,shadow:C,localBottomY:S}}function Lf(e){let t=new Tn,n=new vo([[.48,-.42],[.82,-.36],[1.16,-.14],[1.3,.18],[1.25,.4],[1.08,.52],[.96,.48],[1,.28],[.9,.02],[.72,-.18],[.44,-.27]].map(([e,t])=>new U(e,t)),48),r=n.attributes.position;for(let e=0;e<r.count;e+=1){let t=r.getX(e),n=r.getY(e),i=r.getZ(e),a=Math.atan2(i,t),o=1+Math.sin(a*3+n*2.1)*.005+Math.cos(a*5-n)*.0025;r.setXYZ(e,t*o,n+Math.sin(a*2.2)*.003,i*o)}n.computeVertexNormals();let i=$(n,Z(14209472,e,void 0,{roughness:.36,emissive:1511947,emissiveIntensity:.018}),t);i.scale.z=.96;let a=$(new Yi(.455,40),Z(11183773,e,void 0,{roughness:.58}),t,0,-.265,0);a.rotation.x=-Math.PI/2;let o=$(new Yi(.94,32),Z(Jd.flour,e,`flour`,{roughness:1}),t,0,.39,0);o.rotation.x=-Math.PI/2,bf(1.14,.042,Z(16050902,e,void 0,{roughness:.22,emissive:2826258,emissiveIntensity:.045}),t,.48).scale.set(1,.98,1),bf(1.045,.018,Z(12170408,e,void 0,{roughness:.48}),t,.455).scale.set(1,.96,1);let s=Z(11183512,e,void 0,{roughness:.62}),c=$(new Xi(.49,.455,.052,40),s,t,0,-.401,0);c.scale.z=.96;let l=bf(.48,.035,s,t,-.4);return l.scale.z=.96,{group:t,flourSurface:o,localBottomY:mf(t),doughSupportY:.055}}function Rf(e){let t=new Tn;t.position.set(-1.25,1.47,-.08),t.rotation.z=-.6;let n=Z(11916497,e,void 0,{transparent:!0,opacity:.48,roughness:.1,metalness:.08,side:2,depthWrite:!1});$(new vo([[.22,-.34],[.27,-.29],[.3,.12],[.285,.27],[.32,.34]].map(([e,t])=>new U(e,t)),32),n,t),bf(.32,.024,n,t,.34);let r=$(new wo(.2,.037,12,32),n,t,-.36,0,0);r.scale.x=.75;let i=$(new Zi(.14,.3,4,1,!0),n,t,.25,.34,0);i.rotation.z=-Math.PI/2,i.rotation.y=Math.PI/4;let a=$(new Xi(.274,.235,.36,32),Z(7515829,e,void 0,{transparent:!0,opacity:.67,roughness:.12,depthWrite:!1}),t,0,-.11,0);a.castShadow=!1;let o=$(new Yi(.272,32),Z(11131354,e,void 0,{transparent:!0,opacity:.72,roughness:.08,depthWrite:!1}),t,0,.07,0);return o.rotation.x=-Math.PI/2,t.traverse(e=>{let t=e;t.isMesh&&(t.castShadow=!1)}),a.renderOrder=1,o.renderOrder=1,t.children.forEach(e=>{let t=e;t.isMesh&&t.material===n&&(t.renderOrder=2)}),t}function zf(e){let t=new Tn,n=[13015648,12158544,13675121].map(t=>Z(t,e,`wood`,{roughness:.92}));for(let e=0;e<12;e+=1){let r=bf(.77+e*.022+Math.sin(e*1.7)*.006,.027+e%3*.002,n[e%n.length],t,.05+e*.031);r.position.x=Math.sin(e*2.3)*.005,r.rotation.z=Math.sin(e*1.2)*.004}let r=[Z(8476209,e,`wood`,{roughness:.95}),Z(10119999,e,`wood`,{roughness:.95})];for(let e=0;e<28;e+=1){let n=e/28*Math.PI*2,i=.995+Math.sin(e*1.31)*.008;vf(new W(Math.cos(n)*.79,.055,Math.sin(n)*.79),new W(Math.cos(n)*i,.405,Math.sin(n)*i),.0095,r[e%2],t)}return{group:t,localBottomY:mf(t),doughSupportY:.13}}function Bf(e){let t=new Tn,n=[9323305,10637100,7550757,11557942].map(t=>Z(t,e,`stone`,{roughness:.92})),r=Z(3156001,e,`stone`,{roughness:.97}),i=Z(459779,e,void 0,{roughness:1});$(xf(3.8,2.65,.18),r,t,0,-.18,0),$(new Ji(3.5,2.2,.18),i,t,0,1.02,-1.08),$(new Ji(.16,1.18,1.5),i,t,-1.12,.59,-.28),$(new Ji(.16,1.18,1.5),i,t,1.12,.59,-.28),$(new Ji(2.25,.12,1.5),i,t,0,1.18,-.28);let a=Z(2889489,e,`stone`,{roughness:.98}),o=$(new wo(1.18,.095,8,42,Math.PI),a,t,0,1.17,.57);o.rotation.z=0,$(new Ji(.19,1.17,.26),a,t,-1.18,.59,.57),$(new Ji(.19,1.17,.26),a,t,1.18,.59,.57),$(new Ji(.55,1.2,1.55),r,t,-1.47,.6,-.12),$(new Ji(.55,1.2,1.55),r,t,1.47,.6,-.12);for(let e of[-1,1])for(let r=0;r<4;r+=1){let i=$(new Ji(.49,.265,.24),n[(r+ +(e>0))%n.length],t,e*1.47,.16+r*.3,.69);i.position.x+=Math.sin(r*2.1+e)*.012,i.position.z+=Math.cos(r*1.8+e)*.014,i.rotation.z=Math.sin(r*1.37+e)*.012,i.scale.set(.96+r%3*.025,.97+(r+1)%2*.025,1)}for(let e=0;e<13;e+=1){let r=e/13*Math.PI+.005,i=(e+1)/13*Math.PI-.005,a=new ka;a.moveTo(Math.cos(r)*1.2,1.17+Math.sin(r)*.94),a.lineTo(Math.cos(r)*1.745,1.17+Math.sin(r)*1.39),a.lineTo(Math.cos(i)*1.745,1.17+Math.sin(i)*1.39),a.lineTo(Math.cos(i)*1.2,1.17+Math.sin(i)*.94),a.closePath();let o=$(new mo(a,{depth:1.5,bevelEnabled:!0,bevelSegments:1,bevelSize:.012,bevelThickness:.012}),n[e%n.length],t,0,0,-.86);o.position.z+=Math.sin(e*1.73)*.016}let s=[6640711,5851454,7626836].map(t=>Z(t,e,`stone`,{roughness:.98})),c=-1/0;for(let e=0;e<5;e+=1){let n=new Ji(.47,.11,1.45),r=$(n,s[e%s.length],t,-.98+e*.49,.04,.01);r.position.y+=Math.sin(e*2.1)*.008,r.rotation.y=Math.sin(e*1.9)*.009,c=Math.max(c,r.position.y+pf(n).max)}let l=document.createElement(`canvas`);l.width=256,l.height=128;let u=l.getContext(`2d`),d=u.createRadialGradient(128,98,4,128,90,118);d.addColorStop(0,`rgba(255,139,50,0.92)`),d.addColorStop(.28,`rgba(209,63,15,0.5)`),d.addColorStop(1,`rgba(63,9,2,0)`),u.fillStyle=d,u.fillRect(0,0,256,128);let f=new Wi(l);f.colorSpace=Le;let p=$(new yo(2.15,.82),new ri({map:f,transparent:!0,opacity:0,depthWrite:!1,blending:2}),t,0,.46,-.98);p.castShadow=!1;let m=[];for(let n=0;n<11;n+=1){let r=n<5,i=n%2==0?-1:1,a=$(new _o(.026+Q()*.027,0),Z(7741966,e,void 0,{emissive:n%3==0?15300901:12073750,emissiveIntensity:.55,roughness:1}),t,r?i*(.78+Q()*.25):-.88+Q()*1.76,.13+Q()*.07,r?.35+Q()*.38:-.52-Q()*.34);a.userData.phase=Q()*Math.PI*2,m.push(a)}return{group:t,glow:p,embers:m,floorSurfaceY:c}}function Vf(e){let t=new Tn;t.name=`bread-knife`;let n=new ka;n.moveTo(-.72,.065),n.lineTo(.72,.055),n.lineTo(.72,-.018);for(let e=8;e>=0;--e){let t=-.64+e*.15;n.lineTo(t,e%2==0?-.055:-.028)}n.lineTo(-.72,-.015),n.closePath();let r=new mo(n,{depth:.026,bevelEnabled:!0,bevelSegments:1,bevelSize:.006,bevelThickness:.005});r.rotateY(Math.PI/2),r.center();let i=$(r,Z(13750472,e,void 0,{metalness:.78,roughness:.2,emissive:3881010,emissiveIntensity:.12}),t,0,0,.08);i.castShadow=e.shadows,$(xf(.13,.64,.14,.04),Z(4007451,e,`wood`,{roughness:.72}),t,0,.01,-.94);let a=$(new Ji(.031,.008,.96),new ri({color:16772553,transparent:!0,opacity:.48}),t,.018,.052,.12);return a.castShadow=a.receiveShadow=!1,t}function Hf(){let e=new ka;return e.moveTo(-.48,-.34),e.bezierCurveTo(-.52,-.08,-.47,.25,-.22,.38),e.bezierCurveTo(-.06,.47,.23,.43,.39,.27),e.bezierCurveTo(.5,.14,.52,-.12,.46,-.34),e.lineTo(-.48,-.34),new bo(e,5)}function Uf(){let e=document.createElement(`canvas`);e.width=e.height=64;let t=e.getContext(`2d`),n=t.createRadialGradient(27,25,2,32,32,29);n.addColorStop(0,`rgba(66,31,12,0.94)`),n.addColorStop(.54,`rgba(103,54,23,0.82)`),n.addColorStop(.76,`rgba(243,192,117,0.34)`),n.addColorStop(1,`rgba(243,192,117,0)`),t.fillStyle=n,t.fillRect(0,0,64,64);let r=new Wi(e);return r.colorSpace=Le,r}function Wf(e){let t=new Tn;t.name=`bread-cut-reveal`;let n=Z(16774098,e,`crumb`,{roughness:.97,side:2,emissive:4924688,emissiveIntensity:.035}),r=Z(8664341,e,`crust`,{roughness:.94,bumpScale:.027}),i=new Io({map:Uf(),color:16777215,roughness:1,metalness:0,transparent:!0,opacity:.9,side:2,depthWrite:!1,polygonOffset:!0,polygonOffsetFactor:-1,polygonOffsetUnits:-1}),a=Hf(),o=$(a,r,t,.806,.43,0);o.rotation.y=Math.PI/2,o.scale.set(1,1,1);let s=$(a,n,t,.821,.43,0);s.rotation.y=Math.PI/2,s.scale.set(.94,.94,.94);let c=new Tn;c.name=`separated-slice`,$(new So(1,28,18),r,c).scale.set(.145,.44,.57);let l=$(a,n,c,.151,0,0);l.rotation.y=Math.PI/2,l.scale.set(.95,.95,.95),c.position.set(.88,.43,0),t.add(c);let u=new ri({color:13999449,transparent:!0,opacity:.14,side:2,depthWrite:!1});return[[.38,-.17,.085],[.19,.12,.055],[.55,.2,.07]].forEach(([e,n,r],i)=>{let a=$(new Yi(r,12),u,t,.825,e,n);a.rotation.y=Math.PI/2,a.scale.y=.62+i*.12}),[[.3,-.15],[.53,.09],[.4,.23],[.58,-.245],[.245,.17],[.455,-.025],[.19,-.215],[.65,-.095],[.35,.045],[.72,.12],[.29,.29]].forEach(([e,n],r)=>{let a=$(new Yi(1,12),i,t,.829+r%3*.0015,e,n);a.rotation.y=Math.PI/2;let o=.017+r%4*.005;a.scale.set(o,o*(.58+r%3*.16),o),a.rotation.x=(r%2?-1:1)*.18}),[[-.04,-.12,.075],[.18,.15,.058]].forEach(([e,t,n],r)=>{let i=$(new Yi(n,12),u,c,.155,e,t);i.rotation.y=Math.PI/2,i.scale.y=.66+r*.15}),[[-.12,-.16],[.1,.09],[.23,-.04],[-.02,.22],[.27,.2],[-.2,.12],[.16,-.2],[-.24,-.05],[.31,.04],[-.06,-.01]].forEach(([e,t],n)=>{let r=$(new Yi(1,12),i,c,.158+n%2*.0015,e,t);r.rotation.y=Math.PI/2;let a=.016+n%3*.005;r.scale.set(a,a*(.62+n%4*.12),a),r.rotation.x=(n%2?-1:1)*.16}),{group:t,slice:c,crumbs:Array.from({length:8},(e,r)=>{let i=.014+Q()*.019;return{crumb:$(r%3==0?new Co(i,0):new _o(i,0),n,t),delay:r/11+Q()*.12,x:.72+Q()*.2,z:(Q()-.5)*.55,stretch:.68+Q()*.72,drift:(Q()-.5)*.12}})}}function Gf(e,t,n){let r=document.createElement(`canvas`);r.width=r.height=128;let i=r.getContext(`2d`),a=i.createRadialGradient(64,64,5,64,64,64);a.addColorStop(0,`rgba(15,10,5,0.3)`),a.addColorStop(.55,`rgba(15,10,5,0.13)`),a.addColorStop(1,`rgba(15,10,5,0)`),i.fillStyle=a,i.fillRect(0,0,128,128);let o=$(new yo(t,n),new ri({map:new Wi(r),transparent:!0,depthWrite:!1,opacity:1}),e,0,.004,0);return o.rotation.x=-Math.PI/2,o.castShadow=o.receiveShadow=!1,o}function Kf(e){Q=_f(4937);let t=new Tn;t.name=`journey-transformation`;let n=new Tn,r=Nf(n,e,2.48,812);r.position.set(-.21,0,.26);let i=Pf(e);n.add(i.group),t.add(n);let a=e.mobile?14:32,o=new Float32Array(a*3),s=Array.from({length:a},(e,t)=>({x:-2.8+Q()*5.6,y:.45+Q()*1.75,z:-1.9+Q()*3.2,phase:Q()*Math.PI*2+t})),c=new Dr;c.setAttribute(`position`,new pr(o,3));let l=Yd(16042873,e.mobile?.022:.028,0),u=new Vi(c,l);u.name=`wheat-pollen`,u.frustumCulled=!1,t.add(u);let d=Ff(e);d.name=`hero-kernel`,t.add(d);let f=If(e);f.group.name=`mill`,t.add(f.group);let p=new Tn;p.name=`shared-worktop`;let m=Sf(p,e,5.5,3.7,9398089);Tf(p,e,e.crumbCount,1.9,m.topY+ff),p.rotation.y=-.018,t.add(p);let h=hf(m.topY,f.localBottomY),g=new Af(e);t.add(g.group);let _=Lf(e);_.group.name=`mixing-bowl`,t.add(_.group);let v=hf(m.topY,_.localBottomY),y=Gf(t,1.45,.92),b=Rf(e);t.add(b);let x=Z(12377312,e,void 0,{opacity:.65,roughness:.2,depthWrite:!1}),S=$(wf(),x,t);S.name=`water-stream`;let C=$(new Xi(.004,.007,.94,6),new ri({color:15138815,transparent:!0,opacity:.5,depthWrite:!1}),S,.018,0,0);C.castShadow=C.receiveShadow=!1;let w=new Tn,T=[];for(let t=0;t<15;t+=1){let n=$(new _o(t<10?.02:.035,0),Z(t<10?Jd.salt:Jd.yeast,e),w);T.push({mesh:n,x:(Q()-.5)*.65,z:(Q()-.5)*.45,delay:Q()*.45})}t.add(w);let E=new Tn;E.name=`forming-dough-clumps`;let D=Z(13871987,e,`dough`,{roughness:.82,bumpScale:.008}),ee=Array.from({length:e.mobile?5:8},(e,t)=>{let n=$(new _o(1,+(t%3==0)),D,E),r=Q()*Math.PI*2;return{clump:n,x:Math.cos(r)*(.16+Q()*.42),z:Math.sin(r)*(.1+Q()*.3),size:.055+Q()*.085,phase:Q()*Math.PI*2}});t.add(E);let O=new Df(t,e),k=Wf(e);k.group.visible=!1,O.mesh.add(k.group);let te=Gf(t,2.22,1.5),A=new Tn;A.name=`mixing-spoon`;let j=Z(12420935,e,`wood`,{roughness:.86});$(new So(1,24,16),j,A).scale.set(.16,.055,.24),vf(new W(0,.03,0),new W(.28,1.12,0),.037,j,A),t.add(A);let ne=zf(e),M=ne.group;M.name=`proofing-basket`,M.scale.set(1.14,1,.92),t.add(M);let N=hf(m.topY,ne.localBottomY),re=Gf(t,2.1,1.35),ie=new Tn;ie.name=`proofing-dust-motes`;let ae=e.mobile?12:22,oe=new Float32Array(ae*3),se=Array.from({length:ae},(e,t)=>({x:(Q()-.5)*3.2,y:.28+Q()*1.45,z:-.2+(Q()-.5)*1.8,phase:Q()*Math.PI*2+t})),ce=new Dr;ce.setAttribute(`position`,new pr(oe,3));let le=Yd(16769448,.025,0),P=new Vi(ce,le);P.frustumCulled=!1,ie.add(P),t.add(ie);let F=Bf(e);F.group.name=`oven`,t.add(F.group);let ue=new Tn;ue.name=`oven-peel`;let de=xf(2.65,1.95,.045,.25);$(de,Z(14925445,e,`wood`),ue),vf(new W(0,.005,.95),new W(0,.005,2.7),.055,Z(11502927,e,`wood`),ue),t.add(ue);let fe=F.floorSurfaceY-pf(de).max,pe=Vf(e);t.add(pe);let me=new Tn;me.name=`final-board`;let he=Sf(me,e,3.65,2.45,6502691);Tf(me,e,Math.max(18,Math.floor(e.crumbCount*.62)),1.48,he.topY+ff),me.rotation.y=.025,t.add(me);let ge=new Tn,_e=new Float32Array(72),ve=new Dr;ve.setAttribute(`position`,new pr(_e,3));let ye=Yd(15327698,.07,0),be=document.createElement(`canvas`);be.width=be.height=64;let xe=be.getContext(`2d`),Se=xe.createRadialGradient(32,32,0,32,32,32);Se.addColorStop(0,`rgba(255,255,255,0.6)`),Se.addColorStop(1,`rgba(255,255,255,0)`),xe.fillStyle=Se,xe.fillRect(0,0,64,64),ye.map=new Wi(be);let Ce=new Vi(ve,ye);Ce.frustumCulled=!1,ge.add(Ce),t.add(ge);let we={field:new Ef(n),kernel:new Ef(d),mill:new Ef(f.group),top:new Ef(p),bowl:new Ef(_.group,.02),water:new Ef(b),spoon:new Ef(A),additions:new Ef(w),clumps:new Ef(E),basket:new Ef(M),oven:new Ef(F.group),peel:new Ef(ue),final:new Ef(me),knife:new Ef(pe),cut:new Ef(k.group)},Te=new W(-.155,1.98,.26),Ee=new W(0,1.5,.65),De=new W,Oe=new W,ke=new W,Ae=new W,je=new W(0,v+_.doughSupportY,.18),Me=new W(0,m.topY+ff,.12),I=new W(0,N+ne.doughSupportY,.12),Ne=new W(0,F.floorSurfaceY+ff,-1.4),Pe=new W(0,he.topY+ff,.48),Fe=[{at:.968,value:new W(.78,1.78,.63)},{at:.982,value:new W(.78,1.26,.57)},{at:.989,value:new W(.78,.99,.51),tension:.58},{at:.997,value:new W(.84,.73,.49)},{at:1,value:new W(1.7,1.05,.49)}],L=[{at:.968,value:new W(.04,-.08,-.18)},{at:.989,value:new W(.04,-.08,-.1),tension:.5},{at:.997,value:new W(.04,-.02,-.08)},{at:1,value:new W(.04,.1,.18)}],Ie=new W,R=new W,Le=new W,z=new W(0,1,0);return{group:t,update({progress:e,time:t,quality:a}){let p=Nd(e),w=a.reducedMotion?0:t,E=a.reducedMotion?.35:1,j=X(p,.082,.17),ne=X(p,.225,.292,e=>e*e),ae=X(p,.25,.295,e=>e*e*(3-2*e)),P=X(p,.285,.295,e=>e*e),de=X(p,.182,.242),be=X(p,.138,.285);n.position.set(-be*.08,0,-be*2.3),we.field.set(1-X(p,.19,.298)),n.visible&&(i.update(w),r.rotation.z=Math.sin(w*.65)*.016*(1-j));let xe=1-X(p,.14,.255);if(u.visible=xe>.002,l.opacity=xe*.26,u.position.copy(n.position),s.forEach((e,t)=>{o[t*3]=e.x+Math.sin(w*.14+e.phase)*.12,o[t*3+1]=e.y+Math.sin(w*.2+e.phase*.7)*.06,o[t*3+2]=e.z+Math.cos(w*.11+e.phase)*.05}),c.attributes.position.needsUpdate=!0,we.kernel.set(1-X(p,.29,.299)),df.set(.055,1.98,0).applyEuler(r.rotation).add(r.position).add(n.position),Te.copy(df),d.position.lerpVectors(Te,Ee,j),d.scale.setScalar(.11+j*.64),d.rotation.set(.06*j,.08*j,-.43+j*1.12),f.group.position.set(.12+(1-de)*.34,h,-.4-(1-de)*2.55),we.mill.set(X(p,.178,.228)*(1-X(p,.423,.448))),De.set(f.group.position.x,f.group.position.y+1.21,f.group.position.z),ne>0){qd(Ee,De,ne,.65*E,d.position);let e=Et.lerp(.75,.115,ae);d.scale.setScalar(e*Et.lerp(1,.46,P)),d.rotation.z+=ne*1.6}let Se=X(p,.284,.405,e=>e*e*(2-e));f.rotor.rotation.y=Se*Math.PI*5.75+Math.sin(w*.35)*.014*Ld(Se),f.rotor.position.y=.62+Math.sin(Se*Math.PI*11.5)*Ld(Se)*.0045*E,f.shadow.position.y=m.topY-h+ff*.5,Oe.copy(f.outlet).add(f.group.position),ke.set(Oe.x+.018,m.topY+ff,Oe.z+.055),we.top.set(X(p,.205,.255)*(1-X(p,.8,.845)));let Ce=X(p,.626,.66),Re=X(p,.425,.452,e=>e*e*(3-2*e))*(1-X(p,.621,.629,e=>e**4));_.group.position.set(-Ce*.2,v,.18-Ce*1.25),we.bowl.set(Re),y.position.set(_.group.position.x-.025,m.topY+ff*.5,_.group.position.z-.035),y.material.opacity=Re*Re*.48,y.visible=y.material.opacity>.002,Ae.copy(_.group.position).add(df.set(0,.16,0)),g.update(p,w,Oe,ke,f.group.position,f.rotor.rotation.y);let ze=X(p,.434,.49),Be=X(p,.502,.575),Ve=X(p,.502,.542),He=ze*Re*(1-Ve);_.flourSurface.visible=He>.002,_.flourSurface.scale.setScalar(Math.sqrt(ze)*(1-Be*.08)),_.flourSurface.position.y=-.18+ze*.38-Be*.13,_.flourSurface.material.opacity=He,_.flourSurface.material.transparent=Ve>.001,_.flourSurface.material.depthWrite=Ve<.08;let Ue=X(p,.486,.524);b.position.set(_.group.position.x-1.12,1.54+Ld(Ue)*.06,.16),b.rotation.z=-.3-Ld(Ue)*.72,we.water.set(Rd(p,.477,.546,.016)),Le.set(.29,.27,0).applyEuler(b.rotation).add(b.position),S.position.copy(Le).add(Ae).multiplyScalar(.5),S.quaternion.setFromUnitVectors(z,df.copy(Le).sub(Ae).normalize()),S.scale.set(1,Le.distanceTo(Ae),1),S.visible=Ue>.01&&Ue<.99,x.opacity=Ld(Ue)*.58,C.position.x=.014+Math.sin(w*2.8+Ue*Math.PI*2)*.006,C.material.opacity=Ld(Ue)*.48;let We=X(p,.498,.535,e=>e*e);we.additions.set(Rd(p,.495,.542,.011)),T.forEach(e=>{let t=Nd((We-e.delay)/.55);e.mesh.position.set(Ae.x+e.x,Ae.y+.88*(1-t*t),Ae.z+e.z)});let Ge=X(p,.49,.518)*(1-X(p,.548,.575)),Ke=X(p,.505,.56);we.clumps.set(Ge),D.roughness=.88-X(p,.498,.535)*.18,ee.forEach((e,t)=>{let n=e.phase+Ke*(.8+t*.07);e.clump.position.set(Ae.x+Et.lerp(e.x,Math.cos(n)*.07,Ke),Ae.y+.025+Math.sin(n*1.7)*.035*(1-Ke),Ae.z+Et.lerp(e.z,Math.sin(n)*.045,Ke));let r=e.size*(1-Ke*.64);e.clump.scale.set(r*(1.08+t%2*.16),r*(.72+t%3*.08),r),e.clump.rotation.set(n*.23,n*.5,n*-.16)});let qe=X(p,.492,.568,e=>e*e*(2-e))*Math.PI*5,Je=X(p,.535,.575),Ye=X(p,.552,.615,Fd);A.position.set(Ae.x+Math.cos(qe)*(.48-Je*.15),.66+Be*.06,Ae.z+Math.sin(qe)*.32),A.rotation.set(-.2+Math.sin(qe)*.12,qe,-.34+Je*.15),A.position.y+=Ye*1.28,A.position.z-=Ye*.34,we.spoon.set(Rd(p,.488,.628,.018));let Xe=X(p,.498,.538);O.mesh.visible=Xe>.002,O.apply(p),O.mesh.material.opacity=Xe,O.mesh.material.depthWrite=O.mesh.material.opacity>.98;let B=X(p,.565,.625);qd(je,Me,B,.42,O.mesh.position);let V=X(p,.61,.69,e=>e);O.mesh.rotation.set(0,Math.sin(V*Math.PI*3)*Ld(V)*.06,0);let Ze=X(p,.65,.705),Qe=X(p,.688,.735),$e=X(p,.805,.848);M.position.set(.2*(1-Ze),N,.12-(1-Ze)*1.05-$e*.72);let et=X(p,.666,.7)*(1-X(p,.812,.846));we.basket.set(et),re.position.set(M.position.x-.02,m.topY+ff*.5,M.position.z-.025),re.material.opacity=et*.27,re.visible=re.material.opacity>.002,p>=.688&&qd(Me,I,Qe,.28,O.mesh.position);let tt=Rd(p,.69,.82,.022);ie.visible=tt>.002,le.opacity=tt*.22,se.forEach((e,t)=>{let n=a.reducedMotion?.35:w;oe[t*3]=e.x+Math.sin(n*.18+e.phase)*.08,oe[t*3+1]=e.y+Math.sin(n*.11+e.phase)*.09,oe[t*3+2]=e.z+Math.cos(n*.16+e.phase)*.05}),ce.attributes.position.needsUpdate=!0;let nt=X(p,.738,.812),rt=X(p,.95,.988);F.group.position.set(0,0,-1.4-3.2*(1-nt)-rt*.25),we.oven.set(X(p,.735,.792)*(1-X(p,.965,.993)));let it=X(p,.77,.808),at=X(p,.808,.858),H=X(p,.858,.9,Fd),ot=Et.lerp(1.2,.12,it);at>0&&(ot=Et.lerp(.12,Ne.z,at)),H>0&&(ot=Et.lerp(Ne.z,1.45,H)),ue.position.set(0,fe,ot),we.peel.set(X(p,.765,.8)*(1-X(p,.88,.91))),p>=.808&&qd(I,Ne,at,.22,O.mesh.position);let st=X(p,.732,.83)*(1-rt);F.glow.material.opacity=st*(.3+Math.sin(w*3.1)*.025),F.embers.forEach((e,t)=>{let n=.86+Math.sin(w*(1.7+t*.07)+e.userData.phase)*.13+Math.sin(w*3.3+t)*.05;e.material.emissiveIntensity=st*(.38+n*.44);let r=.92+st*n*.12;e.scale.set(r,r*.58,r*.84)});let ct=X(p,.925,.972);me.position.set(0,0,.48),we.final.set(X(p,.94,.97)),p>=.925&&qd(Ne,Pe,ct,.28*E,O.mesh.position),O.mesh.rotation.y+=ct*-.12;let lt=X(p,.989,.997),ut=X(p,.99,.997),dt=X(p,.994,1);Kd(p,Fe,Ie),Kd(p,L,R),pe.position.copy(Ie),pe.rotation.set(R.x,R.y,R.z),we.knife.set(Rd(p,.965,1,.007)),we.cut.set(ut),k.slice.position.set(.88+dt*.32,.43-dt*.035,dt*.045),k.slice.rotation.z=-dt*.1,k.crumbs.forEach(({crumb:e,delay:t,x:n,z:r,stretch:i,drift:a},o)=>{let s=Nd((lt-t)/.42);e.visible=s>.002;let c=X(s,0,.28);e.scale.set(c*i,c*(.72+o%2*.25),c),e.position.set(n+s*(.06+o*.006)+a*s,.62-s*(.55+o%3*.03),r+Math.sin(o*2.3)*s*.08),e.rotation.set(s*o,s*2.1,s*.7)});let ft=Math.max(Ld(B),Ld(Qe),Ld(at),Ld(ct)),pt=p<.808?.4:p<.925?.32:.5,mt=X(p,.61,.635)*pt*(1-ft*.9),ht=p<.808?m.topY+ff*.5:p<.925?F.floorSurfaceY+ff*.5:he.topY+ff*.5;te.position.set(O.mesh.position.x,ht,O.mesh.position.z),te.visible=mt>.002,te.material.opacity=mt,ge.position.copy(O.mesh.position);let gt=zd(p,.863,.93,.1)*.13;ge.visible=gt>.002&&!a.reducedMotion,ye.opacity=gt;for(let e=0;e<24;e+=1){let t=(w*.11+e/24)%1;_e[e*3]=Math.sin(e*2.4)*.65+Math.sin(w*.35+e)*t*.1,_e[e*3+1]=.92+t*.55,_e[e*3+2]=Math.cos(e*1.3)*.22}ve.attributes.position.needsUpdate=!0}}}var qf=[{id:`wheat`,label:`WHEAT`,start:0,end:.16},{id:`grain`,label:`GRAIN`,start:.12,end:.25},{id:`milling`,label:`MILLING`,start:.21,end:.36},{id:`flour`,label:`FLOUR`,start:.32,end:.47},{id:`mixing`,label:`MIXING`,start:.43,end:.6},{id:`dough`,label:`DOUGH`,start:.56,end:.72},{id:`proofing`,label:`PROOFING`,start:.68,end:.82},{id:`oven`,label:`OVEN`,start:.78,end:.94},{id:`bread`,label:`BREAD`,start:.9,end:1}],Jf=[{at:0,value:new W(-.82,1.1,5.25)},{at:.205,value:new W(.56,1.72,4.1),tension:.42},{at:.31,value:new W(-.1,1.46,4.42)},{at:.41,value:new W(.08,1.44,4.16),tension:.3},{at:.5,value:new W(.55,2.42,4.88)},{at:.62,value:new W(.04,1.86,4.36)},{at:.74,value:new W(.18,2,4.42),tension:.84},{at:.855,value:new W(-.46,1.5,4.05)},{at:.945,value:new W(.3,1.74,4.62)},{at:1,value:new W(.75,1.66,4.35)}],Yf=[{at:0,value:new W(-.2,1.48,-.02)},{at:.205,value:new W(0,1.54,.55),tension:.5},{at:.31,value:new W(0,.78,-.35)},{at:.41,value:new W(.16,.29,1.05),tension:.3},{at:.56,value:new W(0,.39,.16)},{at:.74,value:new W(0,.32,.14),tension:.85},{at:.855,value:new W(0,.68,-1.4)},{at:.93,value:new W(.01,.5,-.35)},{at:1,value:new W(.02,.42,.47)}],Xf=[{at:0,value:32},{at:.205,value:27,tension:.48},{at:.33,value:32.5},{at:.55,value:34},{at:.74,value:31.5,tension:.7},{at:.86,value:35.5},{at:1,value:31}],Zf=[{at:0,value:new K(Jd.night)},{at:.08,value:new K(1186577)},{at:.17,value:new K(2701090)},{at:.25,value:new K(3489835)},{at:.34,value:new K(4671291)},{at:.43,value:new K(6248777)},{at:.5,value:new K(7234386)},{at:.66,value:new K(7102024)},{at:.75,value:new K(5588275)},{at:.82,value:new K(2168079)},{at:.93,value:new K(1182472)},{at:1,value:new K(526600)}],Qf=[{at:0,value:new K(527370)},{at:.17,value:new K(1516568)},{at:.32,value:new K(3815727)},{at:.48,value:new K(8024676)},{at:.66,value:new K(6839113)},{at:.75,value:new K(7626823)},{at:.83,value:new K(1248008)},{at:1,value:new K(329221)}],$f=[{at:0,value:new K(528392)},{at:.17,value:new K(2570272)},{at:.32,value:new K(2434334)},{at:.48,value:new K(4405549)},{at:.66,value:new K(3418399)},{at:.75,value:new K(4009247)},{at:.83,value:new K(591108)},{at:1,value:new K(525572)}],ep=[{at:0,value:new K(10320434)},{at:.22,value:new K(13936722)},{at:.38,value:new K(12757625)},{at:.62,value:new K(15780238)},{at:.76,value:new K(14197853)},{at:.86,value:new K(11877654)},{at:1,value:new K(10701600)}],tp=[{at:0,value:.08},{at:.16,value:.17},{at:.34,value:.08},{at:.5,value:.085},{at:.68,value:.075},{at:.76,value:.07},{at:.86,value:.14},{at:1,value:.11}],np=[{at:0,value:new K(12043661)},{at:.16,value:new K(15911279)},{at:.3,value:new K(15190161)},{at:.5,value:new K(16769197)},{at:.74,value:new K(15845251)},{at:.82,value:new K(16171396)},{at:.865,value:new K(16746560)},{at:1,value:new K(16765602)}],rp=[{at:0,value:new W(-4.5,6.2,2.4)},{at:.18,value:new W(-2.8,5.4,3.2)},{at:.32,value:new W(3.4,5.6,3.6)},{at:.5,value:new W(-3.8,6.2,3.4)},{at:.74,value:new W(3.1,5.4,3)},{at:.84,value:new W(-2.3,3.4,1.2)},{at:1,value:new W(-3.4,4.8,3.2)}],ip=[{at:0,value:.035},{at:.2,value:.065},{at:.48,value:.11},{at:.68,value:.09},{at:.84,value:.025},{at:1,value:.032}],ap=[{at:0,value:.34},{at:.16,value:.48},{at:.34,value:.42},{at:.5,value:.64},{at:.68,value:.56},{at:.84,value:.2},{at:1,value:.27}],op=[{at:0,value:2},{at:.16,value:2.7},{at:.3,value:3},{at:.5,value:2.55},{at:.68,value:2.7},{at:.76,value:2.25},{at:.84,value:1.85},{at:1,value:2.95}],sp=[{at:0,value:.84},{at:.18,value:.92},{at:.5,value:.9},{at:.74,value:.86},{at:.84,value:.78},{at:1,value:.92}],cp=[{at:0,value:.052},{at:.14,value:.042},{at:.28,value:.027},{at:.37,value:.03},{at:.48,value:.021},{at:.74,value:.024},{at:.85,value:.04},{at:1,value:.03}];function lp(e,t,n){let r=Et.clamp(e,0,1);if(r<=t[0].at)return n.copy(t[0].value);for(let e=1;e<t.length;e+=1){let i=t[e-1],a=t[e];if(r<=a.at){let e=Et.clamp((r-i.at)/(a.at-i.at),0,1);return n.lerpColors(i.value,a.value,Id(e))}}return n.copy(t[t.length-1].value)}var up=class{scene=new Pn;camera=new fs(34,1,.1,100);renderer;root=new Tn;pointer={x:0,y:0,targetX:0,targetY:0};quality;container;onStateChange;previousTime=0;sequence;lookTarget=new W;desiredLook=new W;cameraTarget=new W;orbitOffset=new W;reducedCamera=new W(0,3,7.8);lightTarget=new W;backgroundColor=new K(Jd.night);backdropTopColor=new K(527370);backdropBottomColor=new K(528392);backdropGlowColor=new K(10320434);backdropMaterial;backdrop;keyLightColor=new K;fillLightColor=new K(12173981);groundLightColor=new K(1053457);fillLight;keyLight;ovenLight;breadLight;ambientLight;progress=0;visualProgress=0;visualVelocity=0;elapsed=0;animationFrame=0;composer=null;bloom=null;resizeObserver=null;disposed=!1;constructor(e,t,n){if(this.container=e,this.quality=t,this.onStateChange=n,this.scene.background=this.backgroundColor,this.scene.fog=new Nn(Jd.night,.028),this.backdropMaterial=new Po({uniforms:{uTop:{value:this.backdropTopColor},uBottom:{value:this.backdropBottomColor},uGlow:{value:this.backdropGlowColor},uGlowStrength:{value:.08},uResolution:{value:new U(1,1)}},vertexShader:`
        varying vec3 vLocal;
        void main() {
          vLocal = position;
          gl_Position = projectionMatrix * modelViewMatrix * vec4(position, 1.0);
      ...
      `,side:1,depthWrite:!1,depthTest:!1,fog:!1,toneMapped:!1}),this.backdrop=new hi(new So(36,32,18),this.backdropMaterial),this.backdrop.name=`journey-gradient-backdrop`,this.backdrop.renderOrder=-1e3,this.backdrop.frustumCulled=!1,this.scene.add(this.backdrop,this.root),this.renderer=new ed({antialias:!0,powerPreference:`high-performance`,alpha:!1}),this.renderer.setPixelRatio(t.dpr),this.renderer.setSize(e.clientWidth||window.innerWidth,e.clientHeight||window.innerHeight,!1),this.renderer.outputColorSpace=Le,this.renderer.toneMapping=4,this.renderer.toneMappingExposure=.92,this.renderer.shadowMap.enabled=t.shadows,this.renderer.shadowMap.type=1,this.renderer.domElement.setAttribute(`aria-hidden`,`true`),this.renderer.domElement.className=`journey-canvas`,this.container.appendChild(this.renderer.domElement),t.bloom){let e=new qt(1,1,{type:g,samples:t.tier===`high`?2:0});this.composer=new Dd(this.renderer,e),this.composer.addPass(new Od(this.scene,this.camera)),this.bloom=new Ad(new U(1,1),.06,.32,.86),this.composer.addPass(this.bloom),this.composer.addPass(new Md)}this.ambientLight=new vs(16774630,.035),this.fillLight=new es(this.fillLightColor,this.groundLightColor,.34),this.keyLight=new _s(16766349,2.25),this.keyLight.castShadow=t.shadows,this.keyLight.shadow.mapSize.set(t.shadowMapSize,t.shadowMapSize),this.keyLight.shadow.camera.near=.1,this.keyLight.shadow.camera.far=30,this.keyLight.shadow.camera.left=-6,this.keyLight.shadow.camera.right=6,this.keyLight.shadow.camera.top=6,this.keyLight.shadow.camera.bottom=-6,this.keyLight.shadow.normalBias=.025,this.keyLight.shadow.bias=-2e-4,this.keyLight.shadow.radius=2,this.keyLight.shadow.blurSamples=8,this.ovenLight=new ms(Jd.ember,0,6,2),this.ovenLight.position.set(-.55,.46,-1.1),this.breadLight=new ms(16765088,0,5.5,2),this.breadLight.position.set(2.5,2.15,1.45),this.keyLight.target.position.set(0,.35,0),this.scene.add(this.ambientLight,this.fillLight,this.keyLight,this.keyLight.target,this.ovenLight,this.breadLight),this.sequence=Kf(t),this.root.add(this.sequence.group),this.setupEvents(),this.resize(),this.camera.position.copy(Jf[0].value),this.lookTarget.copy(Yf[0].value),this.setProgress(0),this.animationFrame=requestAnimationFrame(this.render)}getState(){let e=[...qf].reverse().find(e=>this.progress>=e.start)??qf[0];return{progress:this.progress,stageIndex:qf.indexOf(e)+1,stageLabel:e.label,remainingSeconds:Math.round(120*(1-this.progress))}}getMotionState(){return{targetProgress:this.progress,visualProgress:this.visualProgress,visualVelocity:this.visualVelocity}}setProgress(e){this.progress=Et.clamp(e,0,1);let t=this.getState();return this.onStateChange?.(t),t}resize=()=>{let e=this.container.clientWidth||window.innerWidth,t=this.container.clientHeight||window.innerHeight;this.camera.aspect=e/Math.max(t,1),this.camera.updateProjectionMatrix(),this.renderer.setPixelRatio(this.quality.dpr),this.renderer.setSize(e,t,!1),this.composer?.setSize(e,t);let n=this.renderer.getPixelRatio();this.backdropMaterial.uniforms.uResolution.value.set(e*n,t*n)};destroy(){this.disposed=!0,cancelAnimationFrame(this.animationFrame),this.resizeObserver?.disconnect(),window.removeEventListener(`pointermove`,this.handlePointer),window.removeEventListener(`resize`,this.resize),this.renderer.dispose(),this.composer?.dispose(),this.backdrop.geometry.dispose(),this.backdropMaterial.dispose(),this.root.traverse(e=>{let t=e;t.geometry&&t.geometry.dispose(),(Array.isArray(t.material)?t.material:t.material?[t.material]:[]).forEach(e=>e.dispose())}),this.container.replaceChildren()}handlePointer=e=>{this.pointer.targetX=(e.clientX/Math.max(window.innerWidth,1)-.5)*2,this.pointer.targetY=(e.clientY/Math.max(window.innerHeight,1)-.5)*2};render=e=>{if(this.disposed)return;let t=this.previousTime?Math.min((e-this.previousTime)/1e3,.05):1/60;this.previousTime=e,this.elapsed+=t;let n=this.quality.reducedMotion?16:8;this.pointer.x=Bd(this.pointer.x,this.pointer.targetX,n,t),this.pointer.y=Bd(this.pointer.y,this.pointer.targetY,n,t);let r=Math.abs(this.progress-this.visualProgress);if(this.quality.reducedMotion)this.visualProgress=this.progress,this.visualVelocity=0;else{let e=this.quality.mobile?.068:this.quality.tier===`high`?.09:.088,n=this.quality.mobile?.046:this.quality.tier===`high`?.058:.054,i=Et.smoothstep(r,.015,.2),a=Vd(this.visualProgress,this.progress,this.visualVelocity,Et.lerp(e,n,i),t);this.visualProgress=Et.clamp(a.value,0,1),this.visualVelocity=a.velocity,r<1e-5&&Math.abs(this.visualVelocity)<1e-4&&(this.visualProgress=this.progress,this.visualVelocity=0)}let i={progress:this.visualProgress,time:this.elapsed,delta:t,pointer:this.pointer,quality:this.quality};this.sequence.update(i),this.updateCamera(i),this.updateLighting(i),this.composer?this.composer.render():this.renderer.render(this.scene,this.camera),this.animationFrame=requestAnimationFrame(this.render)};setupEvents(){window.addEventListener(`pointermove`,this.handlePointer,{passive:!0}),window.addEventListener(`resize`,this.resize,{passive:!0}),`ResizeObserver`in window&&(this.resizeObserver=new ResizeObserver(()=>this.resize()),this.resizeObserver.observe(this.container))}updateCamera(e){let t=+!e.quality.reducedMotion;Kd(e.progress,Jf,this.cameraTarget),Kd(e.progress,Yf,this.desiredLook);let n=e.quality.reducedMotion?0:X(e.progress,.955,1);if(n>0){let e=Math.PI/18*n;this.orbitOffset.copy(this.cameraTarget).sub(this.desiredLook);let t=Math.cos(e),r=Math.sin(e),i=this.orbitOffset.x,a=this.orbitOffset.z;this.orbitOffset.x=i*t+a*r,this.orbitOffset.z=-i*r+a*t,this.orbitOffset.multiplyScalar(1-n*.05),this.cameraTarget.copy(this.desiredLook).add(this.orbitOffset)}if(e.quality.reducedMotion){let t=.8*(1-X(e.progress,.965,.998));this.cameraTarget.lerp(this.reducedCamera,t)}let r=Math.max(1,1.22/this.camera.aspect);this.cameraTarget.sub(this.desiredLook).multiplyScalar(r).add(this.desiredLook),this.cameraTarget.x+=e.pointer.x*.12*t,this.cameraTarget.y+=e.pointer.y*-.06*t,this.camera.position.copy(this.cameraTarget),this.desiredLook.x+=e.pointer.x*.045*t,this.desiredLook.y+=e.pointer.y*-.03*t,this.lookTarget.copy(this.desiredLook),this.camera.lookAt(this.lookTarget);let i=Gd(e.progress,Xf);Math.abs(this.camera.fov-i)>.001&&(this.camera.fov=i,this.camera.updateProjectionMatrix())}updateLighting(e){let t=e.progress;lp(t,Zf,this.backgroundColor),this.scene.background=this.backgroundColor,this.scene.fog instanceof Nn&&this.scene.fog.color.copy(this.backgroundColor),lp(t,Qf,this.backdropTopColor),lp(t,$f,this.backdropBottomColor),lp(t,ep,this.backdropGlowColor),this.backdropMaterial.uniforms.uGlowStrength.value=Gd(t,tp),lp(t,np,this.keyLightColor),this.keyLight.color.copy(this.keyLightColor),Kd(t,rp,this.lightTarget);let n=X(t,.68,.71)*(1-X(t,.775,.81));e.quality.reducedMotion||(this.lightTarget.x+=Math.sin(this.elapsed*.12)*n*.42,this.lightTarget.z+=Math.cos(this.elapsed*.09)*n*.22),this.keyLight.position.copy(this.lightTarget),this.keyLight.target.position.set(0,.32+X(t,.72,.86)*.35,-X(t,.72,.86)*1.2+X(t,.9,1)*1.65);let r=X(t,.735,.829)*(1-X(t,.925,.98)),i=X(t,.813,.86),a=X(t,.89,1);this.ambientLight.intensity=Gd(t,ip),this.fillLight.intensity=Gd(t,ap),this.keyLight.intensity=Gd(t,op),this.ovenLight.intensity=r*(.82+i*1.78),this.breadLight.intensity=a*1.75,this.renderer.toneMappingExposure=Gd(t,sp),this.scene.fog instanceof Nn&&(this.scene.fog.density=Gd(t,cp)),this.bloom&&(this.bloom.strength=.045+r*.12+a*.035,this.bloom.radius=.28+r*.12,this.bloom.threshold=.84)}},dp=document.querySelector(`#experience`),fp=document.querySelector(`#scroll-rail`),pp=document.querySelector(`#loader`),mp=document.querySelector(`#fallback`),hp=document.querySelector(`#stage-number`),gp=document.querySelector(`#stage-label`),_p=document.querySelector(`#timer`),vp=document.querySelector(`#intro-copy`),yp=document.querySelector(`#scene-copy`),bp=document.querySelector(`#finish-copy`),xp=document.querySelector(`#sound-toggle`),Sp=document.querySelector(`#sound-label`),Cp=document.querySelector(`#replay`);if(!dp||!fp||!pp||!mp||!hp||!gp||!_p||!vp||!yp||!bp||!xp||!Sp||!Cp)throw Error(`Journey to Bread could not find its interface shell.`);var wp=new td,Tp=null,Ep=null,Dp=1,Op=null;function kp(e){let t=Math.max(0,Math.round(e));return`${String(Math.floor(t/60)).padStart(2,`0`)}:${String(t%60).padStart(2,`0`)}`}function Ap(e){let t=[`WHEAT`,`ONE GRAIN.`,`BREAKING IT DOWN.`,`FLOUR.`,`FLOUR. WATER. SALT. TIME.`,`MAKE IT SOFT.`,`WAIT.`,`HEAT.`,``];hp.textContent=`${String(e.stageIndex).padStart(2,`0`)} / 09`,gp.textContent=e.stageLabel,e.stageIndex!==Dp&&!window.matchMedia(`(prefers-reduced-motion: reduce)`).matches&&(Op?.cancel(),Op=document.querySelector(`.hud__stage`)?.animate([{opacity:.34,transform:`translateY(-3px)`},{opacity:.72,transform:`translateY(0)`}],{duration:220,easing:`cubic-bezier(.2,.75,.25,1)`})??null),Dp=e.stageIndex,_p.textContent=kp(e.remainingSeconds),_p.setAttribute(`aria-label`,`${kp(e.remainingSeconds)} remaining in the journey`),vp.style.opacity=String(Math.max(0,1-e.progress*14)),yp.textContent=t[e.stageIndex-1]??``,yp.classList.toggle(`is-visible`,e.progress>.17&&e.progress<.93),e.progress<=.996&&bp.contains(document.activeElement)&&xp.focus({preventScroll:!0}),bp.inert=e.progress<=.996,bp.classList.toggle(`is-visible`,e.progress>.996),bp.setAttribute(`aria-hidden`,String(e.progress<=.996)),document.documentElement.classList.toggle(`hud-on-light`,e.progress>=.335&&e.progress<=.79),document.documentElement.style.setProperty(`--journey-progress`,String(e.progress)),wp.setProgress(e.progress)}function jp(e){let t=document.modelContext;if(!t?.registerTool)return;let n=new AbortController;Promise.resolve(t.registerTool({name:`set_journey_progress`,title:`Set journey progress`,description:`Move Journey to Bread to a specific scroll progress between 0 and 1 and return the visible stage and countdown.`,inputSchema:{type:`object`,properties:{progress:{type:`number`,minimum:0,maximum:1}},required:[`progress`],additionalProperties:!1},annotations:{readOnlyHint:!1,untrustedContentHint:!1},execute(t){let n=t?.progress;if(typeof n!=`number`||!Number.isFinite(n)||n<0||n>1)throw Error(`progress must be a finite number between 0 and 1`);return e.scrollToProgress(n)}},{signal:n.signal})).catch(()=>void 0),window.addEventListener(`beforeunload`,()=>n.abort(),{once:!0})}try{let e=vd();Tp=new up(dp,e,Ap),Ep=new _d(Tp),jp(Ep),xp.addEventListener(`click`,async()=>{let e=await wp.toggle();xp.setAttribute(`aria-pressed`,String(e)),xp.setAttribute(`aria-label`,e?`Turn sound off`:`Turn sound on`),Sp.textContent=e?`Sound on`:`Sound off`,xp.classList.toggle(`is-on`,e)}),Cp.addEventListener(`click`,()=>Ep?.replay());let t=new URLSearchParams(window.location.search).get(`progress`),n=Number(t);t!==null&&Number.isFinite(n)&&n>=0&&n<=1&&window.setTimeout(()=>Ep?.scrollToProgress(n),120),window.setTimeout(()=>pp.classList.add(`is-hidden`),e.reducedMotion?100:360)}catch(e){console.error(e),dp.hidden=!0,fp.hidden=!0,pp.hidden=!0,mp.hidden=!1,document.body.classList.add(`webgl-fallback`)}window.addEventListener(`beforeunload`,()=>{Ep?.destroy(),Tp?.destroy(),wp.disable(),delete window.__journeyDebug},{once:!0});