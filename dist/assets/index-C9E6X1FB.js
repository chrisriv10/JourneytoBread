...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function dc(e,t,n){let r=new Float32Array(Zs),i=new G(0,1,0);return new No({name:`SphericalGaussianBlur`,defines:{n:Zs,CUBEUV_TEXEL_WIDTH:1/t,CUBEUV_TEXEL_HEIGHT:1/n,CUBEUV_MAX_MIP:`${e}.0`},uniforms:{envMap:{value:null},samples:{value:1},weights:{value:r},latitudinal:{value:!1},dTheta:{value:0},mipInt:{value:0},poleAxis:{value:i}},vertexShader:mc(),fragmentShader:`
	...
	`}var hc=class extends Kt{constructor(e=1,t={}){super(e,e,t),this.isWebGLCubeRenderTarget=!0;let n={width:e,height:e,depth:1},r=[n,n,n,n,n,n];this.texture=new Ui(r),this._setTextureOptions(t),this.texture.isRenderTargetTexture=!0}fromEquirectangularTexture(e,t){this.texture.type=t.type,this.texture.colorSpace=t.colorSpace,this.texture.generateMipmaps=t.generateMipmaps,this.texture.minFilter=t.minFilter,this.texture.magFilter=t.magFilter;let n={uniforms:{tEquirect:{value:null}},vertexShader:`
	...
	if ( coord.x >= 1.0 ) {
		...
		void main() {
			...
			gl_FragColor = mix( outputColor, texel, alpha );
				...
				}`})}};kd.BlurDirectionX=new W(1,0),kd.BlurDirectionY=new W(0,1);var Ad={name:`OutputShader`,uniforms:{tDiffuse:{value:null},toneMappingExposure:{value:1}},vertexShader:`
		precision highp float;
		...
		}`},jd=class extends yd{constructor(){super(),this.isOutputPass=!0,this.uniforms=Ao.clone(Ad.uniforms),this.material=new Po({name:Ad.name,uniforms:this.uniforms,vertexShader:Ad.vertexShader,fragmentShader:Ad.fragmentShader}),this._fsQuad=new Sd(this.material),this._outputColorSpace=null,this._toneMapping=null}render(e,t,n){this.uniforms.tDiffuse.value=n.texture,this.uniforms.toneMappingExposure.value=e.toneMappingExposure,(this._outputColorSpace!==e.outputColorSpace||this._toneMapping!==e.toneMapping)&&(this._outputColorSpace=e.outputColorSpace,this._toneMapping=e.toneMapping,this.material.defines={},Nt.getTransfer(this._outputColorSpace)===`srgb`&&(this.material.defines.SRGB_TRANSFER=``),this._toneMapping===1?this.material.defines.LINEAR_TONE_MAPPING=``:this._toneMapping===2?this.material.defines.REINHARD_TONE_MAPPING=``:this._toneMapping===3?this.material.defines.CINEON_TONE_MAPPING=``:this._toneMapping===4?this.material.defines.ACES_FILMIC_TONE_MAPPING=``:this._toneMapping===6?this.material.defines.AGX_TONE_MAPPING=``:this._toneMapping===7?this.material.defines.NEUTRAL_TONE_MAPPING=``:this._toneMapping===5&&(this.material.defines.CUSTOM_TONE_MAPPING=``),this.material.needsUpdate=!0),this.renderToScreen===!0?(e.setRenderTarget(null),this._fsQuad.render(e)):(e.setRenderTarget(t),this.clear&&e.clear(e.autoClearColor,e.autoClearDepth,e.autoClearStencil),this._fsQuad.render(e))}dispose(){this.material.dispose(),this._fsQuad.dispose()}};function Md(e){return Tt.clamp(e,0,1)}function Nd(e){let t=Md(e);return t*t*t*(t*(t*6-15)+10)}function Pd(e){return 1-(1-Md(e))**3}function Fd(e){let t=Md(e);return t*t*(3-2*t)}function Id(e,t=.5,n=.5){let r=Math.abs(e-t)/Math.max(n,1e-4);return Math.max(0,1-r*r)**2}function X(e,t,n,r=Nd){return r(Tt.clamp((e-t)/Math.max(n-t,1e-4),0,1))}function Ld(e,t,n,r=.12){let i=X(e,t,t+r),a=1-X(e,n-r,n);return Tt.clamp(Math.min(i,a),0,1)}function Rd(e,t,n,r=.1){return X(e,t+r*(n-t),n)}function zd(e,t,n,r){return Tt.lerp(e,t,1-Math.exp(-n*Math.max(r,0)))}function Bd(e,t,n){let r=e[t],i=Tt.clamp(r.tension??0,0,1);if(t===0){let t=e[1];return(n(t.value)-n(r.value))/Math.max(t.at-r.at,1e-4)*(1-i)}if(t===e.length-1){let a=e[t-1];return(n(r.value)-n(a.value))/Math.max(r.at-a.at,1e-4)*(1-i)}let a=e[t-1],o=e[t+1];return(n(o.value)-n(a.value))/Math.max(o.at-a.at,1e-4)*(1-i)}function Vd(e,t,n,r,i,a){let o=a*a,s=o*a,c=2*s-3*o+1,l=s-2*o+a,u=-2*s+3*o,d=s-o;return c*e+l*i*n+u*t+d*i*r}function Hd(e,t){let n=Md(e);if(n<=t[0].at)return t[0].value;for(let e=1;e<t.length;e+=1){let r=t[e-1],i=t[e];if(n<=i.at){let a=Math.max(i.at-r.at,1e-4),o=Tt.clamp((n-r.at)/a,0,1);return Vd(r.value,i.value,Bd(t,e-1,e=>e),Bd(t,e,e=>e),a,o)}}return t[t.length-1].value}function Ud(e,t,n){let r=Md(e);if(r<=t[0].at)return n.copy(t[0].value);for(let e=1;e<t.length;e+=1){let i=t[e-1],a=t[e];if(r<=a.at){let o=Math.max(a.at-i.at,1e-4),s=Tt.clamp((r-i.at)/o,0,1),c=Bd(t,e-1,e=>e.x),l=Bd(t,e-1,e=>e.y),u=Bd(t,e-1,e=>e.z),d=Bd(t,e,e=>e.x),f=Bd(t,e,e=>e.y),p=Bd(t,e,e=>e.z);return n.set(Vd(i.value.x,a.value.x,c,d,o,s),Vd(i.value.y,a.value.y,l,f,o,s),Vd(i.value.z,a.value.z,u,p,o,s))}}return n.copy(t[t.length-1].value)}function Wd(e,t,n,r,i=new G){let a=Md(n);return i.lerpVectors(e,t,a),i.y+=Math.sin(a*Math.PI)*r,i}var Gd={night:658700,moss:2505255,mossLight:6255937,wheat:14067789,wheatLight:16043890,stone:5986896,stoneLight:9275765,flour:15853520,salt:16314586,yeast:12814431,dough:13208140,doughLight:15775850,oven:2430226,ember:16740146,crust:10111776,bread:13137196,crumb:15976065,table:4403494,ink:1119762};function Kd(e,t,n=.8){return new Ii({color:e,size:t,sizeAttenuation:!0,transparent:!0,opacity:n,depthWrite:!1})}var qd=new G,Jd=new G;function Yd(e){let t=e;return()=>(t=t*16807%2147483647,(t-1)/2147483646)}var Z=Yd(4937),Xd=new Map;function Zd(t,n){let r=Xd.get(t);if(r)return r;let i=document.createElement(`canvas`);i.width=i.height=512;let a=i.getContext(`2d`),o=Yd(t.length*431);a.fillStyle={wood:`#e1d1b8`,stone:`#d8d5ca`,flour:`#fffaf0`,crust:`#e7c690`,crumb:`#f8e2b4`}[t],a.fillRect(0,0,512,512);let s=a.createLinearGradient(0,0,t===`wood`?512:340,512);s.addColorStop(0,t===`flour`?`rgba(255,250,236,0.045)`:t===`crumb`?`rgba(255,246,216,0.11)`:`rgba(255,248,224,0.12)`),s.addColorStop(.45,t===`flour`?`rgba(91,72,45,0.012)`:t===`crumb`?`rgba(155,92,43,0.025)`:`rgba(70,39,18,0.025)`),s.addColorStop(1,t===`flour`?`rgba(54,42,25,0.028)`:t===`crumb`?`rgba(99,50,22,0.07)`:`rgba(21,15,10,0.09)`),a.fillStyle=s,a.fillRect(0,0,512,512);for(let e=0;e<(t===`flour`?4300:t===`crumb`?2400:5900);e+=1){let e=o()*512,n=o()*512,r=t===`flour`?o()*.04:t===`crumb`?.012+o()*.052:.02+o()*.075;a.fillStyle=o()>.5?`rgba(255,247,226,${r})`:t===`crumb`?`rgba(121,69,31,${r*.72})`:`rgba(38,22,10,${r*.8})`;let i=t===`wood`?14+o()*64:t===`crust`?1+o()*4:1+o()*2;a.fillRect(e,n,i,t===`wood`?.65:.8+o()*1.6)}if(t===`wood`){for(let e=0;e<34;e+=1){let e=o()*512;a.strokeStyle=`rgba(66,34,17,${.045+o()*.085})`,a.lineWidth=.7+o()*1.6,a.beginPath(),a.moveTo(-20,e),a.bezierCurveTo(150,e-11,350,e+13,532,e+o()*10),a.stroke()}for(let e=0;e<2;e+=1){let e=100+o()*320,t=80+o()*350;a.strokeStyle=`rgba(73,38,18,0.11)`,a.lineWidth=2,a.beginPath(),a.ellipse(e,t,25+o()*18,7+o()*5,0,0,Math.PI*2),a.stroke()}}else if(t===`stone`)for(let e=0;e<22;e+=1){let e=o()*512;a.strokeStyle=`rgba(61,56,48,${.025+o()*.055})`,a.lineWidth=2+o()*5,a.beginPath(),a.moveTo(-30,e),a.bezierCurveTo(120,e+35,330,e-28,542,e+12),a.stroke()}else if(t===`crumb`)for(let e=0;e<150;e+=1){let e=o()*512,t=o()*512,n=.8+o()**2.2*4.2;a.fillStyle=`rgba(113,61,28,${.045+o()*.11})`,a.beginPath(),a.ellipse(e,t,n,n*(.55+o()*.5),o()*Math.PI,0,Math.PI*2),a.fill()}let c=new Wi(i);return c.colorSpace=Ie,c.wrapS=c.wrapT=e,c.repeat.set(t===`wood`?1:1.25,t===`wood`?1:1.25),c.anisotropy=n,Xd.set(t,c),c}function Q(e,t,n,r={}){return new Fo({color:e,roughness:.84,metalness:.01,transparent:!0,...n?{map:Zd(n,t.anisotropy),bumpMap:Zd(n,t.anisotropy),bumpScale:n===`stone`?.034:n===`crust`?.022:n===`wood`?.014:n===`crumb`?.012:.006}:{},...r})}function $(e,t,n,r=0,i=0,a=0){let o=new hi(e,t);return o.position.set(r,i,a),o.castShadow=!0,o.receiveShadow=!0,n?.add(o),o}function Qd(e,t,n,r,i){let a=$(new Xi(n,n,e.distanceTo(t),8),r,i);return a.position.copy(e).add(t).multiplyScalar(.5),a.quaternion.setFromUnitVectors(new G(0,1,0),t.clone().sub(e).normalize()),a}function $d(e,t,n,r){return $(new wo(new ca(e),28,t,8,!1),n,r)}function ef(e,t,n,r,i){let a=$(new Co(e,t,8,64),n,r,0,i,0);return a.rotation.x=Math.PI/2,a}function tf(e,t,n,r=.14){let i=new ka,a=-e/2,o=-t/2,s=r;i.moveTo(a+s,o),i.lineTo(a+e-s,o),i.quadraticCurveTo(a+e,o,a+e,o+s),i.lineTo(a+e,o+t-s),i.quadraticCurveTo(a+e,o+t,a+e-s,o+t),i.lineTo(a+s,o+t),i.quadraticCurveTo(a,o+t,a,o+t-s),i.lineTo(a,o+s),i.quadraticCurveTo(a,o,a+s,o);let c=new mo(i,{depth:n,bevelEnabled:!0,bevelSegments:3,bevelSize:.025,bevelThickness:.025,curveSegments:10});return c.rotateX(-Math.PI/2),c}function nf(e,t,n=3.9,r=2.7,i=12618325){let a=$(tf(n,r,.13),Q(i,t,void 0,{roughness:.84}),e,0,-.16,0);a.name=`wood-work-surface`;let o=Yd(Math.round(n*r*977)),s=Q(new q(i).multiplyScalar(.48),t,void 0,{roughness:.96,transparent:!0,opacity:.24,depthWrite:!1});for(let t=0;t<13;t+=1){let t=(o()-.5)*r*.76,i=(o()-.5)*.045,a=$d([new G(-n*.44,-.019,t),new G(-n*.08,-.018,t+i),new G(n*.2,-.019,t-i*.45),new G(n*.44,-.019,t+i*.3)],.0022+o()*.0014,s,e);a.castShadow=a.receiveShadow=!1}return a}function rf(e,t,n,r,i){let a=new Xi(e,t,n,r,3),o=a.attributes.position,s=Yd(i),c=Array.from({length:r},()=>(s()-.5)*.045);for(let e=0;e<o.count;e+=1){let t=o.getX(e),n=o.getZ(e),a=Math.atan2(n,t),s=1+c[(Math.round((a+Math.PI)/(Math.PI*2)*r)%r+r)%r]+Math.sin(a*5+i)*.008;o.setX(e,t*s),o.setZ(e,n*s)}return o.needsUpdate=!0,a.computeVertexNormals(),a}function af(e,t,n,r=1.3,i=.006){let a=new Yi(.013,6);a.rotateX(-Math.PI/2);let o=new Di(a,Q(15787987,t,`flour`,{roughness:1}),n),s=new Cn;for(let e=0;e<n;e+=1){let t=Z()*Math.PI*2,n=Math.sqrt(Z())*r;s.position.set(Math.cos(t)*n,i,Math.sin(t)*n*.66),s.scale.setScalar(.25+Z()*1.05),s.updateMatrix(),o.setMatrixAt(e,s.matrix)}return o.castShadow=!1,e.add(o),o}var of=class{object;materials;last=-1;constructor(e){this.object=e,this.materials=[],e.traverse(e=>{let t=e;(Array.isArray(t.material)?t.material:t.material?[t.material]:[]).forEach(e=>{this.materials.some(t=>t.material===e)||this.materials.push({material:e,opacity:e.opacity,depthWrite:e.depthWrite})})})}set(e){let t=Tt.clamp(e,0,1);t!==this.last&&(this.last=t,this.object.visible=t>.002,this.materials.forEach(e=>{e.material.transparent=!0,e.material.opacity=t*e.opacity,e.material.depthWrite=e.depthWrite&&t>.96}))}},sf=class{mesh;original;position;colors;lastProgress=-1;color=new q;pale=new q(Gd.flour);wet=new q(14200434);crust=new q(12149282);toasted=new q(6104079);cut=new q(15779975);raised=new q(15906909);constructor(e,t){let n=new So(1,t.mobile?96:144,t.mobile?48:72);this.position=n.attributes.position,this.original=new Float32Array(this.position.array),this.colors=new fr(new Float32Array(this.position.count*3),3),n.setAttribute(`color`,this.colors),this.mesh=$(n,Q(16777215,t,`flour`,{vertexColors:!0,roughness:.96}),e),this.mesh.name=`hero-dough-loaf`,this.mesh.frustumCulled=!1}apply(e){if(e===this.lastProgress)return;this.lastProgress=e;let t=X(e,.502,.575),n=X(e,.598,.692),r=X(e,.705,.778),i=X(e,.834,.885),a=X(e,.842,.925),o=X(e,.776,.803),s=X(e,.61,.69,e=>e),c=Math.sin(s*Math.PI*3)**2*Id(s),l=X(e,.989,.997)*.9,u=.8+t*.12+n*.18+r*.18+i*.12,d=.08+t*.57+r*.2+i*.11,f=.69+t*.05+r*.07,p=X(e,.492,.565,e=>e)*Math.PI*5;for(let e=0;e<this.position.count;e+=1){let m=this.original[e*3],h=this.original[e*3+1],g=this.original[e*3+2],_=Math.max(0,h),v=Md((h+.12)/1.12),y=Math.max(0,(h+.64)/1.64),b=Math.exp(-(((m-Math.sin(s*Math.PI*3)*.4)/.42)**2))*c,x=Math.sin(m*7.5+g*5.5-p)*_*t*(1-t)*.17,S=Math.sin(m*6.5+s*8)*b*_*.075,C=m+g*.32-Tt.lerp(-.3,.26,s),w=(Math.exp(-(((C+.16)/.22)**2))*.09-Math.exp(-((C/.105)**2))*.055)*_*Id(s),T=Math.sin(m*4.3+g*7.1)*t*(1-t)*.055,E=1-(r*.035+i*.12)*Math.abs(m)**1.55,D=1+r*(.052*Math.sin(m*2.2+g*2.7)+m*.028-g*.018),ee=r*_*(.024*Math.sin(m*3.1-g*2.4)+.018*m),O=y*d*D*E-b*_*.2+x+S+w+ee,k=m*u*(1+c*.17)+T*(.4+_)+n*Math.sin(g*3.2+h)*.018,A=g*f*E*(1-c*.09)+T*.42;k>.72&&(k=Tt.lerp(k,.72,l));let j=k+A*.42,M=0,N=0,P=0;for(let e of[-.59,0,.59]){let t=.014+i*.035,n=Math.abs(j-e);M=Math.max(M,Math.exp(-((n/t)**2))),N=Math.max(N,Math.exp(-((n/(t*.38))**2))),P=Math.max(P,Math.exp(-(((n-t*1.05)/(t*.48))**2)))}let F=X(h,.28,.66)*(1-X(Math.abs(g),.57,.88));M*=F*o,N*=F*o,P*=F*o,O-=M*(.022+i*.055);let te=Math.sin(k*21+A*13)*Math.sin(A*31-k*9);O+=_*a*te*.009,this.position.setXYZ(e,k,Math.max(0,O),A),this.color.copy(this.pale).lerp(this.wet,t*(.72-n*.25));let ne=Md(.57+v*.3+m*.065-g*.11+te*.12);this.color.lerp(this.crust,a*ne);let re=Math.max(0,Math.sin(k*8.5-A*5.2)*Math.cos(A*10.5+k*2.7));this.color.lerp(this.toasted,a*((1-v)*.68+Math.max(0,g)*.11+N*.34+re*v*.08)),this.color.lerp(this.cut,M*a*.8),this.color.lerp(this.raised,P*a*.72);let ie=Math.max(0,Math.sin(k*12+A*7)*Math.sin(A*18-k*3.5)-.34);this.color.lerp(this.pale,ie*v*a*(1-M)*.32),this.colors.setXYZ(e,this.color.r,this.color.g,this.color.b)}this.mesh.material.roughness=.95-t*.22+n*.14+r*.04+a*.06,this.mesh.material.bumpScale=.006+a*.025,this.position.needsUpdate=this.colors.needsUpdate=!0,this.mesh.geometry.computeVertexNormals()}},cf=class{group=new wn;pile;pileShadow;points;particles=[];positions;alphas;haze=[];source=new G;destination=new G;constructor(e){this.group.name=`milling-output`;let t=e.flourCount,n=new Dr;this.positions=new fr(new Float32Array(t*3),3),this.alphas=new fr(new Float32Array(t),1);let r=new Float32Array(t),i=Array.from({length:14},()=>{let e=Z()*Math.PI*2,t=Math.sqrt(Z());return{x:Math.cos(e)*t*.68,z:Math.sin(e)*t*.46}});for(let e=0;e<t;e+=1){let t=i[Math.floor(Z()*i.length)],n=Z()**2.2,a=Z()*Math.PI*2,o=Z()**1.8;this.particles.push({x:t.x+Math.cos(a)*n*.26,y:(.15+Z()*.85)*(1-Math.min(.9,Math.hypot(t.x,t.z)))*.48,z:t.z+Math.sin(a)*n*.2,delay:Z(),phase:Z()*Math.PI*2,weight:o,near:Z()}),r[e]=.28+o*1.85}n.setAttribute(`position`,this.positions),n.setAttribute(`alpha`,this.alphas),n.setAttribute(`size`,new fr(r,1));let a=new No({transparent:!0,depthWrite:!1,uniforms:{tint:{value:new q(15853264)},pixelRatio:{value:e.dpr}},vertexShader:`attribute float alpha; attribute float size; varying float vAlpha;
        ...
        void main(){ float r=length(gl_PointCoord-0.5)*2.0;
          ...
          #include <tonemapping_fragment>
          #include <colorspace_fragment>
        }`});this.points=new Vi(n,a),this.points.frustumCulled=!1,this.group.add(this.points);let o=document.createElement(`canvas`);o.width=o.height=96;let s=o.getContext(`2d`),c=s.createRadialGradient(48,48,4,48,48,47);c.addColorStop(0,`rgba(255,247,226,0.42)`),c.addColorStop(.42,`rgba(246,235,211,0.2)`),c.addColorStop(1,`rgba(238,224,198,0)`),s.fillStyle=c,s.fillRect(0,0,96,96);let l=new Wi(o);l.colorSpace=Ie;let u=e.mobile?4:8,d=e.mobile?2:3;for(let e=0;e<u;e+=1){let t=new Nr({map:l,color:16116434,transparent:!0,opacity:0,depthWrite:!1,depthTest:e>=d}),n=new qr(t);n.frustumCulled=!1,n.renderOrder=e<d?12:0,this.group.add(n),this.haze.push({sprite:n,material:t,phase:Z()*Math.PI*2,near:Z(),scale:.7+Z()*.85})}let f=new So(1,48,24),p=f.attributes.position;for(let e=0;e<p.count;e+=1){let t=p.getX(e),n=p.getY(e),r=p.getZ(e),i=Math.sqrt(t*t+r*r),a=Math.atan2(r,t),o=1+Math.sin(a*5+.8)*.065+Math.sin(a*9)*.028,s=Math.max(0,1-i*i)**.42*.27,c=Math.sin(t*17+r*13)*Math.cos(r*21-t*7)*.012;p.setXYZ(e,t*.96*o,n<0?0:Math.max(0,s+c),r*.68*o)}f.computeVertexNormals(),this.pile=$(f,Q(Gd.flour,e,`flour`,{roughness:1}),this.group),this.pile.name=`flour-pile`,af(this.pile,e,e.mobile?34:58,1.12,.008),this.pileShadow=bf(this.group,1.8,1.15),this.pileShadow.material.opacity=.24}update(e,t,n,r){let i=X(e,.288,.405,e=>e*e*(2-e)),a=X(e,.42,.51,e=>e*e),o=X(e,.3,.405)*(1-X(e,.425,.475));if(this.group.visible=e>=.278&&e<=.52,this.pile.position.set(-.65,0,.85),this.pile.scale.setScalar(Math.max(.001,Math.cbrt(o))),this.pile.visible=o>1e-4,this.pileShadow.position.set(-.65,.002,.85),this.pileShadow.scale.setScalar(Math.max(.001,Math.sqrt(o))),this.pileShadow.visible=this.pile.visible,!this.group.visible)return;let s=X(e,.318,.372)*(1-X(e,.472,.515)),c=Math.max(Id(i,.58,.58)*(1-a)*.55,s,Id(a)),l=X(e,.405,.437)*(1-X(e,.448,.482)),u=this.haze.length<=4?2:3;this.haze.forEach((e,n)=>{let i=e.near**1.6,o=n<u?Math.max(c*(.2+i*.22),l*(.54+i*.2)):c*(.24+i*.34);e.sprite.visible=o>.003,e.material.opacity=o,e.sprite.position.set(Tt.lerp(-.35,r.x,a)+Math.sin(e.phase+a*3)*.78,.42+i*.88-a*(.08+i*.24)+Math.cos(e.phase+t*.18)*.11,1.8+i*2.1+Math.sin(n*1.7)*.16);let s=e.scale*(1.2+i*1.5)*(1+c*.55);e.sprite.scale.set(s,s*.68,1)}),this.particles.forEach((e,o)=>{let s=Md((i-e.delay*.72)/.28),c=Md((a-e.delay*.65)/.35);this.source.copy(n),this.destination.set(-.65+e.x,e.y,.85+e.z);let l=s*s;qd.lerpVectors(this.source,this.destination,l);let u=s>0&&s<1?.2+e.weight*.4:0;if(a>0){this.source.copy(this.destination),this.destination.copy(r).add(Jd.set(e.x*.7,e.y*.18,e.z*.68)),Wd(this.source,this.destination,c,.65,qd);let t=Id(c)*e.near**4;qd.z+=t*(1.2+e.near*1.55),qd.y+=t*(.1+e.weight*.55),qd.x+=Math.sin(e.phase)*t*.46,u=c>0&&c<1?.22+e.weight*.42+t*.13:0}let d=Math.sin(t*(.34+e.near*.32)+e.phase)*(.008+e.near*.022)*u;this.positions.setXYZ(o,qd.x+d,qd.y+Math.cos(t*.28+e.phase)*d*.6,qd.z+d),this.alphas.setX(o,u)}),this.positions.needsUpdate=this.alphas.needsUpdate=!0}};function lf(e,t,n,r){let i=Yd(r),a=new wn;e.add(a);let o=Q(12226879,t,void 0,{roughness:.92}),s=Q(Gd.wheatLight,t,`crust`,{roughness:.76,emissive:7030027,emissiveIntensity:.18});Qd(new G(0,0,0),new G(.035,n,0),.014,o,a);let c=new So(1,12,10);for(let e=0;e<9;e+=1)for(let t of[-1,1]){if(e===4&&t===1)continue;let r=n-.88+e*.095,i=$(c,s,a,t*(.062-e*.003),r,0);i.scale.set(.061-e*.0018,.112-e*.003,.064),i.rotation.z=t*-.43,Qd(new G(t*.085,r+.045,0),new G(t*(.21-e*.005),r+.39,0),.003,o,a)}return $d([new G(0,.78,0),new G(-.19,1.12,.06),new G(-.31,1.43,.03)],.017,o,a),a.userData.phase=i()*Math.PI*2,a}function uf(e){let t=new wn,n=e.wheatCount,r=new Di(new Xi(.012,.018,1,6),Q(6716222,e,void 0,{roughness:.96}),n),i=new Di(new So(1,8,6),Q(Gd.wheat,e,`crust`,{roughness:.84,emissive:4926472,emissiveIntensity:.08}),n*8),a=new Di(new Xi(.0025,.0025,1,4),Q(10386226,e,void 0,{roughness:.96}),n*8);r.instanceMatrix.setUsage(Ve),i.instanceMatrix.setUsage(Ve),a.instanceMatrix.setUsage(Ve),r.castShadow=i.castShadow=a.castShadow=e.shadows,r.receiveShadow=i.receiveShadow=a.receiveShadow=e.shadows,t.add(r,i,a);let o=[-2.55,-1.62,-.72,.2,1.16,2.18,2.78],s=Math.max(12,Math.floor(n*.065)),c=Array.from({length:n},(e,t)=>{let n=t<s,r=o[Math.floor(Z()*o.length)],i=(Z()+Z()+Z()-1.5)*.64,a=Z()>.5?1:-1;return{x:n?a*(1.25+Z()*1.75)+(Z()-.5)*.35:r+i,z:n?.34+Z()*1.35:-.52-Z()*3,height:n?1.62+Z()*.72:1.15+Z()*.82,scale:n?.92+Z()*.32:.72+Z()*.46,phase:Z()*Math.PI*2,lean:(Z()-.5)*(n?.28:.19),forward:(Z()-.5)*.13,tone:Z()}}),l=new Cn,u=new q,d=0;return c.forEach((e,t)=>{u.setHSL(.22+e.tone*.018,.34,.25+e.tone*.11),r.setColorAt(t,u);for(let t=0;t<4;t+=1)for(let t of[-1,1])u.setHSL(.105+e.tone*.018,.58+e.tone*.08,.41+e.tone*.15),i.setColorAt(d,u),a.setColorAt(d,u.clone().multiplyScalar(.73)),d+=1}),r.instanceColor.needsUpdate=i.instanceColor.needsUpdate=a.instanceColor.needsUpdate=!0,{group:t,update(e){let t=0,n=0;c.forEach((o,s)=>{let c=Math.sin(e*(.48+o.tone*.19)+o.phase)*(.018+o.tone*.014),u=o.height*o.scale;l.position.set(o.x+c*.25,u*.5-.03,o.z),l.rotation.set(o.forward+c*.35,0,o.lean+c),l.scale.set(1,u,1),l.updateMatrix(),r.setMatrixAt(s,l.matrix);for(let e=0;e<4;e+=1){let r=u*.63+e*.105;for(let s of[-1,1]){let u=s*(.048-e*.002),d=(o.lean+c)*r*.44,f=o.forward*r*.38;l.position.set(o.x+d+u,r,o.z+f),l.rotation.set(o.forward,0,o.lean+c+s*-.42);let p=.9+o.tone*.18;l.scale.set((.057-e*.002)*p,(.092-e*.003)*p,.06*p),l.updateMatrix(),i.setMatrixAt(t,l.matrix),t+=1,l.position.set(o.x+d+s*.082,r+.045,o.z+f),l.rotation.set(o.forward,0,o.lean+c+s*-.34),l.scale.set(1,.34,1),l.updateMatrix(),a.setMatrixAt(n,l.matrix),n+=1}}}),r.instanceMatrix.needsUpdate=!0,i.instanceMatrix.needsUpdate=!0,a.instanceMatrix.needsUpdate=!0}}}function df(e,t=1){let n=[[.012,-.59],[.17,-.53],[.285,-.32],[.325,.02],[.27,.34],[.15,.54],[.01,.62]],r=new wn,i=new vo(n.map(([e,t])=>new W(e,t)),48),a=i.attributes.position;for(let e=0;e<a.count;e+=1){let t=a.getX(e),n=a.getY(e),r=a.getZ(e),i=Math.atan2(r,t),o=1+n*.065+Math.sin(n*4.2)*.022,s=1+Math.sin(i*3+n*2.1)*.014;a.setXYZ(e,t*o*s+(1-n*n)*.024,n,r*.69*(1-n*.045)*s)}return i.computeVertexNormals(),$(i,Q(14724429,e,void 0,{roughness:.88}),r).scale.setScalar(t),$d([new G(.018,-.45,.18),new G(-.006,-.18,.218),new G(.012,.16,.213),new G(-.005,.44,.176)],.013,Q(7688226,e,void 0,{roughness:.96}),r).scale.setScalar(t),$d([new G(.04,-.41,.19),new G(.022,-.12,.227),new G(.035,.2,.22),new G(.018,.4,.185)],.004,Q(16109432,e,void 0,{roughness:.82}),r).scale.setScalar(t),r}function ff(e){let t=new wn,n=Q(10986389,e,`stone`,{roughness:.96}),r=Q(8486257,e,`stone`,{roughness:.98}),i=Q(6842207,e,void 0,{roughness:.94}),a=Q(3157803,e,void 0,{metalness:.48,roughness:.55}),o=new wn;o.position.y=.62,t.add(o),$(rf(1.19,1.25,.38,48,31),n,t,0,.2,0),$(rf(1.16,1.2,.44,48,79),n,o),ef(1.205,.028,r,t,.37),ef(1.18,.025,r,o,-.2),ef(1.16,.014,a,o,.2);for(let e=0;e<14;e+=1){let t=e/14*Math.PI*2,n=t+.2+Math.sin(e*1.7)*.035;Qd(new G(Math.cos(t)*.29,.224,Math.sin(t)*.29),new G(Math.cos(n)*1.08,.224,Math.sin(n)*1.08),.008,i,o)}Qd(new G(0,.74,0),new G(0,1.78,0),.052,a,t),Qd(new G(0,1.1,0),new G(.88,1.1,0),.052,a,o),Qd(new G(.88,1.08,0),new G(.88,1.5,0),.09,Q(9329201,e,`wood`,{roughness:.83}),o);let s=Q(11434313,e,void 0,{side:2,roughness:.86,emissive:2823689,emissiveIntensity:.08}),c=$(new Xi(.49,.14,.56,4,1,!0),s,t,0,1.35,0);c.rotation.y=Math.PI/4+.16,ef(.49,.023,Q(7357993,e,`wood`,{roughness:.9}),t,1.63),ef(.145,.016,Q(6175784,e,void 0,{roughness:.92}),t,1.07),$(new Xi(.28,.28,.03,24),Q(9132596,e,`wood`),t,0,1.53,0);let l=new G(.25,.2,1.12);return $(tf(.42,.84,.065,.045),Q(9658425,e,`wood`),t,l.x,l.y,l.z).rotation.x=.2,bf(t,2.85,2.45).scale.set(1.08,1,1),{group:t,rotor:o,outlet:l}}function pf(e){let t=new wn,n=$(new vo([[.48,-.42],[.82,-.36],[1.16,-.14],[1.3,.18],[1.25,.4],[1.08,.52],[.96,.48],[1,.28],[.9,.02],[.72,-.18],[.44,-.27]].map(([e,t])=>new W(e,t)),48),Q(13947074,e,void 0,{roughness:.34}),t);n.scale.z=.96;let r=$(new Yi(.455,40),Q(12236202,e,void 0,{roughness:.5}),t,0,-.265,0);r.rotation.x=-Math.PI/2;let i=$(new Yi(.94,32),Q(Gd.flour,e,`flour`,{roughness:1}),t,0,.39,0);return i.rotation.x=-Math.PI/2,ef(1.14,.042,Q(15657177,e,void 0,{roughness:.27}),t,.48).scale.set(1,.98,1),ef(.48,.035,Q(11183512,e,void 0,{roughness:.62}),t,-.4),{group:t,flourSurface:i}}function mf(e){let t=new wn;t.position.set(-1.25,1.47,-.08),t.rotation.z=-.6;let n=Q(11916497,e,void 0,{transparent:!0,opacity:.48,roughness:.1,metalness:.08,side:2,depthWrite:!1});$(new vo([[.22,-.34],[.27,-.29],[.3,.12],[.285,.27],[.32,.34]].map(([e,t])=>new W(e,t)),32),n,t),ef(.32,.024,n,t,.34);let r=$(new Co(.2,.037,12,32),n,t,-.36,0,0);r.scale.x=.75;let i=$(new Zi(.14,.3,4,1,!0),n,t,.25,.34,0);i.rotation.z=-Math.PI/2,i.rotation.y=Math.PI/4;let a=$(new Xi(.274,.235,.36,32),Q(7515829,e,void 0,{transparent:!0,opacity:.67,roughness:.12,depthWrite:!1}),t,0,-.11,0);a.castShadow=!1;let o=$(new Yi(.272,32),Q(11131354,e,void 0,{transparent:!0,opacity:.72,roughness:.08,depthWrite:!1}),t,0,.07,0);return o.rotation.x=-Math.PI/2,t.traverse(e=>{let t=e;t.isMesh&&(t.castShadow=!1)}),t}function hf(e){let t=new wn,n=[13015648,12158544,13675121].map(t=>Q(t,e,`wood`,{roughness:.92}));for(let e=0;e<13;e+=1){let r=ef(.77+e*.024+Math.sin(e*1.7)*.006,.027+e%3*.002,n[e%n.length],t,.05+e*.035);r.position.x=Math.sin(e*2.3)*.005,r.rotation.z=Math.sin(e*1.2)*.004}let r=[Q(8476209,e,`wood`,{roughness:.95}),Q(10119999,e,`wood`,{roughness:.95})];for(let e=0;e<32;e+=1){let n=e/32*Math.PI*2;Qd(new G(Math.cos(n)*.79,.055,Math.sin(n)*.79),new G(Math.cos(n)*(1.056+Math.sin(e)*.008),.48,Math.sin(n)*(1.056+Math.sin(e)*.008)),.009,r[e%2],t)}return t}function gf(e){let t=new wn,n=[9323305,10637100,7550757,11557942].map(t=>Q(t,e,`stone`,{roughness:.92})),r=Q(3156001,e,`stone`,{roughness:.97}),i=Q(459779,e,void 0,{roughness:1});$(tf(3.8,2.65,.18),r,t,0,-.18,0),$(new Ji(3.5,2.2,.18),i,t,0,1.02,-1.08),$(new Ji(.16,1.18,1.5),i,t,-1.12,.59,-.28),$(new Ji(.16,1.18,1.5),i,t,1.12,.59,-.28),$(new Ji(2.25,.12,1.5),i,t,0,1.18,-.28),$(new Ji(.55,1.2,1.55),r,t,-1.47,.6,-.12),$(new Ji(.55,1.2,1.55),r,t,1.47,.6,-.12);for(let e of[-1,1])for(let r=0;r<4;r+=1){let i=$(new Ji(.49,.265,.24),n[(r+ +(e>0))%n.length],t,e*1.47,.16+r*.3,.69);i.position.x+=Math.sin(r*2.1+e)*.012}for(let e=0;e<13;e+=1){let r=e/13*Math.PI+.005,i=(e+1)/13*Math.PI-.005,a=new ka;a.moveTo(Math.cos(r)*1.2,1.17+Math.sin(r)*.94),a.lineTo(Math.cos(r)*1.745,1.17+Math.sin(r)*1.39),a.lineTo(Math.cos(i)*1.745,1.17+Math.sin(i)*1.39),a.lineTo(Math.cos(i)*1.2,1.17+Math.sin(i)*.94),a.closePath(),$(new mo(a,{depth:1.5,bevelEnabled:!0,bevelSegments:1,bevelSize:.012,bevelThickness:.012}),n[e%n.length],t,0,0,-.86)}let a=Q(6640711,e,`stone`,{roughness:.98});for(let e=0;e<5;e+=1)$(new Ji(.48,.11,1.45),a,t,-.98+e*.49,.04,.01);let o=document.createElement(`canvas`);o.width=256,o.height=128;let s=o.getContext(`2d`),c=s.createRadialGradient(128,98,4,128,90,118);c.addColorStop(0,`rgba(255,139,50,0.92)`),c.addColorStop(.28,`rgba(209,63,15,0.5)`),c.addColorStop(1,`rgba(63,9,2,0)`),s.fillStyle=c,s.fillRect(0,0,256,128);let l=new Wi(o);l.colorSpace=Ie;let u=$(new yo(2.15,.82),new ri({map:l,transparent:!0,opacity:0,depthWrite:!1,blending:2}),t,0,.46,-.98);u.castShadow=!1;let d=[];for(let n=0;n<11;n+=1){let r=n<5,i=n%2==0?-1:1,a=$(new _o(.026+Z()*.027,0),Q(7741966,e,void 0,{emissive:n%3==0?15300901:12073750,emissiveIntensity:.55,roughness:1}),t,r?i*(.78+Z()*.25):-.88+Z()*1.76,.13+Z()*.07,r?.35+Z()*.38:-.52-Z()*.34);a.userData.phase=Z()*Math.PI*2,d.push(a)}return{group:t,glow:u,embers:d}}function _f(e){let t=new wn;t.name=`bread-knife`;let n=new ka;n.moveTo(-.72,.065),n.lineTo(.72,.055),n.lineTo(.72,-.018);for(let e=8;e>=0;--e){let t=-.64+e*.15;n.lineTo(t,e%2==0?-.055:-.028)}n.lineTo(-.72,-.015),n.closePath();let r=new mo(n,{depth:.026,bevelEnabled:!0,bevelSegments:1,bevelSize:.006,bevelThickness:.005});r.rotateY(Math.PI/2),r.center();let i=$(r,Q(13750472,e,void 0,{metalness:.78,roughness:.2,emissive:3881010,emissiveIntensity:.12}),t,0,0,.08);i.castShadow=e.shadows,$(tf(.13,.64,.14,.04),Q(4007451,e,`wood`,{roughness:.72}),t,0,.01,-.94);let a=$(new Ji(.031,.008,.96),new ri({color:16772553,transparent:!0,opacity:.48}),t,.018,.052,.12);return a.castShadow=a.receiveShadow=!1,t}function vf(){let e=new ka;return e.moveTo(-.48,-.34),e.bezierCurveTo(-.52,-.08,-.47,.25,-.22,.38),e.bezierCurveTo(-.06,.47,.23,.43,.39,.27),e.bezierCurveTo(.5,.14,.52,-.12,.46,-.34),e.lineTo(-.48,-.34),new bo(e,5)}function yf(e){let t=new wn;t.name=`bread-cut-reveal`;let n=Q(16774098,e,`crumb`,{roughness:.97,side:2,emissive:16762751,emissiveIntensity:.5}),r=Q(8664341,e,`crust`,{roughness:.94,bumpScale:.027}),i=new ri({color:7158041,transparent:!0,opacity:.64,side:2,depthWrite:!1}),a=vf(),o=$(a,r,t,.806,.43,0);o.rotation.y=Math.PI/2,o.scale.set(1,1,1);let s=$(a,n,t,.821,.43,0);s.rotation.y=Math.PI/2,s.scale.set(.94,.94,.94);let c=new wn;c.name=`separated-slice`,$(new So(1,28,18),r,c).scale.set(.145,.44,.57);let l=$(a,n,c,.151,0,0);return l.rotation.y=Math.PI/2,l.scale.set(.95,.95,.95),c.position.set(.88,.43,0),t.add(c),[[.31,-.14],[.52,.08],[.41,.21],[.57,-.24],[.27,.18],[.46,-.02],[.2,-.2]].forEach(([e,n],r)=>{let a=$(new Yi(.014+r%3*.005,8),i,t,.824,e,n);a.rotation.y=Math.PI/2,a.scale.y=.72+r%2*.18}),[[-.12,-.16],[.1,.09],[.23,-.04],[-.02,.22],[.27,.2],[-.2,.12]].forEach(([e,t],n)=>{let r=$(new Yi(.013+n%3*.004,8),i,c,.154,e,t);r.rotation.y=Math.PI/2,r.scale.y=.68+n%2*.2}),{group:t,slice:c,crumbs:Array.from({length:8},(e,r)=>({crumb:$(new _o(.015+Z()*.017,0),n,t),delay:r/11+Z()*.12,x:.72+Z()*.2,z:(Z()-.5)*.55}))}}function bf(e,t,n){let r=document.createElement(`canvas`);r.width=r.height=128;let i=r.getContext(`2d`),a=i.createRadialGradient(64,64,5,64,64,64);a.addColorStop(0,`rgba(15,10,5,0.3)`),a.addColorStop(.55,`rgba(15,10,5,0.13)`),a.addColorStop(1,`rgba(15,10,5,0)`),i.fillStyle=a,i.fillRect(0,0,128,128);let o=$(new yo(t,n),new ri({map:new Wi(r),transparent:!0,depthWrite:!1,opacity:1}),e,0,.004,0);return o.rotation.x=-Math.PI/2,o.castShadow=o.receiveShadow=!1,o}function xf(e){Z=Yd(4937);let t=new wn;t.name=`journey-transformation`;let n=new wn,r=lf(n,e,2.48,812);r.position.set(-.21,0,.26);let i=uf(e);n.add(i.group),t.add(n);let a=df(e);a.name=`hero-kernel`,t.add(a);let o=ff(e);o.group.name=`mill`,t.add(o.group);let s=new wn;s.name=`shared-worktop`,nf(s,e,5.5,3.7,11106640),af(s,e,e.crumbCount,1.9,.002),s.rotation.y=-.018,t.add(s);let c=new cf(e);t.add(c.group);let l=pf(e);l.group.name=`mixing-bowl`,t.add(l.group);let u=bf(t,2.6,2.3),d=mf(e);t.add(d);let f=Q(12377312,e,void 0,{opacity:.65,roughness:.2,depthWrite:!1}),p=$(new Xi(.021,.035,1,10),f,t);p.name=`water-stream`;let m=$(new Xi(.004,.007,.94,6),new ri({color:15138815,transparent:!0,opacity:.5,depthWrite:!1}),p,.018,0,0);m.castShadow=m.receiveShadow=!1;let h=new wn,g=[];for(let t=0;t<15;t+=1){let n=$(new _o(t<10?.02:.035,0),Q(t<10?Gd.salt:Gd.yeast,e),h);g.push({mesh:n,x:(Z()-.5)*.65,z:(Z()-.5)*.45,delay:Z()*.45})}t.add(h);let _=new sf(t,e),v=yf(e);v.group.visible=!1,_.mesh.add(v.group);let y=bf(t,2.5,1.85),b=new wn;b.name=`mixing-spoon`;let x=Q(12420935,e,`wood`,{roughness:.86});$(new So(1,24,16),x,b).scale.set(.16,.055,.24),Qd(new G(0,.03,0),new G(.28,1.12,0),.037,x,b),t.add(b);let S=hf(e);S.name=`proofing-basket`,S.scale.set(1.14,1,.92),t.add(S);let C=new wn;C.name=`proofing-dust-motes`;let w=e.mobile?12:22,T=new Float32Array(w*3),E=Array.from({length:w},(e,t)=>({x:(Z()-.5)*3.2,y:.28+Z()*1.45,z:-.2+(Z()-.5)*1.8,phase:Z()*Math.PI*2+t})),D=new Dr;D.setAttribute(`position`,new fr(T,3));let ee=Kd(16769448,.025,0),O=new Vi(D,ee);O.frustumCulled=!1,C.add(O),t.add(C);let k=gf(e);k.group.name=`oven`,t.add(k.group);let A=new wn;A.name=`oven-peel`,$(tf(2.65,1.95,.045,.25),Q(14925445,e,`wood`),A),Qd(new G(0,.005,.95),new G(0,.005,2.7),.055,Q(11502927,e,`wood`),A),t.add(A);let j=_f(e);t.add(j);let M=new wn;M.name=`final-board`,nf(M,e,3.65,2.45,6502691),af(M,e,Math.max(18,Math.floor(e.crumbCount*.62)),1.48),M.rotation.y=.025,t.add(M);let N=new wn,P=new Float32Array(72),F=new Dr;F.setAttribute(`position`,new fr(P,3));let te=Kd(15327698,.07,0),ne=document.createElement(`canvas`);ne.width=ne.height=64;let re=ne.getContext(`2d`),ie=re.createRadialGradient(32,32,0,32,32,32);ie.addColorStop(0,`rgba(255,255,255,0.6)`),ie.addColorStop(1,`rgba(255,255,255,0)`),re.fillStyle=ie,re.fillRect(0,0,64,64),te.map=new Wi(ne);let ae=new Vi(F,te);ae.frustumCulled=!1,N.add(ae),t.add(N);let oe={field:new of(n),kernel:new of(a),mill:new of(o.group),top:new of(s),bowl:new of(l.group),water:new of(d),spoon:new of(b),additions:new of(h),basket:new of(S),oven:new of(k.group),peel:new of(A),final:new of(M),knife:new of(j),cut:new of(v.group)},se=new G(-.155,1.98,.26),I=new G(0,1.5,.65),ce=new G,le=new G,ue=new G,de=new G(0,.48,.18),fe=new G(0,.002,.12),pe=new G(0,.075,.12),me=new G(0,.105,-1.4),he=new G(0,.02,.48),ge=[{at:.968,value:new G(.78,1.78,.63)},{at:.982,value:new G(.78,1.26,.57)},{at:.989,value:new G(.78,.99,.51),tension:.58},{at:.997,value:new G(.84,.73,.49)},{at:1,value:new G(1.7,1.05,.49)}],_e=[{at:.968,value:new G(.04,-.08,-.18)},{at:.989,value:new G(.04,-.08,-.1),tension:.5},{at:.997,value:new G(.04,-.02,-.08)},{at:1,value:new G(.04,.1,.18)}],ve=new G,ye=new G,be=new G,xe=new G(0,1,0);return{group:t,update({progress:e,time:t,quality:s}){let m=Md(e),h=s.reducedMotion?0:t,x=s.reducedMotion?.35:1,w=X(m,.082,.17),O=X(m,.225,.292,e=>e*e),ne=X(m,.182,.242),re=X(m,.43,.47),ie=X(m,.138,.285);n.position.set(-ie*.08,0,-ie*2.3),oe.field.set(1-X(m,.19,.298)),n.visible&&(i.update(h),r.rotation.z=Math.sin(h*.65)*.016*(1-w)),oe.kernel.set(1-X(m,.29,.297)),qd.set(.055,1.98,0).applyEuler(r.rotation).add(r.position).add(n.position),se.copy(qd),a.position.lerpVectors(se,I,w),a.scale.setScalar(.11+w*.64),a.rotation.set(.06*w,.08*w,-.43+w*1.12),o.group.position.set(.12+(1-ne)*.34-re*.1,0,-.4-(1-ne)*2.55-re*.65),oe.mill.set(X(m,.178,.228)*(1-X(m,.423,.448))),ce.set(o.group.position.x,1.21,o.group.position.z),O>0&&(Wd(I,ce,O,.65*x,a.position),a.scale.setScalar(Tt.lerp(.75,.07,O)),a.rotation.z+=O*1.6);let ae=X(m,.284,.405,e=>e*e*(2-e));o.rotor.rotation.y=ae*Math.PI*9+Math.sin(h*.35)*.014*Id(ae),le.copy(o.outlet).add(o.group.position),oe.top.set(X(m,.205,.255)*(1-X(m,.8,.845)));let Se=X(m,.432,.492),Ce=X(m,.592,.66),we=X(m,.437,.48)*(1-X(m,.626,.668));l.group.position.set(.32*(1-Se)-Ce*.28,.43-Ce*.05,.18-(1-Se)*2.6-Ce*1.45),oe.bowl.set(we),u.position.set(l.group.position.x,.004,l.group.position.z),u.material.opacity=we*.86,u.visible=u.material.opacity>.002,ue.copy(l.group.position).add(qd.set(0,.16,0)),c.update(m,h,le,ue);let Te=X(m,.432,.49),Ee=X(m,.502,.575),De=X(m,.502,.542),Oe=Te*we*(1-De);l.flourSurface.visible=Oe>.002,l.flourSurface.scale.setScalar(Math.sqrt(Te)*(1-Ee*.08)),l.flourSurface.position.y=-.18+Te*.38-Ee*.13,l.flourSurface.material.opacity=Oe,l.flourSurface.material.transparent=De>.001,l.flourSurface.material.depthWrite=De<.08;let ke=X(m,.486,.524);d.position.set(l.group.position.x-1.12,1.54+Id(ke)*.06,.16),d.rotation.z=-.3-Id(ke)*.72,oe.water.set(Ld(m,.477,.546,.016)),be.set(.29,.27,0).applyEuler(d.rotation).add(d.position),p.position.copy(be).add(ue).multiplyScalar(.5),p.quaternion.setFromUnitVectors(xe,qd.copy(be).sub(ue).normalize()),p.scale.set(1,be.distanceTo(ue),1),p.visible=ke>.01&&ke<.99,f.opacity=Id(ke)*.58;let Ae=X(m,.498,.535,e=>e*e);oe.additions.set(Ld(m,.495,.542,.011)),g.forEach(e=>{let t=Md((Ae-e.delay)/.55);e.mesh.position.set(ue.x+e.x,ue.y+.88*(1-t*t),ue.z+e.z)});let je=X(m,.492,.568,e=>e*e*(2-e))*Math.PI*5,L=X(m,.535,.575),Me=X(m,.552,.615,Pd);b.position.set(ue.x+Math.cos(je)*(.48-L*.15),.66+Ee*.06,ue.z+Math.sin(je)*.32),b.rotation.set(-.2+Math.sin(je)*.12,je,-.34+L*.15),b.position.y+=Me*1.28,b.position.z-=Me*.34,oe.spoon.set(Ld(m,.488,.628,.018));let Ne=X(m,.498,.538);_.mesh.visible=Ne>.002,_.apply(m),_.mesh.material.opacity=Ne,_.mesh.material.depthWrite=_.mesh.material.opacity>.98;let Pe=X(m,.565,.625);Wd(de,fe,Pe,.42,_.mesh.position);let R=X(m,.61,.69,e=>e);_.mesh.rotation.set(0,Math.sin(R*Math.PI*3)*Id(R)*.06,0);let Fe=X(m,.65,.705),z=X(m,.688,.735),Ie=X(m,.816,.87);S.position.set(.36*(1-Fe),-Ie*.08,.12-(1-Fe)*2.35-Ie*.9),oe.basket.set(X(m,.645,.692)*(1-X(m,.835,.875))),m>=.688&&Wd(fe,pe,z,.28,_.mesh.position);let B=Ld(m,.69,.82,.022);C.visible=B>.002,ee.opacity=B*.22,E.forEach((e,t)=>{let n=s.reducedMotion?.35:h;T[t*3]=e.x+Math.sin(n*.18+e.phase)*.08,T[t*3+1]=e.y+Math.sin(n*.11+e.phase)*.09,T[t*3+2]=e.z+Math.cos(n*.16+e.phase)*.05}),D.attributes.position.needsUpdate=!0;let Le=X(m,.738,.812),Re=X(m,.95,.988);k.group.position.set(0,0,-1.4-3.2*(1-Le)-Re*.25),oe.oven.set(X(m,.735,.792)*(1-X(m,.965,.993)));let ze=X(m,.77,.808),Be=X(m,.808,.858),Ve=X(m,.858,.9,Pd),He=Tt.lerp(1.2,.12,ze);Be>0&&(He=Tt.lerp(.12,me.z,Be)),Ve>0&&(He=Tt.lerp(me.z,1.45,Ve)),A.position.set(0,.053,He),oe.peel.set(X(m,.765,.8)*(1-X(m,.88,.91))),m>=.808&&Wd(pe,me,Be,.22,_.mesh.position);let Ue=X(m,.748,.83)*(1-Re);k.glow.material.opacity=Ue*(.3+Math.sin(h*3.1)*.025),k.embers.forEach((e,t)=>{let n=.86+Math.sin(h*(1.7+t*.07)+e.userData.phase)*.13+Math.sin(h*3.3+t)*.05;e.material.emissiveIntensity=Ue*(.38+n*.44);let r=.92+Ue*n*.12;e.scale.set(r,r*.58,r*.84)});let We=X(m,.925,.972);M.position.set(0,0,.48),oe.final.set(X(m,.94,.97)),m>=.925&&Wd(me,he,We,.28*x,_.mesh.position),_.mesh.rotation.y+=We*-.12;let Ge=X(m,.989,.997),Ke=X(m,.99,.997),qe=X(m,.994,1);Ud(m,ge,ve),Ud(m,_e,ye),j.position.copy(ve),j.rotation.set(ye.x,ye.y,ye.z),oe.knife.set(Ld(m,.965,1,.007)),oe.cut.set(Ke),v.slice.position.set(.88+qe*.32,.43-qe*.035,qe*.045),v.slice.rotation.z=-qe*.1,v.crumbs.forEach(({crumb:e,delay:t,x:n,z:r},i)=>{let a=Md((Ge-t)/.42);e.visible=a>.002,e.scale.setScalar(X(a,0,.28)),e.position.set(n+a*(.06+i*.006),.62-a*(.5+i%3*.035),r+Math.sin(i*2.3)*a*.08),e.rotation.set(a*i,a*2.1,a*.7)});let Je=Math.max(Id(Pe),Id(z),Id(Be),Id(We)),Ye=X(m,.61,.635)*.62*(1-Je*.9);y.position.set(_.mesh.position.x,m<.808?.003:m<.925?.101:.019,_.mesh.position.z),y.visible=Ye>.002,y.material.opacity=Ye,N.position.copy(_.mesh.position);let V=Rd(m,.863,.93,.1)*.13;N.visible=V>.002&&!s.reducedMotion,te.opacity=V;for(let e=0;e<24;e+=1){let t=(h*.11+e/24)%1;P[e*3]=Math.sin(e*2.4)*.65+Math.sin(h*.35+e)*t*.1,P[e*3+1]=.92+t*.55,P[e*3+2]=Math.cos(e*1.3)*.22}F.attributes.position.needsUpdate=!0}}}var Sf=[{id:`wheat`,label:`WHEAT`,start:0,end:.16},{id:`grain`,label:`GRAIN`,start:.12,end:.25},{id:`milling`,label:`MILLING`,start:.21,end:.36},{id:`flour`,label:`FLOUR`,start:.32,end:.47},{id:`mixing`,label:`MIXING`,start:.43,end:.6},{id:`dough`,label:`DOUGH`,start:.56,end:.72},{id:`proofing`,label:`PROOFING`,start:.68,end:.82},{id:`oven`,label:`OVEN`,start:.78,end:.94},{id:`bread`,label:`BREAD`,start:.9,end:1}],Cf=[{at:0,value:new G(-.82,1.1,5.25)},{at:.08,value:new G(-.54,1.2,4.6)},{at:.145,value:new G(.58,1.7,4.22),tension:.35},{at:.2,value:new G(.78,1.75,4.12),tension:.62},{at:.245,value:new G(.34,1.67,4.25)},{at:.31,value:new G(-.86,1.43,4.78)},{at:.375,value:new G(-.12,1.7,4.62)},{at:.44,value:new G(.62,2.44,5.05)},{at:.52,value:new G(.78,2.46,4.72)},{at:.61,value:new G(.1,1.9,4.38)},{at:.68,value:new G(-.56,1.74,4.18)},{at:.74,value:new G(.38,2.02,4.45),tension:.82},{at:.8,value:new G(.12,1.88,4.32)},{at:.855,value:new G(-.68,1.45,4.02)},{at:.92,value:new G(.14,1.72,4.35)},{at:.955,value:new G(.9,2,4.78),tension:.28},{at:.98,value:new G(1.95,1.7,5)},{at:.99,value:new G(2.55,1.62,4.76)},{at:1,value:new G(3.15,1.58,4.45)}],wf=[{at:0,value:new G(-.2,1.48,-.02)},{at:.12,value:new G(-.1,1.7,.28)},{at:.2,value:new G(0,1.55,.55),tension:.62},{at:.245,value:new G(.05,1.35,.1)},{at:.31,value:new G(0,.78,-.35)},{at:.38,value:new G(-.35,.42,.35)},{at:.44,value:new G(-.1,.42,.65)},{at:.49,value:new G(0,.38,.18)},{at:.6,value:new G(0,.4,.14)},{at:.74,value:new G(0,.32,.14),tension:.85},{at:.8,value:new G(0,.42,-.35)},{at:.855,value:new G(0,.68,-1.4)},{at:.91,value:new G(0,.58,-1.3)},{at:.95,value:new G(.02,.42,.1),tension:.25},{at:1,value:new G(.02,.42,.47)}],Tf=[{at:0,value:32},{at:.14,value:28},{at:.22,value:27,tension:.55},{at:.31,value:34},{at:.38,value:32},{at:.45,value:36},{at:.53,value:34},{at:.63,value:31},{at:.74,value:33,tension:.72},{at:.855,value:36},{at:.93,value:34},{at:1,value:31}],Ef=[{at:0,value:new q(Gd.night)},{at:.08,value:new q(1186577)},{at:.17,value:new q(2701090)},{at:.25,value:new q(3489835)},{at:.34,value:new q(4671291)},{at:.43,value:new q(8354661)},{at:.5,value:new q(11576714)},{at:.66,value:new q(10851960)},{at:.75,value:new q(8418141)},{at:.82,value:new q(2168079)},{at:.93,value:new q(1182472)},{at:1,value:new q(526600)}],Df=[{at:0,value:new q(12043661)},{at:.16,value:new q(15911279)},{at:.3,value:new q(15190161)},{at:.5,value:new q(16769197)},{at:.74,value:new q(15845251)},{at:.84,value:new q(16747075)},{at:1,value:new q(16761213)}],Of=[{at:0,value:new G(-4.5,6.2,2.4)},{at:.18,value:new G(-2.8,5.4,3.2)},{at:.32,value:new G(3.4,5.6,3.6)},{at:.5,value:new G(-3.8,6.2,3.4)},{at:.74,value:new G(3.1,5.4,3)},{at:.84,value:new G(-2.3,3.4,1.2)},{at:1,value:new G(-3.4,4.8,3.2)}],kf=[{at:0,value:.035},{at:.2,value:.065},{at:.48,value:.11},{at:.68,value:.09},{at:.84,value:.025},{at:1,value:.025}],Af=[{at:0,value:.34},{at:.16,value:.48},{at:.34,value:.42},{at:.5,value:.64},{at:.68,value:.56},{at:.84,value:.2},{at:1,value:.18}],jf=[{at:0,value:2},{at:.16,value:2.7},{at:.3,value:3},{at:.5,value:2.55},{at:.68,value:2.7},{at:.76,value:2.25},{at:.84,value:1.85},{at:1,value:3.15}],Mf=[{at:0,value:.84},{at:.18,value:.92},{at:.5,value:.9},{at:.74,value:.86},{at:.84,value:.78},{at:1,value:.94}],Nf=[{at:0,value:.052},{at:.14,value:.042},{at:.28,value:.027},{at:.37,value:.038},{at:.48,value:.021},{at:.74,value:.024},{at:.85,value:.04},{at:1,value:.03}];function Pf(e,t,n){let r=Tt.clamp(e,0,1);if(r<=t[0].at)return n.copy(t[0].value);for(let e=1;e<t.length;e+=1){let i=t[e-1],a=t[e];if(r<=a.at){let e=Tt.clamp((r-i.at)/(a.at-i.at),0,1);return n.lerpColors(i.value,a.value,Fd(e))}}return n.copy(t[t.length-1].value)}var Ff=class{scene=new Nn;camera=new ds(34,1,.1,100);renderer;root=new wn;pointer={x:0,y:0,targetX:0,targetY:0};quality;container;onStateChange;previousTime=0;sequence;lookTarget=new G;desiredLook=new G;cameraTarget=new G;reducedCamera=new G(0,3,7.8);lightTarget=new G;backgroundColor=new q(Gd.night);keyLightColor=new q;fillLightColor=new q(12173981);groundLightColor=new q(1053457);fillLight;keyLight;ovenLight;breadLight;ambientLight;progress=0;elapsed=0;animationFrame=0;composer=null;bloom=null;resizeObserver=null;disposed=!1;constructor(e,t,n){if(this.container=e,this.quality=t,this.onStateChange=n,this.scene.background=this.backgroundColor,this.scene.fog=new Mn(Gd.night,.028),this.scene.add(this.root),this.renderer=new $u({antialias:!0,powerPreference:`high-performance`,alpha:!1}),this.renderer.setPixelRatio(t.dpr),this.renderer.setSize(e.clientWidth||window.innerWidth,e.clientHeight||window.innerHeight,!1),this.renderer.outputColorSpace=Ie,this.renderer.toneMapping=4,this.renderer.toneMappingExposure=.92,this.renderer.shadowMap.enabled=t.shadows,this.renderer.shadowMap.type=1,this.renderer.domElement.setAttribute(`aria-hidden`,`true`),this.renderer.domElement.className=`journey-canvas`,this.container.appendChild(this.renderer.domElement),t.bloom){let e=new Kt(1,1,{type:g,samples:t.tier===`high`?4:0});this.composer=new Ed(this.renderer,e),this.composer.addPass(new Dd(this.scene,this.camera)),this.bloom=new kd(new W(1,1),.06,.32,.86),this.composer.addPass(this.bloom),this.composer.addPass(new jd)}this.ambientLight=new _s(16774630,.035),this.fillLight=new $o(this.fillLightColor,this.groundLightColor,.34),this.keyLight=new gs(16766349,2.25),this.keyLight.castShadow=t.shadows,this.keyLight.shadow.mapSize.set(t.shadowMapSize,t.shadowMapSize),this.keyLight.shadow.camera.near=.1,this.keyLight.shadow.camera.far=30,this.keyLight.shadow.camera.left=-6,this.keyLight.shadow.camera.right=6,this.keyLight.shadow.camera.top=6,this.keyLight.shadow.camera.bottom=-6,this.keyLight.shadow.normalBias=.025,this.keyLight.shadow.bias=-2e-4,this.keyLight.shadow.radius=2,this.keyLight.shadow.blurSamples=8,this.ovenLight=new ps(Gd.ember,0,6,2),this.ovenLight.position.set(-.55,.46,-1.1),this.breadLight=new ps(16763282,0,5.5,2),this.breadLight.position.set(2.5,2.15,1.45),this.keyLight.target.position.set(0,.35,0),this.scene.add(this.ambientLight,this.fillLight,this.keyLight,this.keyLight.target,this.ovenLight,this.breadLight),this.sequence=xf(t),this.root.add(this.sequence.group),this.setupEvents(),this.resize(),this.camera.position.copy(Cf[0].value),this.lookTarget.copy(wf[0].value),this.setProgress(0),this.animationFrame=requestAnimationFrame(this.render)}getState(){let e=[...Sf].reverse().find(e=>this.progress>=e.start)??Sf[0];return{progress:this.progress,stageIndex:Sf.indexOf(e)+1,stageLabel:e.label,remainingSeconds:Math.round(120*(1-this.progress))}}setProgress(e){this.progress=Tt.clamp(e,0,1);let t=this.getState();return this.onStateChange?.(t),t}resize=()=>{let e=this.container.clientWidth||window.innerWidth,t=this.container.clientHeight||window.innerHeight;this.camera.aspect=e/Math.max(t,1),this.camera.updateProjectionMatrix(),this.renderer.setPixelRatio(this.quality.dpr),this.renderer.setSize(e,t,!1),this.composer?.setSize(e,t)};destroy(){this.disposed=!0,cancelAnimationFrame(this.animationFrame),this.resizeObserver?.disconnect(),window.removeEventListener(`pointermove`,this.handlePointer),window.removeEventListener(`resize`,this.resize),this.renderer.dispose(),this.composer?.dispose(),this.root.traverse(e=>{let t=e;t.geometry&&t.geometry.dispose(),(Array.isArray(t.material)?t.material:t.material?[t.material]:[]).forEach(e=>e.dispose())}),this.container.replaceChildren()}handlePointer=e=>{this.pointer.targetX=(e.clientX/Math.max(window.innerWidth,1)-.5)*2,this.pointer.targetY=(e.clientY/Math.max(window.innerHeight,1)-.5)*2};render=e=>{if(this.disposed)return;let t=this.previousTime?Math.min((e-this.previousTime)/1e3,.05):1/60;this.previousTime=e,this.elapsed+=t;let n=this.quality.reducedMotion?16:8;this.pointer.x=zd(this.pointer.x,this.pointer.targetX,n,t),this.pointer.y=zd(this.pointer.y,this.pointer.targetY,n,t);let r={progress:this.progress,time:this.elapsed,delta:t,pointer:this.pointer,quality:this.quality};this.sequence.update(r),this.updateCamera(r),this.updateLighting(r),this.composer?this.composer.render():this.renderer.render(this.scene,this.camera),this.animationFrame=requestAnimationFrame(this.render)};setupEvents(){window.addEventListener(`pointermove`,this.handlePointer,{passive:!0}),window.addEventListener(`resize`,this.resize,{passive:!0}),`ResizeObserver`in window&&(this.resizeObserver=new ResizeObserver(()=>this.resize()),this.resizeObserver.observe(this.container))}updateCamera(e){let t=+!e.quality.reducedMotion;if(Ud(e.progress,Cf,this.cameraTarget),Ud(e.progress,wf,this.desiredLook),e.quality.reducedMotion){let t=.8*(1-X(e.progress,.965,.998));this.cameraTarget.lerp(this.reducedCamera,t)}let n=Math.max(1,1.22/this.camera.aspect);this.cameraTarget.sub(this.desiredLook).multiplyScalar(n).add(this.desiredLook),this.cameraTarget.x+=e.pointer.x*.12*t,this.cameraTarget.y+=e.pointer.y*-.06*t,this.camera.position.copy(this.cameraTarget),this.desiredLook.x+=e.pointer.x*.045*t,this.desiredLook.y+=e.pointer.y*-.03*t,this.lookTarget.copy(this.desiredLook),this.camera.lookAt(this.lookTarget);let r=Hd(e.progress,Tf);Math.abs(this.camera.fov-r)>.001&&(this.camera.fov=r,this.camera.updateProjectionMatrix())}updateLighting(e){let t=e.progress;Pf(t,Ef,this.backgroundColor),this.scene.background=this.backgroundColor,this.scene.fog instanceof Mn&&this.scene.fog.color.copy(this.backgroundColor),Pf(t,Df,this.keyLightColor),this.keyLight.color.copy(this.keyLightColor),Ud(t,Of,this.lightTarget);let n=X(t,.68,.71)*(1-X(t,.775,.81));e.quality.reducedMotion||(this.lightTarget.x+=Math.sin(this.elapsed*.12)*n*.42,this.lightTarget.z+=Math.cos(this.elapsed*.09)*n*.22),this.keyLight.position.copy(this.lightTarget),this.keyLight.target.position.set(0,.32+X(t,.72,.86)*.35,-X(t,.72,.86)*1.2+X(t,.9,1)*1.65);let r=X(t,.753,.829)*(1-X(t,.925,.98)),i=X(t,.89,1);this.ambientLight.intensity=Hd(t,kf),this.fillLight.intensity=Hd(t,Af),this.keyLight.intensity=Hd(t,jf),this.ovenLight.intensity=r*2.55,this.breadLight.intensity=i*2.25,this.renderer.toneMappingExposure=Hd(t,Mf),this.scene.fog instanceof Mn&&(this.scene.fog.density=Hd(t,Nf)),this.bloom&&(this.bloom.strength=.045+r*.12+i*.035,this.bloom.radius=.28+r*.12,this.bloom.threshold=.84)}},If=document.querySelector(`#experience`),Lf=document.querySelector(`#scroll-rail`),Rf=document.querySelector(`#loader`),zf=document.querySelector(`#fallback`),Bf=document.querySelector(`#stage-number`),Vf=document.querySelector(`#stage-label`),Hf=document.querySelector(`#timer`),Uf=document.querySelector(`#intro-copy`),Wf=document.querySelector(`#scene-copy`),Gf=document.querySelector(`#finish-copy`),Kf=document.querySelector(`#sound-toggle`),qf=document.querySelector(`#sound-label`),Jf=document.querySelector(`#replay`);if(!If||!Lf||!Rf||!zf||!Bf||!Vf||!Hf||!Uf||!Wf||!Gf||!Kf||!qf||!Jf)throw Error(`Journey to Bread could not find its interface shell.`);var Yf=new ed,Xf=null,Zf=null;function Qf(e){let t=Math.max(0,Math.round(e));return`${String(Math.floor(t/60)).padStart(2,`0`)}:${String(t%60).padStart(2,`0`)}`}function $f(e){let t=[`WHEAT`,`ONE GRAIN.`,`BREAKING IT DOWN.`,`FLOUR.`,`FLOUR. WATER. SALT. TIME.`,`MAKE IT SOFT.`,`WAIT.`,`HEAT.`,``];Bf.textContent=`${String(e.stageIndex).padStart(2,`0`)} / 09`,Vf.textContent=e.stageLabel,Hf.textContent=Qf(e.remainingSeconds),Hf.setAttribute(`aria-label`,`${Qf(e.remainingSeconds)} remaining in the journey`),Uf.style.opacity=String(Math.max(0,1-e.progress*14)),Wf.textContent=t[e.stageIndex-1]??``,Wf.classList.toggle(`is-visible`,e.progress>.17&&e.progress<.93),e.progress<=.996&&Gf.contains(document.activeElement)&&Kf.focus({preventScroll:!0}),Gf.inert=e.progress<=.996,Gf.classList.toggle(`is-visible`,e.progress>.996),Gf.setAttribute(`aria-hidden`,String(e.progress<=.996)),document.documentElement.classList.toggle(`hud-on-light`,e.progress>=.335&&e.progress<=.79),document.documentElement.style.setProperty(`--journey-progress`,String(e.progress)),Yf.setProgress(e.progress)}function ep(e){let t=document.modelContext;if(!t?.registerTool)return;let n=new AbortController;Promise.resolve(t.registerTool({name:`set_journey_progress`,title:`Set journey progress`,description:`Move Journey to Bread to a specific scroll progress between 0 and 1 and return the visible stage and countdown.`,inputSchema:{type:`object`,properties:{progress:{type:`number`,minimum:0,maximum:1}},required:[`progress`],additionalProperties:!1},annotations:{readOnlyHint:!1,untrustedContentHint:!1},execute(t){let n=t?.progress;if(typeof n!=`number`||!Number.isFinite(n)||n<0||n>1)throw Error(`progress must be a finite number between 0 and 1`);return e.scrollToProgress(n)}},{signal:n.signal})).catch(()=>void 0),window.addEventListener(`beforeunload`,()=>n.abort(),{once:!0})}try{let e=_d();Xf=new Ff(If,e,$f),Zf=new gd(Xf),ep(Zf),Kf.addEventListener(`click`,async()=>{let e=await Yf.toggle();Kf.setAttribute(`aria-pressed`,String(e)),Kf.setAttribute(`aria-label`,e?`Turn sound off`:`Turn sound on`),qf.textContent=e?`Sound on`:`Sound off`,Kf.classList.toggle(`is-on`,e)}),Jf.addEventListener(`click`,()=>Zf?.replay());let t=new URLSearchParams(window.location.search).get(`progress`),n=Number(t);t!==null&&Number.isFinite(n)&&n>=0&&n<=1&&window.setTimeout(()=>Zf?.scrollToProgress(n),120),window.setTimeout(()=>Rf.classList.add(`is-hidden`),e.reducedMotion?100:360)}catch(e){console.error(e),If.hidden=!0,Lf.hidden=!0,Rf.hidden=!0,zf.hidden=!1,document.body.classList.add(`webgl-fallback`)}window.addEventListener(`beforeunload`,()=>{Zf?.destroy(),Xf?.destroy(),Yf.disable()},{once:!0});