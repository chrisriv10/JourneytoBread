...
void main() {
    ...
    `}));return u.frustumCulled=!1,{points:u,positions:o,alphas:s}}function Tf(e,t){let n=e.mobile?28:48,r=e.mobile?7:11,i=pf(t),a=Array.from({length:n},()=>.91+i()*.17),o=[0,.34,0],s=[.5,.5],c=[1,.975,.91],l=[];for(let e=1;e<=r;e+=1){let t=e/r;for(let e=0;e<n;e+=1){let r=e/n*Math.PI*2,i=t*Et.lerp(1,a[e],t**1.5),l=Math.cos(r)*i*.96,u=Math.sin(r)*i*.7,d=Math.max(0,1-t)**.72*.34,f=(Math.sin(r*5.1+t*8.2)+Math.sin(r*9.3-t*5.4)*.5)*.008*(1-t);o.push(l,Math.max(0,d+f),u),s.push(.5+l*.5,.5+u/1.4);let p=.9+(1-t)*.065+Math.sin(r*4.7+t*7.2)*.018;c.push(p,p*.976,p*.92)}}for(let e=0;e<n;e+=1){let t=(e+1)%n;l.push(0,1+t,1+e)}for(let e=1;e<r;e+=1){let t=1+(e-1)*n,r=t+n;for(let e=0;e<n;e+=1){let i=(e+1)%n,a=t+e,o=t+i,s=r+e,c=r+i;l.push(a,o,s,o,c,s)}}let u=new Dr;return u.setAttribute(`position`,new q(o,3)),u.setAttribute(`uv`,new q(s,2)),u.setAttribute(`color`,new q(c,3)),u.setIndex(l),u.computeVertexNormals(),u}var Ef=class{group=new Tn;pile=new Tn;pileShadow;grinding;stream;impact;pileVisibility;grindingParticles=[];streamParticles=[];impactParticles=[];haze=[];source=new W;destination=new W;constructor(e){this.group.name=`milling-output`;let t=e.mobile?56:e.tier===`high`?150:96,n=Math.floor(e.flourCount*.64),r=Math.max(120,e.flourCount-n-t);this.grinding=wf(e,t,.4,1.12,14271645),this.stream=wf(e,n,.38,1.38,14996921),this.impact=wf(e,r,.4,1.48,14206375),this.group.add(this.grinding.points,this.stream.points,this.impact.points);for(let e=0;e<t;e+=1)this.grindingParticles.push({angle:Math.PI*(.3+Q()*.4),radius:1.155+Q()*.115,delay:Q(),phase:Q()*Math.PI*2,weight:Q()**.95,near:Q(),turbulence:.003+Q()*.009});for(let e=0;e<n;e+=1)this.streamParticles.push({angle:Q()*Math.PI*2,radius:Q()**2.15,delay:Q(),phase:Q(),weight:Q()**1.55,near:Q(),turbulence:.004+Q()*.014});for(let e=0;e<r;e+=1)this.impactParticles.push({angle:Q()*Math.PI*2,radius:Math.sqrt(Q()),delay:Q(),phase:Q(),weight:Q()**1.45,near:Q(),turbulence:.008+Q()*.02});let i=document.createElement(`canvas`);i.width=i.height=96;let a=i.getContext(`2d`),o=a.createRadialGradient(44,51,3,48,48,47);o.addColorStop(0,`rgba(255,248,230,0.7)`),o.addColorStop(.38,`rgba(246,235,211,0.29)`),o.addColorStop(1,`rgba(238,224,198,0)`),a.fillStyle=o,a.fillRect(0,0,96,96);let s=new Wi(i);s.colorSpace=Le;let c=e.mobile?3:6,l=e.mobile?1:2;for(let e=0;e<c;e+=1){let t=new Nr({map:s,color:new K().setHSL(.105+e*.0025,.26,.86+e%3*.02),transparent:!0,opacity:0,depthWrite:!1,depthTest:e>=l}),n=new qr(t);n.frustumCulled=!1,n.renderOrder=e<l?12:0,this.group.add(n),this.haze.push({sprite:n,material:t,phase:Q()*Math.PI*2,near:Q(),scale:.62+Q()*.68})}let u=Tf(e,7301),d=Z(15195332,e,`flour`,{roughness:1,bumpScale:.004,vertexColors:!0}),f=$(u,d,this.pile);f.name=`flour-pile-mound`;let p=$(u.clone(),d,this.pile,-.27,.002,.08);p.scale.set(.42,.62,.46),p.rotation.y=-.34;let m=$(u.clone(),d,this.pile,.3,.001,.02);m.scale.set(.34,.45,.38),m.rotation.y=.48,this.pile.name=`flour-pile`,this.group.add(this.pile),xf(this.pile,e,e.mobile?34:58,1.12,.008),this.pileVisibility=new Sf(this.pile),this.pileShadow=Vf(this.group,1.8,1.15),this.pileShadow.material.opacity=.27}update(e,t,n,r,i,a){let o=X(e,.274,.31)*(1-X(e,.41,.442)),s=X(e,.304,.356,e=>e*e*(2-e)),c=s*(1-X(e,.416,.447)),l=X(e,.326,.405),u=X(e,.342,.418)*(1-X(e,.463,.505)),d=X(e,.397,.432)*(1-X(e,.448,.486)),f=X(e,.326,.413,e=>e*e*(2-e)),p=1-X(e,.422,.452),m=f*p;this.group.visible=e>=.27&&e<=.51,this.pile.position.copy(r);let h=Math.max(.001,Math.cbrt(f));this.pile.scale.set(h*.44,h*.55,h*.44),this.pileVisibility.set(p),this.pileShadow.position.set(r.x-.018,r.y+.002,r.z-.032);let g=Math.max(.001,Math.sqrt(f)*.56);if(this.pileShadow.scale.set(g*1.04,g*.9,1),this.pileShadow.visible=this.pile.visible,this.pileShadow.material.opacity=m*.27,!this.group.visible)return;this.grindingParticles.forEach((e,n)=>{let r=e.angle+Math.sin(a*.42+e.phase)*(.035+e.weight*.085),s=Math.sin(t*(.8+e.weight*.7)+e.phase)*e.turbulence,c=e.radius+s+o*e.weight*.045,l=o*e.weight*.052;this.grinding.positions.setXYZ(n,i.x+Math.cos(r)*c,i.y+.408+l+(e.near-.5)*.038+Math.sin(e.phase+a)*.012,i.z+Math.sin(r)*c),this.grinding.alphas.setX(n,o*(.075+e.weight*.25))}),this.grinding.positions.needsUpdate=this.grinding.alphas.needsUpdate=!0,this.source.copy(n),this.streamParticles.forEach((n,i)=>{let a=+(s>=n.delay*.88),o=((n.phase+e*(17+n.weight*7))%1+1)%1,l=(.015+n.radius*.14)*(.3+o*.7);this.destination.set(r.x+Math.cos(n.angle)*l,r.y+.012+n.weight*.012,r.z+Math.sin(n.angle)*l*.72),df.lerpVectors(this.source,this.destination,o),df.y=this.source.y+(this.destination.y-this.source.y)*o*o;let u=Math.sin(n.phase*21+o*7.2+t*.28)*n.turbulence*o;df.x+=u,df.z+=Math.cos(n.phase*17+o*5.4)*n.turbulence*o*.62;let d=X(o,0,.08)*(1-X(o,.9,1));this.stream.positions.setXYZ(i,df.x,df.y,df.z),this.stream.alphas.setX(i,a*c*d*(.24+n.weight*.48))}),this.stream.positions.needsUpdate=this.stream.alphas.needsUpdate=!0;let _=Math.max(c*.72,u*.58,d*.42);this.impactParticles.forEach((n,i)=>{let a=((n.phase+e*(10+n.weight*4))%1+1)%1,o=Math.sin(a*Math.PI),s=d*n.near**1.55,c=n.radius*(.035+l*.62+s*.82)*Math.sqrt(a),f=Math.sin(t*.2+n.phase*11)*n.turbulence*u;this.impact.positions.setXYZ(i,r.x+Math.cos(n.angle)*c+f,r.y+.014+o*(.04+l*(.16+n.near*.3))+s*(.12+n.near*.76),r.z+Math.sin(n.angle)*c*.68+f*.6+s*1.38);let p=X(a,0,.12)*(1-X(a,.78,1)),m=+(l>=n.delay*.82);this.impact.alphas.setX(i,m*_*p*(.09+n.weight*.34+s*.11))}),this.impact.positions.needsUpdate=this.impact.alphas.needsUpdate=!0;let v=this.haze.length<=3?1:2;this.haze.forEach((e,n)=>{let i=e.near**1.6,a=n<v?Math.max(u*(.075+i*.1),d*(.32+i*.17)):u*(.09+i*.16);e.sprite.visible=a>.003,e.material.opacity=a,e.sprite.position.set(r.x+Math.sin(e.phase+t*.08)*(.18+i*.42),r.y+.18+i*.62+Math.cos(e.phase+t*(.12+i*.06))*.09,r.z+.1+i*1.62+Math.sin(n*1.7)*.08);let o=e.scale*(.52+u*1.05+d*1.12)*(1+i*.82);e.sprite.scale.set(o,o*(.48+n%3*.09),1),e.material.rotation=e.phase*.18+t*(n%2==0?.018:-.013)})}};function Df(){let e=new So(1,12,9),t=e.attributes.position;for(let e=0;e<t.count;e+=1){let n=t.getX(e),r=t.getY(e),i=t.getZ(e),a=.76+(1-Math.abs(r)**1.45)*.24,o=1+r*.045+Math.sin(r*3.4)*.018;t.setXYZ(e,n*a*o+(1-r*r)*.055,r,i*a*.88)}return e.computeVertexNormals(),e}function Of(e,t,n,r){let i=new ka;return i.moveTo(0,0),i.bezierCurveTo(e*n*.4,t*.18,e*(n+r*.15),t*.52,e*r,t),i.bezierCurveTo(e*(n*.34+r*.42),t*.6,e*n*.18,t*.2,0,0),new bo(i,7)}function kf(e,t,n,r){let i=pf(r),a=new Tn;e.add(a);let o=Z(12226879,t,void 0,{roughness:.92}),s=Z(Jd.wheatLight,t,`grain`,{roughness:.76,emissive:7030027,emissiveIntensity:.13});hf([new W(0,0,0),new W(-.018,n*.34,.008),new W(.028,n*.69,-.006),new W(.035,n,0)],.014,o,a);let c=Z(9272633,t,void 0,{roughness:.96,side:2}),l=$(Of(-1,1.08,.16,.5),c,a,-.004,.68,.018);l.rotation.y=-.13;let u=$(Of(1,.76,.115,.3),c,a,.018,1.05,-.012);u.rotation.y=.22;let d=Df();for(let e=0;e<9;e+=1)for(let t of[-1,1]){if(e===4&&t===1)continue;let r=n-.88+e*.095,c=$(d,s,a,t*(.062-e*.003),r,(i()-.5)*.028),l=.94+i()*.12;c.scale.set((.061-e*.0018)*l,(.112-e*.003)*l,.064*l),c.rotation.set((i()-.5)*.13,(i()-.5)*.18,t*(-.4-i()*.08));let u=(.34-e*.004)*(.86+i()*.28);mf(new W(t*.085,r+.045,c.position.z),new W(t*(.085+u*.37),r+.045+u,c.position.z+(i()-.5)*.045),.0026+i()*8e-4,o,a)}return hf([new W(0,.78,0),new W(-.19,1.12,.06),new W(-.31,1.43,.03)],.017,o,a),a.userData.phase=i()*Math.PI*2,a}function Af(e){let t=new Tn,n=e.wheatCount,r=new Di(new Xi(.012,.018,1,6),Z(6716222,e,void 0,{roughness:.96}),n),i=new Di(new So(1,8,6),Z(Jd.wheat,e,`grain`,{roughness:.84,emissive:4926472,emissiveIntensity:.065}),n*8),a=new Di(new Xi(.0025,.0025,1,4),Z(10386226,e,void 0,{roughness:.96}),n*8);r.instanceMatrix.setUsage(He),i.instanceMatrix.setUsage(He),a.instanceMatrix.setUsage(He),r.castShadow=i.castShadow=a.castShadow=e.shadows,r.receiveShadow=i.receiveShadow=a.receiveShadow=e.shadows,t.add(r,i,a);let o=[-2.55,-1.62,-.72,.2,1.16,2.18,2.78],s=Math.max(12,Math.floor(n*.065)),c=Array.from({length:n},(e,t)=>{let n=t<s,r=o[Math.floor(Q()*o.length)],i=(Q()+Q()+Q()-1.5)*.64,a=Q()>.5?1:-1;return{x:n?a*(1.25+Q()*1.75)+(Q()-.5)*.35:r+i,z:n?.34+Q()*1.35:-.52-Q()*3,height:n?1.62+Q()*.72:1.15+Q()*.82,scale:n?.92+Q()*.32:.72+Q()*.46,phase:Q()*Math.PI*2,lean:(Q()-.5)*(n?.28:.19),forward:(Q()-.5)*.13,tone:Q()}}),l=new wn,u=new K,d=0;return c.forEach((e,t)=>{u.setHSL(.22+e.tone*.018,.34,.25+e.tone*.11),r.setColorAt(t,u);for(let t=0;t<4;t+=1)for(let t of[-1,1])u.setHSL(.105+e.tone*.018,.58+e.tone*.08,.41+e.tone*.15),i.setColorAt(d,u),a.setColorAt(d,u.clone().multiplyScalar(.73)),d+=1}),r.instanceColor.needsUpdate=i.instanceColor.needsUpdate=a.instanceColor.needsUpdate=!0,{group:t,update(e){let t=0,n=0;c.forEach((o,s)=>{let c=Math.sin(e*(.48+o.tone*.19)+o.phase)*(.018+o.tone*.014),u=o.height*o.scale;l.position.set(o.x+c*.25,u*.5-.03,o.z),l.rotation.set(o.forward+c*.35,0,o.lean+c),l.scale.set(1,u,1),l.updateMatrix(),r.setMatrixAt(s,l.matrix);for(let e=0;e<4;e+=1){let r=u*.63+e*.105;for(let s of[-1,1]){let u=s*(.048-e*.002),d=(o.lean+c)*r*.44,f=o.forward*r*.38;l.position.set(o.x+d+u,r,o.z+f),l.rotation.set(o.forward,0,o.lean+c+s*-.42);let p=.9+o.tone*.18;l.scale.set((.057-e*.002)*p,(.092-e*.003)*p,.06*p),l.updateMatrix(),i.setMatrixAt(t,l.matrix),t+=1,l.position.set(o.x+d+s*.082,r+.045,o.z+f),l.rotation.set(o.forward,0,o.lean+c+s*-.34),l.scale.set(1,.34,1),l.updateMatrix(),a.setMatrixAt(n,l.matrix),n+=1}}}),r.instanceMatrix.needsUpdate=!0,i.instanceMatrix.needsUpdate=!0,a.instanceMatrix.needsUpdate=!0}}}function jf(e,t=1){let n=[[.008,-.64],[.12,-.59],[.27,-.4],[.345,-.12],[.355,.14],[.3,.4],[.18,.57],[.045,.65],[.008,.66]],r=new Tn,i=new vo(n.map(([e,t])=>new U(e,t)),e.mobile?28:e.tier===`high`?40:34),a=i.attributes.position;for(let e=0;e<a.count;e+=1){let t=a.getX(e),n=a.getY(e),r=a.getZ(e),i=Math.atan2(r,t),o=1+n*.075+Math.sin(n*4.2)*.024,s=1+Math.sin(i*3+n*2.1)*.012,c=t*o*s+(1-n*n)*.03,l=r*.71*(1-n*.05)*s,u=Math.max(0,Math.sin(i)),d=Math.exp(-((c/.078)**2))*u*(1-(Math.abs(n)/.68)**2)*.072;a.setXYZ(e,c,n,l-Math.max(0,d))}return i.computeVertexNormals(),$(i,Z(14724429,e,`grain`,{roughness:.78,bumpScale:.012,emissive:3480069,emissiveIntensity:.075}),r).scale.setScalar(t),hf([new W(.018,-.48,.174),new W(-.01,-.2,.199),new W(.012,.15,.196),new W(-.004,.47,.166)],.012,Z(5320979,e,void 0,{roughness:.99}),r).scale.setScalar(t),hf([new W(.037,-.42,.183),new W(.019,-.12,.208),new W(.032,.2,.205),new W(.016,.42,.177)],.0035,Z(16109432,e,void 0,{roughness:.82}),r).scale.setScalar(t),r}function Mf(e){let t=new Tn,n=Z(10986389,e,`stone`,{roughness:.96}),r=Z(8486257,e,`stone`,{roughness:.98}),i=Z(6842207,e,void 0,{roughness:.94}),a=Z(3157803,e,void 0,{metalness:.48,roughness:.55}),o=new Tn;o.position.y=.62,t.add(o),$(yf(1.19,1.25,.38,48,31),n,t,0,.2,0),$(yf(1.16,1.2,.44,48,79),n,o);let s=$(new Yi(1.075,48),new ri({color:1513233,transparent:!0,opacity:.28,depthWrite:!1}),t,0,.397,0);s.rotation.x=-Math.PI/2,s.castShadow=s.receiveShadow=!1,gf(1.12,.042,Z(5131591,e,`stone`,{roughness:.99}),t,.025),gf(1.205,.028,r,t,.37),gf(1.18,.025,r,o,-.2),gf(1.16,.014,a,o,.2),gf(.19,.026,a,o,.225);for(let e=0;e<14;e+=1){let t=e/14*Math.PI*2,n=t+.2+Math.sin(e*1.7)*.035;mf(new W(Math.cos(t)*.29,.224,Math.sin(t)*.29),new W(Math.cos(n)*1.08,.224,Math.sin(n)*1.08),.008,i,o)}let c=Z(6446934,e,`stone`,{roughness:.99}),l=Z(12631214,e,`stone`,{roughness:.98});for(let e=0;e<11;e+=1){let t=e/11*Math.PI*2+.13,n=1.218+Math.sin(e*2.4)*.008,r=$(new Ji(.11+e%3*.035,.018+e%2*.008,.016),e%4==0?l:c,o,Math.cos(t)*n,-.02+Math.sin(e*1.7)*.105,Math.sin(t)*n);r.rotation.y=Math.PI/2-t,r.rotation.z=Math.sin(e*2.1)*.16,r.castShadow=!1}mf(new W(0,.74,0),new W(0,1.78,0),.052,a,t),mf(new W(0,1.1,0),new W(.88,1.1,0),.052,a,o),mf(new W(.88,1.08,0),new W(.88,1.5,0),.09,Z(9329201,e,`wood`,{roughness:.83}),o);let u=Z(11434313,e,`wood`,{side:2,roughness:.86,emissive:2823689,emissiveIntensity:.05}),d=new Tn;d.position.y=1.35,d.rotation.y=Math.PI/4+.16,t.add(d),$(new Xi(.49,.14,.56,4,1,!0),u,d);let f=Z(7357993,e,`wood`,{roughness:.92,bumpScale:.01}),p=Z(5123869,e,void 0,{roughness:.96});for(let e of[-1,1])$(new Ji(.78,.045,.045),f,d,0,.29,e*.39),$(new Ji(.045,.045,.78),f,d,e*.39,.29,0);for(let e=0;e<4;e+=1){let t=Math.PI/4+e*Math.PI/2;mf(new W(Math.cos(t)*.47,.27,Math.sin(t)*.47),new W(Math.cos(t)*.13,-.27,Math.sin(t)*.13),.008,p,d)}gf(.145,.016,Z(6175784,e,void 0,{roughness:.92}),t,1.07);let m=new Tn;m.position.set(.25,.36,1.15),m.rotation.x=.14,t.add(m);let h=Z(9658425,e,`wood`,{roughness:.88,bumpScale:.009}),g=Z(7159845,e,`wood`,{roughness:.92,bumpScale:.008});$(_f(.46,.82,.055,.04),h,m),$(new Ji(.042,.105,.77),g,m,-.205,.052,0),$(new Ji(.042,.105,.77),g,m,.205,.052,0);let _=$(new Ji(.37,.075,.038),Z(3087378,e,void 0,{roughness:.98}),m,0,.025,.4);_.castShadow=!1;let v=Z(15194557,e,`flour`,{transparent:!0,opacity:.42,depthWrite:!1});for(let e=0;e<3;e+=1){let t=$(new Ji(.025+e*.006,.004,.18+e*.035),v,m,(e-1)*.075,.032+e*.001,.18+e*.035);t.rotation.y=(e-1)*.07,t.castShadow=t.receiveShadow=!1}let y=new W(0,.015,.43).applyEuler(m.rotation).add(m.position),b=Vf(t,2.85,2.45);return b.scale.set(1.08,1,1),b.material.opacity=.82,{group:t,rotor:o,outlet:y}}function Nf(e){let t=new Tn,n=new vo([[.48,-.42],[.82,-.36],[1.16,-.14],[1.3,.18],[1.25,.4],[1.08,.52],[.96,.48],[1,.28],[.9,.02],[.72,-.18],[.44,-.27]].map(([e,t])=>new U(e,t)),48),r=n.attributes.position;for(let e=0;e<r.count;e+=1){let t=r.getX(e),n=r.getY(e),i=r.getZ(e),a=Math.atan2(i,t),o=1+Math.sin(a*3+n*2.1)*.005+Math.cos(a*5-n)*.0025;r.setXYZ(e,t*o,n+Math.sin(a*2.2)*.003,i*o)}n.computeVertexNormals();let i=$(n,Z(14209472,e,void 0,{roughness:.36,emissive:1511947,emissiveIntensity:.018}),t);i.scale.z=.96;let a=$(new Yi(.455,40),Z(11183773,e,void 0,{roughness:.58}),t,0,-.265,0);a.rotation.x=-Math.PI/2;let o=$(new Yi(.94,32),Z(Jd.flour,e,`flour`,{roughness:1}),t,0,.39,0);return o.rotation.x=-Math.PI/2,gf(1.14,.042,Z(16050902,e,void 0,{roughness:.22,emissive:2826258,emissiveIntensity:.045}),t,.48).scale.set(1,.98,1),gf(1.045,.018,Z(12170408,e,void 0,{roughness:.48}),t,.455).scale.set(1,.96,1),gf(.48,.035,Z(11183512,e,void 0,{roughness:.62}),t,-.4),{group:t,flourSurface:o}}function Pf(e){let t=new Tn;t.position.set(-1.25,1.47,-.08),t.rotation.z=-.6;let n=Z(11916497,e,void 0,{transparent:!0,opacity:.48,roughness:.1,metalness:.08,side:2,depthWrite:!1});$(new vo([[.22,-.34],[.27,-.29],[.3,.12],[.285,.27],[.32,.34]].map(([e,t])=>new U(e,t)),32),n,t),gf(.32,.024,n,t,.34);let r=$(new wo(.2,.037,12,32),n,t,-.36,0,0);r.scale.x=.75;let i=$(new Zi(.14,.3,4,1,!0),n,t,.25,.34,0);i.rotation.z=-Math.PI/2,i.rotation.y=Math.PI/4;let a=$(new Xi(.274,.235,.36,32),Z(7515829,e,void 0,{transparent:!0,opacity:.67,roughness:.12,depthWrite:!1}),t,0,-.11,0);a.castShadow=!1;let o=$(new Yi(.272,32),Z(11131354,e,void 0,{transparent:!0,opacity:.72,roughness:.08,depthWrite:!1}),t,0,.07,0);return o.rotation.x=-Math.PI/2,t.traverse(e=>{let t=e;t.isMesh&&(t.castShadow=!1)}),t}function Ff(e){let t=new Tn,n=[13015648,12158544,13675121].map(t=>Z(t,e,`wood`,{roughness:.92}));for(let e=0;e<12;e+=1){let r=gf(.77+e*.022+Math.sin(e*1.7)*.006,.027+e%3*.002,n[e%n.length],t,.05+e*.031);r.position.x=Math.sin(e*2.3)*.005,r.rotation.z=Math.sin(e*1.2)*.004}let r=[Z(8476209,e,`wood`,{roughness:.95}),Z(10119999,e,`wood`,{roughness:.95})];for(let e=0;e<28;e+=1){let n=e/28*Math.PI*2,i=.995+Math.sin(e*1.31)*.008;mf(new W(Math.cos(n)*.79,.055,Math.sin(n)*.79),new W(Math.cos(n)*i,.405,Math.sin(n)*i),.0095,r[e%2],t)}return t}function If(e){let t=new Tn,n=[9323305,10637100,7550757,11557942].map(t=>Z(t,e,`stone`,{roughness:.92})),r=Z(3156001,e,`stone`,{roughness:.97}),i=Z(459779,e,void 0,{roughness:1});$(_f(3.8,2.65,.18),r,t,0,-.18,0),$(new Ji(3.5,2.2,.18),i,t,0,1.02,-1.08),$(new Ji(.16,1.18,1.5),i,t,-1.12,.59,-.28),$(new Ji(.16,1.18,1.5),i,t,1.12,.59,-.28),$(new Ji(2.25,.12,1.5),i,t,0,1.18,-.28);let a=Z(2889489,e,`stone`,{roughness:.98}),o=$(new wo(1.18,.095,8,42,Math.PI),a,t,0,1.17,.57);o.rotation.z=0,$(new Ji(.19,1.17,.26),a,t,-1.18,.59,.57),$(new Ji(.19,1.17,.26),a,t,1.18,.59,.57),$(new Ji(.55,1.2,1.55),r,t,-1.47,.6,-.12),$(new Ji(.55,1.2,1.55),r,t,1.47,.6,-.12);for(let e of[-1,1])for(let r=0;r<4;r+=1){let i=$(new Ji(.49,.265,.24),n[(r+ +(e>0))%n.length],t,e*1.47,.16+r*.3,.69);i.position.x+=Math.sin(r*2.1+e)*.012}for(let e=0;e<13;e+=1){let r=e/13*Math.PI+.005,i=(e+1)/13*Math.PI-.005,a=new ka;a.moveTo(Math.cos(r)*1.2,1.17+Math.sin(r)*.94),a.lineTo(Math.cos(r)*1.745,1.17+Math.sin(r)*1.39),a.lineTo(Math.cos(i)*1.745,1.17+Math.sin(i)*1.39),a.lineTo(Math.cos(i)*1.2,1.17+Math.sin(i)*.94),a.closePath(),$(new mo(a,{depth:1.5,bevelEnabled:!0,bevelSegments:1,bevelSize:.012,bevelThickness:.012}),n[e%n.length],t,0,0,-.86)}let s=[6640711,5851454,7626836].map(t=>Z(t,e,`stone`,{roughness:.98}));for(let e=0;e<5;e+=1){let n=$(new Ji(.47,.11,1.45),s[e%s.length],t,-.98+e*.49,.04,.01);n.position.y+=Math.sin(e*2.1)*.008}let c=document.createElement(`canvas`);c.width=256,c.height=128;let l=c.getContext(`2d`),u=l.createRadialGradient(128,98,4,128,90,118);u.addColorStop(0,`rgba(255,139,50,0.92)`),u.addColorStop(.28,`rgba(209,63,15,0.5)`),u.addColorStop(1,`rgba(63,9,2,0)`),l.fillStyle=u,l.fillRect(0,0,256,128);let d=new Wi(c);d.colorSpace=Le;let f=$(new yo(2.15,.82),new ri({map:d,transparent:!0,opacity:0,depthWrite:!1,blending:2}),t,0,.46,-.98);f.castShadow=!1;let p=[];for(let n=0;n<11;n+=1){let r=n<5,i=n%2==0?-1:1,a=$(new _o(.026+Q()*.027,0),Z(7741966,e,void 0,{emissive:n%3==0?15300901:12073750,emissiveIntensity:.55,roughness:1}),t,r?i*(.78+Q()*.25):-.88+Q()*1.76,.13+Q()*.07,r?.35+Q()*.38:-.52-Q()*.34);a.userData.phase=Q()*Math.PI*2,p.push(a)}return{group:t,glow:f,embers:p}}function Lf(e){let t=new Tn;t.name=`bread-knife`;let n=new ka;n.moveTo(-.72,.065),n.lineTo(.72,.055),n.lineTo(.72,-.018);for(let e=8;e>=0;--e){let t=-.64+e*.15;n.lineTo(t,e%2==0?-.055:-.028)}n.lineTo(-.72,-.015),n.closePath();let r=new mo(n,{depth:.026,bevelEnabled:!0,bevelSegments:1,bevelSize:.006,bevelThickness:.005});r.rotateY(Math.PI/2),r.center();let i=$(r,Z(13750472,e,void 0,{metalness:.78,roughness:.2,emissive:3881010,emissiveIntensity:.12}),t,0,0,.08);i.castShadow=e.shadows,$(_f(.13,.64,.14,.04),Z(4007451,e,`wood`,{roughness:.72}),t,0,.01,-.94);let a=$(new Ji(.031,.008,.96),new ri({color:16772553,transparent:!0,opacity:.48}),t,.018,.052,.12);return a.castShadow=a.receiveShadow=!1,t}function Rf(){let e=new ka;return e.moveTo(-.48,-.34),e.bezierCurveTo(-.52,-.08,-.47,.25,-.22,.38),e.bezierCurveTo(-.06,.47,.23,.43,.39,.27),e.bezierCurveTo(.5,.14,.52,-.12,.46,-.34),e.lineTo(-.48,-.34),new bo(e,5)}function zf(){let e=document.createElement(`canvas`);e.width=e.height=64;let t=e.getContext(`2d`),n=t.createRadialGradient(27,25,2,32,32,29);n.addColorStop(0,`rgba(66,31,12,0.94)`),n.addColorStop(.54,`rgba(103,54,23,0.82)`),n.addColorStop(.76,`rgba(243,192,117,0.34)`),n.addColorStop(1,`rgba(243,192,117,0)`),t.fillStyle=n,t.fillRect(0,0,64,64);let r=new Wi(e);return r.colorSpace=Le,r}function Bf(e){let t=new Tn;t.name=`bread-cut-reveal`;let n=Z(16774098,e,`crumb`,{roughness:.97,side:2,emissive:4924688,emissiveIntensity:.035}),r=Z(8664341,e,`crust`,{roughness:.94,bumpScale:.027}),i=new Io({map:zf(),color:16777215,roughness:1,metalness:0,transparent:!0,opacity:.9,side:2,depthWrite:!1}),a=Rf(),o=$(a,r,t,.806,.43,0);o.rotation.y=Math.PI/2,o.scale.set(1,1,1);let s=$(a,n,t,.821,.43,0);s.rotation.y=Math.PI/2,s.scale.set(.94,.94,.94);let c=new Tn;c.name=`separated-slice`,$(new So(1,28,18),r,c).scale.set(.145,.44,.57);let l=$(a,n,c,.151,0,0);l.rotation.y=Math.PI/2,l.scale.set(.95,.95,.95),c.position.set(.88,.43,0),t.add(c);let u=new ri({color:13999449,transparent:!0,opacity:.14,side:2,depthWrite:!1});return[[.38,-.17,.085],[.19,.12,.055],[.55,.2,.07]].forEach(([e,n,r],i)=>{let a=$(new Yi(r,12),u,t,.825,e,n);a.rotation.y=Math.PI/2,a.scale.y=.62+i*.12}),[[.3,-.15],[.53,.09],[.4,.23],[.58,-.245],[.245,.17],[.455,-.025],[.19,-.215],[.65,-.095],[.35,.045],[.72,.12],[.29,.29]].forEach(([e,n],r)=>{let a=$(new Yi(1,12),i,t,.829+r%3*.0015,e,n);a.rotation.y=Math.PI/2;let o=.017+r%4*.005;a.scale.set(o,o*(.58+r%3*.16),o),a.rotation.x=(r%2?-1:1)*.18}),[[-.04,-.12,.075],[.18,.15,.058]].forEach(([e,t,n],r)=>{let i=$(new Yi(n,12),u,c,.155,e,t);i.rotation.y=Math.PI/2,i.scale.y=.66+r*.15}),[[-.12,-.16],[.1,.09],[.23,-.04],[-.02,.22],[.27,.2],[-.2,.12],[.16,-.2],[-.24,-.05],[.31,.04],[-.06,-.01]].forEach(([e,t],n)=>{let r=$(new Yi(1,12),i,c,.158+n%2*.0015,e,t);r.rotation.y=Math.PI/2;let a=.016+n%3*.005;r.scale.set(a,a*(.62+n%4*.12),a),r.rotation.x=(n%2?-1:1)*.16}),{group:t,slice:c,crumbs:Array.from({length:8},(e,r)=>{let i=.014+Q()*.019;return{crumb:$(r%3==0?new Co(i,0):new _o(i,0),n,t),delay:r/11+Q()*.12,x:.72+Q()*.2,z:(Q()-.5)*.55,stretch:.68+Q()*.72,drift:(Q()-.5)*.12}})}}function Vf(e,t,n){let r=document.createElement(`canvas`);r.width=r.height=128;let i=r.getContext(`2d`),a=i.createRadialGradient(64,64,5,64,64,64);a.addColorStop(0,`rgba(15,10,5,0.3)`),a.addColorStop(.55,`rgba(15,10,5,0.13)`),a.addColorStop(1,`rgba(15,10,5,0)`),i.fillStyle=a,i.fillRect(0,0,128,128);let o=$(new yo(t,n),new ri({map:new Wi(r),transparent:!0,depthWrite:!1,opacity:1}),e,0,.004,0);return o.rotation.x=-Math.PI/2,o.castShadow=o.receiveShadow=!1,o}function Hf(e){Q=pf(4937);let t=new Tn;t.name=`journey-transformation`;let n=new Tn,r=kf(n,e,2.48,812);r.position.set(-.21,0,.26);let i=Af(e);n.add(i.group),t.add(n);let a=e.mobile?14:32,o=new Float32Array(a*3),s=Array.from({length:a},(e,t)=>({x:-2.8+Q()*5.6,y:.45+Q()*1.75,z:-1.9+Q()*3.2,phase:Q()*Math.PI*2+t})),c=new Dr;c.setAttribute(`position`,new pr(o,3));let l=Yd(16042873,e.mobile?.022:.028,0),u=new Vi(c,l);u.name=`wheat-pollen`,u.frustumCulled=!1,t.add(u);let d=jf(e);d.name=`hero-kernel`,t.add(d);let f=Mf(e);f.group.name=`mill`,t.add(f.group);let p=new Tn;p.name=`shared-worktop`,vf(p,e,5.5,3.7,9398089),xf(p,e,e.crumbCount,1.9,.002),p.rotation.y=-.018,t.add(p);let m=new Ef(e);t.add(m.group);let h=Nf(e);h.group.name=`mixing-bowl`,t.add(h.group);let g=Vf(t,2.6,2.3),_=Pf(e);t.add(_);let v=Z(12377312,e,void 0,{opacity:.65,roughness:.2,depthWrite:!1}),y=$(bf(),v,t);y.name=`water-stream`;let b=$(new Xi(.004,.007,.94,6),new ri({color:15138815,transparent:!0,opacity:.5,depthWrite:!1}),y,.018,0,0);b.castShadow=b.receiveShadow=!1;let x=new Tn,S=[];for(let t=0;t<15;t+=1){let n=$(new _o(t<10?.02:.035,0),Z(t<10?Jd.salt:Jd.yeast,e),x);S.push({mesh:n,x:(Q()-.5)*.65,z:(Q()-.5)*.45,delay:Q()*.45})}t.add(x);let C=new Tn;C.name=`forming-dough-clumps`;let w=Z(13871987,e,`dough`,{roughness:.82,bumpScale:.008}),T=Array.from({length:e.mobile?5:8},(e,t)=>{let n=$(new _o(1,+(t%3==0)),w,C),r=Q()*Math.PI*2;return{clump:n,x:Math.cos(r)*(.16+Q()*.42),z:Math.sin(r)*(.1+Q()*.3),size:.055+Q()*.085,phase:Q()*Math.PI*2}});t.add(C);let E=new Cf(t,e),D=Bf(e);D.group.visible=!1,E.mesh.add(D.group);let ee=Vf(t,2.5,1.85),O=new Tn;O.name=`mixing-spoon`;let k=Z(12420935,e,`wood`,{roughness:.86});$(new So(1,24,16),k,O).scale.set(.16,.055,.24),mf(new W(0,.03,0),new W(.28,1.12,0),.037,k,O),t.add(O);let A=Ff(e);A.name=`proofing-basket`,A.scale.set(1.14,1,.92),t.add(A);let j=new Tn;j.name=`proofing-dust-motes`;let M=e.mobile?12:22,te=new Float32Array(M*3),N=Array.from({length:M},(e,t)=>({x:(Q()-.5)*3.2,y:.28+Q()*1.45,z:-.2+(Q()-.5)*1.8,phase:Q()*Math.PI*2+t})),P=new Dr;P.setAttribute(`position`,new pr(te,3));let ne=Yd(16769448,.025,0),re=new Vi(P,ne);re.frustumCulled=!1,j.add(re),t.add(j);let ie=If(e);ie.group.name=`oven`,t.add(ie.group);let ae=new Tn;ae.name=`oven-peel`,$(_f(2.65,1.95,.045,.25),Z(14925445,e,`wood`),ae),mf(new W(0,.005,.95),new W(0,.005,2.7),.055,Z(11502927,e,`wood`),ae),t.add(ae);let oe=Lf(e);t.add(oe);let se=new Tn;se.name=`final-board`,vf(se,e,3.65,2.45,6502691),xf(se,e,Math.max(18,Math.floor(e.crumbCount*.62)),1.48),se.rotation.y=.025,t.add(se);let ce=new Tn,F=new Float32Array(72),le=new Dr;le.setAttribute(`position`,new pr(F,3));let ue=Yd(15327698,.07,0),de=document.createElement(`canvas`);de.width=de.height=64;let fe=de.getContext(`2d`),pe=fe.createRadialGradient(32,32,0,32,32,32);pe.addColorStop(0,`rgba(255,255,255,0.6)`),pe.addColorStop(1,`rgba(255,255,255,0)`),fe.fillStyle=pe,fe.fillRect(0,0,64,64),ue.map=new Wi(de);let me=new Vi(le,ue);me.frustumCulled=!1,ce.add(me),t.add(ce);let he={field:new Sf(n),kernel:new Sf(d),mill:new Sf(f.group),top:new Sf(p),bowl:new Sf(h.group),water:new Sf(_),spoon:new Sf(O),additions:new Sf(x),clumps:new Sf(C),basket:new Sf(A),oven:new Sf(ie.group),peel:new Sf(ae),final:new Sf(se),knife:new Sf(oe),cut:new Sf(D.group)},ge=new W(-.155,1.98,.26),_e=new W(0,1.5,.65),ve=new W,ye=new W,be=new W,xe=new W,Se=new W(0,.48,.18),Ce=new W(0,.002,.12),we=new W(0,.075,.12),Te=new W(0,.105,-1.4),Ee=new W(0,.02,.48),De=[{at:.968,value:new W(.78,1.78,.63)},{at:.982,value:new W(.78,1.26,.57)},{at:.989,value:new W(.78,.99,.51),tension:.58},{at:.997,value:new W(.84,.73,.49)},{at:1,value:new W(1.7,1.05,.49)}],Oe=[{at:.968,value:new W(.04,-.08,-.18)},{at:.989,value:new W(.04,-.08,-.1),tension:.5},{at:.997,value:new W(.04,-.02,-.08)},{at:1,value:new W(.04,.1,.18)}],ke=new W,Ae=new W,je=new W,Me=new W(0,1,0);return{group:t,update({progress:e,time:t,quality:a}){let p=Nd(e),x=a.reducedMotion?0:t,C=a.reducedMotion?.35:1,k=X(p,.082,.17),M=X(p,.225,.292,e=>e*e),re=X(p,.215,.289,e=>e*e*(3-2*e)),de=X(p,.285,.295,e=>e*e),fe=X(p,.182,.242),pe=X(p,.138,.285);n.position.set(-pe*.08,0,-pe*2.3),he.field.set(1-X(p,.19,.298)),n.visible&&(i.update(x),r.rotation.z=Math.sin(x*.65)*.016*(1-k));let me=1-X(p,.14,.255);if(u.visible=me>.002,l.opacity=me*.26,u.position.copy(n.position),s.forEach((e,t)=>{o[t*3]=e.x+Math.sin(x*.14+e.phase)*.12,o[t*3+1]=e.y+Math.sin(x*.2+e.phase*.7)*.06,o[t*3+2]=e.z+Math.cos(x*.11+e.phase)*.05}),c.attributes.position.needsUpdate=!0,he.kernel.set(1-X(p,.29,.297)),df.set(.055,1.98,0).applyEuler(r.rotation).add(r.position).add(n.position),ge.copy(df),d.position.lerpVectors(ge,_e,k),d.scale.setScalar(.11+k*.64),d.rotation.set(.06*k,.08*k,-.43+k*1.12),f.group.position.set(.12+(1-fe)*.34,0,-.4-(1-fe)*2.55),he.mill.set(X(p,.178,.228)*(1-X(p,.423,.448))),ve.set(f.group.position.x,1.21,f.group.position.z),M>0){qd(_e,ve,M,.65*C,d.position);let e=Et.lerp(.75,.115,re);d.scale.setScalar(e*Et.lerp(1,.46,de)),d.rotation.z+=M*1.6}let I=X(p,.284,.405,e=>e*e*(2-e));f.rotor.rotation.y=I*Math.PI*9+Math.sin(x*.35)*.014*Ld(I),f.rotor.position.y=.62+Math.sin(I*Math.PI*18)*Ld(I)*.0045*C,ye.copy(f.outlet).add(f.group.position),be.set(ye.x+.018,.006,ye.z+.055),he.top.set(X(p,.205,.255)*(1-X(p,.8,.845)));let Ne=X(p,.423,.482),Pe=X(p,.592,.66),Fe=X(p,.427,.47)*(1-X(p,.602,.633));h.group.position.set(.32*(1-Ne)-Pe*.28,.43-Pe*.05,.18-(1-Ne)*2.6-Pe*1.45),he.bowl.set(Fe),g.position.set(h.group.position.x,.004,h.group.position.z),g.material.opacity=Fe*.86,g.visible=g.material.opacity>.002,xe.copy(h.group.position).add(df.set(0,.16,0)),m.update(p,x,ye,be,f.group.position,f.rotor.rotation.y);let L=X(p,.434,.49),Ie=X(p,.502,.575),R=X(p,.502,.542),Le=L*Fe*(1-R);h.flourSurface.visible=Le>.002,h.flourSurface.scale.setScalar(Math.sqrt(L)*(1-Ie*.08)),h.flourSurface.position.y=-.18+L*.38-Ie*.13,h.flourSurface.material.opacity=Le,h.flourSurface.material.transparent=R>.001,h.flourSurface.material.depthWrite=R<.08;let z=X(p,.486,.524);_.position.set(h.group.position.x-1.12,1.54+Ld(z)*.06,.16),_.rotation.z=-.3-Ld(z)*.72,he.water.set(Rd(p,.477,.546,.016)),je.set(.29,.27,0).applyEuler(_.rotation).add(_.position),y.position.copy(je).add(xe).multiplyScalar(.5),y.quaternion.setFromUnitVectors(Me,df.copy(je).sub(xe).normalize()),y.scale.set(1,je.distanceTo(xe),1),y.visible=z>.01&&z<.99,v.opacity=Ld(z)*.58,b.position.x=.014+Math.sin(x*2.8+z*Math.PI*2)*.006,b.material.opacity=Ld(z)*.48;let Re=X(p,.498,.535,e=>e*e);he.additions.set(Rd(p,.495,.542,.011)),S.forEach(e=>{let t=Nd((Re-e.delay)/.55);e.mesh.position.set(xe.x+e.x,xe.y+.88*(1-t*t),xe.z+e.z)});let ze=X(p,.49,.518)*(1-X(p,.548,.575)),Be=X(p,.505,.56);he.clumps.set(ze),w.roughness=.88-X(p,.498,.535)*.18,T.forEach((e,t)=>{let n=e.phase+Be*(.8+t*.07);e.clump.position.set(xe.x+Et.lerp(e.x,Math.cos(n)*.07,Be),xe.y+.025+Math.sin(n*1.7)*.035*(1-Be),xe.z+Et.lerp(e.z,Math.sin(n)*.045,Be));let r=e.size*(1-Be*.64);e.clump.scale.set(r*(1.08+t%2*.16),r*(.72+t%3*.08),r),e.clump.rotation.set(n*.23,n*.5,n*-.16)});let Ve=X(p,.492,.568,e=>e*e*(2-e))*Math.PI*5,He=X(p,.535,.575),Ue=X(p,.552,.615,Fd);O.position.set(xe.x+Math.cos(Ve)*(.48-He*.15),.66+Ie*.06,xe.z+Math.sin(Ve)*.32),O.rotation.set(-.2+Math.sin(Ve)*.12,Ve,-.34+He*.15),O.position.y+=Ue*1.28,O.position.z-=Ue*.34,he.spoon.set(Rd(p,.488,.628,.018));let We=X(p,.498,.538);E.mesh.visible=We>.002,E.apply(p),E.mesh.material.opacity=We,E.mesh.material.depthWrite=E.mesh.material.opacity>.98;let Ge=X(p,.565,.625);qd(Se,Ce,Ge,.42,E.mesh.position);let Ke=X(p,.61,.69,e=>e);E.mesh.rotation.set(0,Math.sin(Ke*Math.PI*3)*Ld(Ke)*.06,0);let qe=X(p,.65,.705),Je=X(p,.688,.735),Ye=X(p,.805,.848);A.position.set(.25*(1-qe),-.34*(1-qe)-Ye*.38,.12-(1-qe)*2.35-Ye*.72),he.basket.set(X(p,.666,.7)*(1-X(p,.812,.846))),p>=.688&&qd(Ce,we,Je,.28,E.mesh.position);let Xe=Rd(p,.69,.82,.022);j.visible=Xe>.002,ne.opacity=Xe*.22,N.forEach((e,t)=>{let n=a.reducedMotion?.35:x;te[t*3]=e.x+Math.sin(n*.18+e.phase)*.08,te[t*3+1]=e.y+Math.sin(n*.11+e.phase)*.09,te[t*3+2]=e.z+Math.cos(n*.16+e.phase)*.05}),P.attributes.position.needsUpdate=!0;let B=X(p,.738,.812),V=X(p,.95,.988);ie.group.position.set(0,0,-1.4-3.2*(1-B)-V*.25),he.oven.set(X(p,.735,.792)*(1-X(p,.965,.993)));let Ze=X(p,.77,.808),Qe=X(p,.808,.858),$e=X(p,.858,.9,Fd),et=Et.lerp(1.2,.12,Ze);Qe>0&&(et=Et.lerp(.12,Te.z,Qe)),$e>0&&(et=Et.lerp(Te.z,1.45,$e)),ae.position.set(0,.053,et),he.peel.set(X(p,.765,.8)*(1-X(p,.88,.91))),p>=.808&&qd(we,Te,Qe,.22,E.mesh.position);let tt=X(p,.748,.83)*(1-V);ie.glow.material.opacity=tt*(.3+Math.sin(x*3.1)*.025),ie.embers.forEach((e,t)=>{let n=.86+Math.sin(x*(1.7+t*.07)+e.userData.phase)*.13+Math.sin(x*3.3+t)*.05;e.material.emissiveIntensity=tt*(.38+n*.44);let r=.92+tt*n*.12;e.scale.set(r,r*.58,r*.84)});let nt=X(p,.925,.972);se.position.set(0,0,.48),he.final.set(X(p,.94,.97)),p>=.925&&qd(Te,Ee,nt,.28*C,E.mesh.position),E.mesh.rotation.y+=nt*-.12;let rt=X(p,.989,.997),it=X(p,.99,.997),at=X(p,.994,1);Kd(p,De,ke),Kd(p,Oe,Ae),oe.position.copy(ke),oe.rotation.set(Ae.x,Ae.y,Ae.z),he.knife.set(Rd(p,.965,1,.007)),he.cut.set(it),D.slice.position.set(.88+at*.32,.43-at*.035,at*.045),D.slice.rotation.z=-at*.1,D.crumbs.forEach(({crumb:e,delay:t,x:n,z:r,stretch:i,drift:a},o)=>{let s=Nd((rt-t)/.42);e.visible=s>.002;let c=X(s,0,.28);e.scale.set(c*i,c*(.72+o%2*.25),c),e.position.set(n+s*(.06+o*.006)+a*s,.62-s*(.5+o%3*.035),r+Math.sin(o*2.3)*s*.08),e.rotation.set(s*o,s*2.1,s*.7)});let H=Math.max(Ld(Ge),Ld(Je),Ld(Qe),Ld(nt)),ot=X(p,.61,.635)*.62*(1-H*.9);ee.position.set(E.mesh.position.x,p<.808?.003:p<.925?.101:.019,E.mesh.position.z),ee.visible=ot>.002,ee.material.opacity=ot,ce.position.copy(E.mesh.position);let st=zd(p,.863,.93,.1)*.13;ce.visible=st>.002&&!a.reducedMotion,ue.opacity=st;for(let e=0;e<24;e+=1){let t=(x*.11+e/24)%1;F[e*3]=Math.sin(e*2.4)*.65+Math.sin(x*.35+e)*t*.1,F[e*3+1]=.92+t*.55,F[e*3+2]=Math.cos(e*1.3)*.22}le.attributes.position.needsUpdate=!0}}}var Uf=[{id:`wheat`,label:`WHEAT`,start:0,end:.16},{id:`grain`,label:`GRAIN`,start:.12,end:.25},{id:`milling`,label:`MILLING`,start:.21,end:.36},{id:`flour`,label:`FLOUR`,start:.32,end:.47},{id:`mixing`,label:`MIXING`,start:.43,end:.6},{id:`dough`,label:`DOUGH`,start:.56,end:.72},{id:`proofing`,label:`PROOFING`,start:.68,end:.82},{id:`oven`,label:`OVEN`,start:.78,end:.94},{id:`bread`,label:`BREAD`,start:.9,end:1}],Wf=[{at:0,value:new W(-.82,1.1,5.25)},{at:.095,value:new W(-.38,1.3,4.52)},{at:.205,value:new W(.56,1.72,4.1),tension:.42},{at:.31,value:new W(-.34,1.46,4.72)},{at:.36,value:new W(-.18,1.32,4.3),tension:.34},{at:.425,value:new W(.14,1.5,4.12),tension:.28},{at:.5,value:new W(.55,2.42,4.88)},{at:.62,value:new W(.04,1.86,4.36)},{at:.74,value:new W(.18,2,4.42),tension:.84},{at:.855,value:new W(-.46,1.5,4.05)},{at:.925,value:new W(.12,1.7,4.38)},{at:.965,value:new W(1.02,1.84,4.9),tension:.18},{at:1,value:new W(2.55,1.62,4.58)}],Gf=[{at:0,value:new W(-.2,1.48,-.02)},{at:.13,value:new W(-.08,1.69,.3)},{at:.205,value:new W(0,1.54,.55),tension:.56},{at:.31,value:new W(0,.78,-.35)},{at:.36,value:new W(.14,.31,.92),tension:.36},{at:.425,value:new W(.18,.27,1.2),tension:.3},{at:.5,value:new W(0,.38,.18)},{at:.62,value:new W(0,.4,.14)},{at:.74,value:new W(0,.32,.14),tension:.85},{at:.855,value:new W(0,.68,-1.4)},{at:.925,value:new W(0,.56,-1.1)},{at:1,value:new W(.02,.42,.47)}],Kf=[{at:0,value:32},{at:.19,value:27,tension:.48},{at:.31,value:34},{at:.36,value:31},{at:.425,value:29,tension:.35},{at:.5,value:36},{at:.62,value:31},{at:.74,value:33,tension:.72},{at:.855,value:36},{at:.93,value:34},{at:1,value:31}],qf=[{at:0,value:new K(Jd.night)},{at:.08,value:new K(1186577)},{at:.17,value:new K(2701090)},{at:.25,value:new K(3489835)},{at:.34,value:new K(4671291)},{at:.43,value:new K(6248777)},{at:.5,value:new K(7826263)},{at:.66,value:new K(7102024)},{at:.75,value:new K(5588275)},{at:.82,value:new K(2168079)},{at:.93,value:new K(1182472)},{at:1,value:new K(526600)}],Jf=[{at:0,value:new K(527370)},{at:.17,value:new K(1516568)},{at:.32,value:new K(3815727)},{at:.48,value:new K(8879984)},{at:.66,value:new K(6839113)},{at:.75,value:new K(7626823)},{at:.83,value:new K(1248008)},{at:1,value:new K(329221)}],Yf=[{at:0,value:new K(528392)},{at:.17,value:new K(2570272)},{at:.32,value:new K(2434334)},{at:.48,value:new K(4405549)},{at:.66,value:new K(3418399)},{at:.75,value:new K(4009247)},{at:.83,value:new K(591108)},{at:1,value:new K(525572)}],Xf=[{at:0,value:new K(10320434)},{at:.22,value:new K(13936722)},{at:.38,value:new K(12757625)},{at:.62,value:new K(15780238)},{at:.76,value:new K(14197853)},{at:.86,value:new K(11877654)},{at:1,value:new K(10701600)}],Zf=[{at:0,value:.08},{at:.16,value:.17},{at:.34,value:.08},{at:.5,value:.085},{at:.68,value:.075},{at:.76,value:.07},{at:.86,value:.14},{at:1,value:.11}],Qf=[{at:0,value:new K(12043661)},{at:.16,value:new K(15911279)},{at:.3,value:new K(15190161)},{at:.5,value:new K(16769197)},{at:.74,value:new K(15845251)},{at:.82,value:new K(16171396)},{at:.865,value:new K(16746560)},{at:1,value:new K(16765602)}],$f=[{at:0,value:new W(-4.5,6.2,2.4)},{at:.18,value:new W(-2.8,5.4,3.2)},{at:.32,value:new W(3.4,5.6,3.6)},{at:.5,value:new W(-3.8,6.2,3.4)},{at:.74,value:new W(3.1,5.4,3)},{at:.84,value:new W(-2.3,3.4,1.2)},{at:1,value:new W(-3.4,4.8,3.2)}],ep=[{at:0,value:.035},{at:.2,value:.065},{at:.48,value:.11},{at:.68,value:.09},{at:.84,value:.025},{at:1,value:.032}],tp=[{at:0,value:.34},{at:.16,value:.48},{at:.34,value:.42},{at:.5,value:.64},{at:.68,value:.56},{at:.84,value:.2},{at:1,value:.27}],np=[{at:0,value:2},{at:.16,value:2.7},{at:.3,value:3},{at:.5,value:2.55},{at:.68,value:2.7},{at:.76,value:2.25},{at:.84,value:1.85},{at:1,value:3.15}],rp=[{at:0,value:.84},{at:.18,value:.92},{at:.5,value:.9},{at:.74,value:.86},{at:.84,value:.78},{at:1,value:.94}],ip=[{at:0,value:.052},{at:.14,value:.042},{at:.28,value:.027},{at:.37,value:.038},{at:.48,value:.021},{at:.74,value:.024},{at:.85,value:.04},{at:1,value:.03}];function ap(e,t,n){let r=Et.clamp(e,0,1);if(r<=t[0].at)return n.copy(t[0].value);for(let e=1;e<t.length;e+=1){let i=t[e-1],a=t[e];if(r<=a.at){let e=Et.clamp((r-i.at)/(a.at-i.at),0,1);return n.lerpColors(i.value,a.value,Id(e))}}return n.copy(t[t.length-1].value)}var op=class{scene=new Pn;camera=new fs(34,1,.1,100);renderer;root=new Tn;pointer={x:0,y:0,targetX:0,targetY:0};quality;container;onStateChange;previousTime=0;sequence;lookTarget=new W;desiredLook=new W;cameraTarget=new W;reducedCamera=new W(0,3,7.8);lightTarget=new W;backgroundColor=new K(Jd.night);backdropTopColor=new K(527370);backdropBottomColor=new K(528392);backdropGlowColor=new K(10320434);backdropMaterial;backdrop;keyLightColor=new K;fillLightColor=new K(12173981);groundLightColor=new K(1053457);fillLight;keyLight;ovenLight;breadLight;ambientLight;progress=0;visualProgress=0;visualVelocity=0;elapsed=0;animationFrame=0;composer=null;bloom=null;resizeObserver=null;disposed=!1;constructor(e,t,n){if(this.container=e,this.quality=t,this.onStateChange=n,this.scene.background=this.backgroundColor,this.scene.fog=new Nn(Jd.night,.028),this.backdropMaterial=new Po({uniforms:{uTop:{value:this.backdropTopColor},uBottom:{value:this.backdropBottomColor},uGlow:{value:this.backdropGlowColor},uGlowStrength:{value:.08},uResolution:{value:new U(1,1)}},vertexShader:`
        varying vec3 vLocal;
        void main() {
          vLocal = position;
          gl_Position = projectionMatrix * modelViewMatrix * vec4(position, 1.0);
